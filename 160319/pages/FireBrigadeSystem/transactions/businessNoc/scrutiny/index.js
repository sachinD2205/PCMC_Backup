...
import IssuanceOfStreetVendorLicenseCertificate from "../../../../../components/fireBrigadeSystem/buisnessNoc/IssuanceOfStreetVendorLicenseCertificate";
...
const Index = () => {
  ...
  const getIssuanceOfHawkerLicense = () => {
    axios.get(`${urls.FbsURL}/trnBussinessNOC/getAll`).then((resp) => {
      console.log(
        "FBS Data(PROVISIONAL DATA) ",
        JSON.stringify(resp.data.bussiness)
      );
  ...
  const remarkFun = (data) => {
    ...
    axios
      .post(
        `${urls.FbsURL}/trnBussinessNOC/saveApplicationApprove`,
        finalBodyForApi
      )
      .then((res) => {
        if (res.status == 200) {
                      ...
                      <Table>
                        ...
                        <TableBody>
                          ...
                          <TableRow>
                            ...
                            <TableCell>
                              Structural Stability Certificate From PWD
                              Department
                            </TableCell>
                            <TableCell>Required</TableCell>
                            <TableCell>
