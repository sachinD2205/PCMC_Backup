                        ...
                        render={({ field }) => (
                          <LocalizationProvider dateAdapter={AdapterMoment}>
                            <TimePicker
                              ...
                              renderInput={(params) => (
                                <TextField sx={{ width: "80%" }} size="small" {...params} />
                              )}
                            />
                  ...
                  <Grid item xs={4} className={styles.feildres}>
                    <FormControl component="fieldset" sx={{ marginTop: "8%" }}>
                      <FormLabel component="legend">
                        {/* <FormattedLabel id='lossAmount' /> */}
                        Is tenant have any loss?
                      </FormLabel>
                      <Controller
                        rules={{ required: true }}
                        control={control}
                ...
                <Grid container columns={{ xs: 4, sm: 8, md: 12 }} className={styles.feildres}>
                  <Grid item xs={4} className={styles.feildres}>
                    <FormControl sx={{ m: 1, width: 300 }}>
                      <InputLabel id="demo-multiple-checkbox-label">Fire Station</InputLabel>
                      <Select
                  ...
                  {externalPerson == "Yes" && (
                    <>
                      ...
                      >
                        <Grid item xs={11} className={styles.feildres}>
                          <h4>इतर बाह्य कर्मचारी - जो डयुटी वर नाही परंतु वर्दीच्या वेळी उपस्थित आहे</h4>
                          <FormControl fullWidth sx={{ m: 1 }}>
                            <InputLabel id="demo-multiple-chip-label">
