...
// import styles from "../businessNoc/citizen/"
...
const Index = () => {
  ...
  const getAllCaseEntry = (_pageSize = 10, _pageNo = 0) => {
    ...
    axios
      .get(`${urls.FbsURL}/trnBussinessNOC/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.FbsURL}/trnBussinessNOC/save`, body)
            .then((res) => {
  ...
  const actionOnRecord = (record, pageMode) => {
    ...
    router.push({
      pathname: "/FireBrigadeSystem/transactions/renewalOfBusinessNoc",
      query: {
        pageMode: pageMode,
        ...record,
      },
          ...
          <Box>
            <IconButton
              ...
              onClick={() => {
                ...
                router.push({
                  pathname:
                    "/FireBrigadeSystem/transactions/renewalOfBusinessNoc/form",
                  query: {
                    pageMode: "Edit",
                    ...record,
                  },
