...
const Index = () => {
  ...
  const columns = [
    ...
    // },
    {
      headerName: <FormattedLabel id="nameOfBusiness" />,
    ...
    {
      headerName: <FormattedLabel id="nocNo" />,
      field: "nocNo",
      width: 120,
    },
    {
    ...
    {
      headerName: <FormattedLabel id="nocEndDate" />,
      field: "nocEndDate",
      width: 150,
    },
      ...
      <Box style={{ display: "flex", marginTop: "2%" }}>
        <Box className={styles.tableHead}>
          <Box className={styles.h1Tag}>
            ...
            >
              {<FormattedLabel id="defaulterNocList" />}
            </Typography>
          </Box>
        </Box>
      </Box>
