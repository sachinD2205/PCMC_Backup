            ...
            <tr style={{ border: "2px solid black" }}>
              <div className={styles.main}>
                <div className={styles.one}>
                  <img src="/logoCer.jpg" alt="Maharashtra Logo" height={198} width={198}></img>
                  <tr>
                    <div style={{ marginTop: "20px", width: "max-content" }}>
                      <right>
                        <h3>
                          <b>
                            फेरीवाला नोंदणी क्र.: &nbsp;&nbsp;{this?.props?.certificateData?.certificateNo}{" "}
                          </b>
                        </h3>
                      </right>
                    </div>
                ...
                <div className={styles.three} style={{ marginRight: "50px" }}>
                  <Image src="/rts_servicelogo.png" alt="Maharashtra Logo" height={197} width={197}></Image>
                  <tr>
                    <div style={{ marginTop: "20px", width: "max-content", marginRight: "70px" }}>
                      <right>
                        <h3>
                          <b>
                            फेरीवाला नोंदणी दिनांक :- &nbsp;&nbsp;
                ...
                <center>
                  <td>
                    <h2 style={{ marginTop: "25px" }} className={styles.extraWidth1}>
                      <b>
                        फेरीवाला नोंदणी प्रमाणपत्र :&nbsp;&nbsp; {this?.props?.certificateData?.certificateNo}
                      </b>
                    </h2>
                  </td>
                </center>
