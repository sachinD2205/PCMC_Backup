            ...
            <Grid container rowSpacing={2} columnSpacing={1} className={styles.attachmentContainer}>
              ...
              >
                <Grid item xl={10} lg={10} md={10} sm={10} xs={10}>
                  <label>A-1 Form for Power Supply</label><br/>
                  <label>{documentList.length > 0 && documentList[0] ? documentList[0].remark : ""}</label>
                </Grid>
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                  {console.log("documentList", documentList)}
                  {documentList.length > 0 && documentList[0] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[0]?.documentPath}`}
                      target="__blank"
                    >
              ...
              >
                <Grid item xl={10} lg={10} md={10} sm={10} xs={10} style={{ marginRight: "15px" }}>
                  <label>
                    Proof of Ownership or Occupancy of Premises (Any one of the following)
                  </label><br/>
                  <label>{documentList.length > 0 && documentList[1] ? documentList[1].remark : ""}</label>
                </Grid>
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                {documentList.length > 0 && documentList[1] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[1]?.documentPath}`}
                      target="__blank"
                    >
                      <Button variant="contained">View</Button>
                    </a>
              ...
              >
                <Grid item xl={10} lg={10} md={10} sm={10} xs={10}>
                  ...
                  <label>{documentList.length > 0 && documentList[2] ? documentList[2].remark : ""}</label>
                </Grid>
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                {documentList.length > 0 && documentList[2] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[2]?.documentPath}`}
                      target="__blank"
                    >
                      <Button variant="contained">View</Button>
                    </a>
              ...
              >
                <Grid item xl={10} lg={10} md={10} sm={10} xs={10}>
                  ...
                  <label>{documentList.length > 0 && documentList[3] ? documentList[3].remark : ""}</label>
                </Grid>
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                {documentList.length > 0 && documentList[3] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[3]?.documentPath}`}
                      target="__blank"
                    >
                      <Button variant="contained">View</Button>
                    </a>
              ...
              >
                ...
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                {documentList.length > 0 && documentList[4] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[4]?.documentPath}`}
                      target="__blank"
                    >
                      <Button variant="contained">View</Button>
                    </a>
              ...
              >
                ...
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                {documentList.length > 0 && documentList[5] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[5]?.documentPath}`}
                      target="__blank"
                    >
                      <Button variant="contained">View</Button>
                    </a>
              ...
              >
                ...
                <Grid item xl={2} lg={2} md={2} sm={2} xs={2} className={styles.viewButton}>
                {documentList.length > 0 && documentList[6] ? (
                    <a
                      href={`${urls.CFCURL}/file/preview?filePath=${documentList[6]?.documentPath}`}
                      target="__blank"
                    >
                      <Button variant="contained">View</Button>
                    </a>
