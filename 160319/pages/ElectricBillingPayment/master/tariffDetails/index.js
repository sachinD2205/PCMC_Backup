      ...
      .then((r) => {
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            energyChargeMr: r.energyChargeMr,

            fixedDemandCharge: r.fixedDemandCharge,
            fixedDemandChargeMr: r.fixedDemandChargeMr,
            fromDate: r.fromDate,
            ...
            fromRangeMr: r.fromRangeMr,
            toRange: r.toRange,
            toRangeMr: r.toRangeMr,
            units: r.units,
            unitsMr: r.unitsMr,
            wheelingCharge: r.wheelingCharge,
            wheelingChargeMr: r.wheelingChargeMr,
            ...
            >
              <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label="Energy Charge (En)"
                    // {<FormattedLabel id="billingCycleEn" />}
                    id="standard-basic"
                    variant="standard"
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label="Energy Charge(Mr)"
                    // {<FormattedLabel id="billingCycleMr" />}
                    id="standard-basic"
                    variant="standard"
                    {...register("energyChargeMr")}
                    error={!!errors.energyCharge}
                    InputProps={{ style: { fontSize: 18 } }}
                    InputLabelProps={{
                      style: { fontSize: 15 },
                      //true
                      shrink:
                        (watch("energyChargeMr") ? true : false) ||
                        (router.query.energyChargeMr ? true : false),
                    }}
                    helperText={
                      // errors?.studentName ? errors.studentName.message : null
                      errors?.energyCharge
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label="Fixed Demand Charge(Mr)"
                    id="standard-basic"
                    variant="standard"
                    {...register("fixedDemandChargeMr")}
                    error={!!errors.fixedDemandCharge}
                    InputProps={{ style: { fontSize: 18 } }}
                    InputLabelProps={{
                      style: { fontSize: 15 },
                      //true
                      shrink:
                        (watch("fixedDemandChargeMr") ? true : false) ||
                        (router.query.fixedDemandChargeMr ? true : false),
                    }}
                    helperText={
                      errors?.fixedDemandCharge
                        ? "Fixed Demand Charge is Required !!!"
                      ...
                      render={({ field }) => (
                        <LocalizationProvider dateAdapter={AdapterMoment}>
                          <DatePicker
                            ...
                            inputFormat="DD/MM/YYYY"
                            label={
                              <span style={{ fontSize: 16 }}>To Date (Mr)</span>
                            }
                            value={field.value}
                            onChange={(date) =>
                              field.onChange(moment(date).format("YYYY-MM-DD"))
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("tariffCategory") ? true : false) ||
                        (router.query.tariffCategory ? true : false),
                    }}
                    helperText={
                      // errors?.studentName ? errors.studentName.message : null
                      errors?.tariffCategory
                        ? "Tariff Category is Required !!!"
                        : null
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label="Tariff Category(Mr)"
                    id="standard-basic"
                    variant="standard"
                    {...register("tariffCategoryMr")}
                    error={!!errors.tariffCategory}
                    InputProps={{ style: { fontSize: 18 } }}
                    InputLabelProps={{
                      style: { fontSize: 15 },
                      //true
                      shrink:
                        (watch("tariffCategoryMr") ? true : false) ||
                        (router.query.tariffCategoryMr ? true : false),
                    }}
                    helperText={
                      errors?.tariffCategory
                        ? "Tariff Category is Required !!!"
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("fromRangeMr") ? true : false) ||
                        (router.query.fromRangeMr ? true : false),
                    }}
                    helperText={
                      errors?.fromRange ? "From Range is Required !!!" : null
                    }
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("toRangeMr") ? true : false) ||
                        (router.query.toRangeMr ? true : false),
                    }}
                    helperText={
                      errors?.toRange ? "To Range is Required !!!" : null
                    }
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("unitsMr") ? true : false) ||
                        (router.query.unitsMr ? true : false),
                    }}
                    helperText={errors?.units ? "Units is Required !!!" : null}
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label="Wheeling Charge(Mr)"
                    id="standard-basic"
                    variant="standard"
                    {...register("wheelingChargeMr")}
                    error={!!errors.wheelingCharge}
                    InputProps={{ style: { fontSize: 18 } }}
                    InputLabelProps={{
                      style: { fontSize: 15 },
                      //true
                      shrink:
                        (watch("wheelingChargeMr") ? true : false) ||
                        (router.query.wheelingChargeMr ? true : false),
                    }}
                    helperText={
                      errors?.wheelingCharge
                        ? "Wheeling Charge is Required !!!"
                        : null
                    }
                  />
                </Grid>
