...
const Index = () => {
  ...
  const getBillingCycle = (_pageSize = 10, _pageNo = 0) => {
    ...
    axios
      ...
      .then((r) => {
        console.log(";r", r);
        let result = r.data.mstBillingCycleList;
  ...
  const onSubmitForm = (fromData) => {
    ...
    if (btnSaveText === "Save") {
      const tempData = axios
        .post(`${urls.EBPSURL}/mstBillingCycle/save`, _body)
        .then((res) => {
          if (res.status == 201) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.EBPSURL}/mstBillingCycle/save`, body)
            .then((res) => {
            ...
            >
              <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label={<FormattedLabel id="billingCycleEn" />}
                    id="standard-basic"
                    variant="standard"
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("billingCycle") ? true : false) ||
                        (router.query.billingCycle ? true : false),
                    }}
                    helperText={
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("billingCycleMr") ? true : false) ||
                        (router.query.billingCycleMr ? true : false),
                    }}
                    helperText={
