      ...
      .then((r) => {
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            billingUnitNoMr: r.billingUnitNoMr,
            divisionName: r.divisionName,
            divisionNameMr: r.divisionNameMr,
            billingUnitAndDivision: `${r.divisionName}/${r.billingUnitNo}`,
            billingUnitAndDivisionMr: `${r.divisionNameMr}/${r.billingUnitNoMr}`,
              ...
              <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={
                      errors?.billingUnitNo ? errors.billingUnitNo.message : null
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    id="standard-basic"
                    variant="standard"
                    {...register("billingUnitNoMr")}
                    error={!!errors.billingUnitNoMr}
                    InputProps={{ style: { fontSize: 18 } }}
                    InputLabelProps={{
                      style: { fontSize: 15 },
                      //true
                      shrink:
                        (watch("billingUnitNoMr") ? true : false) ||
                        (router.query.billingUnitNoMr ? true : false),
                    }}
                    helperText={
                      errors?.billingUnitNoMr ? errors.billingUnitNoMr.message : null
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label={<FormattedLabel id="divisionNameEn" />}
                    id="standard-basic"
                    variant="standard"
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    label={<FormattedLabel id="divisionNameMr" />}
                    id="standard-basic"
                    variant="standard"
                    {...register("divisionNameMr")}
                    ...
                    helperText={
                      ...
                      errors?.divisionNameMr ? "Division Name is Required !!!" : null
                    }
                  />
                </Grid>
