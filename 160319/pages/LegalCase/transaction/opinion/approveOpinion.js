    ...
    axios.get(`${urls.LCMSURL}/transaction/opinion/getById?id=${router?.query?.id}`).then((r) => {
      ...
      let _res = r.data.opinionAdvPanelList.map((r, i) => {
        return {
          ...
          advocateOpinion: r.remark,
          advocateOpinionMr: r.remarkMr,
        };
      });
      // setData(_res)
      setData({
          ...
          <Grid container sx={{ padding: "10px" }}>
            ...
            >
              <TextField
                ...
                // style={{ width: 1000 }}
                fullWidth
                {...register("hodRemarkEn")}
                InputLabelProps={{
                  //true
                  shrink: (watch("hodRemarkEn") ? true : false) || (router.query.hodRemarkEn ? true : false),
                }}
            ...
            >
              <TextField
                ...
                InputLabelProps={{
                  //true
                  shrink: (watch("hodRemarkMr") ? true : false) || (router.query.hodRemarkMr ? true : false),
                }}
            ...
            >
              <FormControl style={{ marginTop: 10 }} error={!!errors.opinionSubmisionDate}>
                <Controller
                  control={control}
                ...
                />
                <FormHelperText>
                  {errors?.opinionSubmisionDate ? errors.opinionSubmisionDate.message : null}
                </FormHelperText>
              </FormControl>
            </Grid>
          </Grid>
