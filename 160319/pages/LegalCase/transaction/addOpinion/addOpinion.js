...
const View = () => {
  ...
  const onSubmitForm = (data) => {
    ...
    const bodyForAPI = {
      ...
      // trnOpinionAttachmentDao: additionalFiles.map((Obj, index) => {
    ...
    axios
      ...
      .then((res) => {
        if (res.status == 200) {
          ...
          router.push(`/LegalCase/transaction/addOpinion/`);
                    ...
                    <Grid container sx={{ padding: "10px" }}>
                      ...
                      <Grid item xs={12} xl={12} md={12} sm={12}>
                        <TextField
                          ...
                          helperText={errors?.panelAdvocateOpinion ? errors.panelAdvocateOpinion.message : " "}
                        />
                      </Grid>
                      ...
                      >
                        <TextField
                          ...
                          // helperText={errors?.panelAdvocateOpinionMr ? errors.panelAdvocateOpinionMr.message : " "}
                        />
                      </Grid>
                    </Grid>
                  </>
