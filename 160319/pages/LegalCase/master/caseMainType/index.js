...
import schema from "../../../../containers/schema/LegalCaseSchema/caseMainTypeSchema";
...
const Index = () => {
  ...
  const columns = [
    { field: "srNo", headerName: <FormattedLabel id="srNo" />, flex: 1 ,align: "center",
    headerAlign: "center",},
               ...
               >
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={
                      errors?.caseMainTypeMr ? errors.caseMainTypeMr.message : " "
                    }
                  />
                </Grid>
