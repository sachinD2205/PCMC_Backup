...
const Documents = (props) => {
  ...
  const [mstAdvocateAttachmentDao, setmstAdvocateAttachmentDao] =
    useState([]);
  ...
  useEffect(() => {
    if (localStorage.getItem("mstAdvocateAttachmentDao") !== null) {
      setAdditionalFiles(
        JSON.parse(localStorage.getItem("mstAdvocateAttachmentDao")),
      );
    }
    // delete
