...
function VehicleEntryReport() {
  ...
  const getInOut = (fromDate, toDate, _pageSize = 10, _pageNo = 0) => {
    setLoading(true);
    axios
      .get(`${urls.SMURL}/trnVehicleInOut/getReportByDate`, {
        params: {
    ...
    <Paper>
      ...
      >
        ...
        <Grid item xs={8} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          <h2>
            {language === "en" ? "Vehicle In/Out Entry Report" : "वाहन आत/बाहेर प्रवेश अहवाल"}
      ...
      <Grid container sx={{ display: "flex", justifyContent: "center", padding: "5px" }}>
        <Button
          variant="contained"
          size="small"
      ...
      <Box>
        <Box sx={{ paddingTop: "10px" }}>
          <ComponentToPrint data={{ dataSource, language, ...menu, route }} ref={componentRef} />
        </Box>
      </Box>
    </Paper>
  );
              ...
              <table className={styles.report}>
                ...
                <tbody>
                  <tr>
                    ...
                    <th colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Vehicle Number" : "वाहन क्रमांक"}
                    </th>
                    <th colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Driver Name" : "चालकाचे नाव"}
                    </th>
                    <th colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Driver Number" : "चालक क्रमांक"}
                    </th>
                    <th colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Driver Licence Number" : "चालक परवाना क्रमांक"}
                    </th>
                    <th colSpan={1}>{this?.props?.data?.language === "en" ? "In Time" : "ची वेळ"}</th>
                    <th colSpan={1}>{this?.props?.data?.language === "en" ? "Out Time" : "बाहेरची वेळ"}</th>
                    <th colSpan={1}>
                      {this?.props?.data?.language === "en" ? "In Out Status" : "आत/बाहेर स्थिती"}
                    </th>
                  </tr>
                    ...
                    this?.props?.data?.dataSource?.map((r, i) => (
                      <>
                        <tr>
                          <td>{i + 1}</td>
                          <td>
                            {this?.props?.data?.language == "en" ? r?.vehicleNumber : r?.vehicleNumber}
                            {/* {this?.props?.data?.language === "en" ? r?.zone?.zoneName : r?.zone?.zoneNameMr} */}
                          </td>

                          <td>{this?.props?.data?.language == "en" ? r?.driverName : r?.driverName}</td>

                          <td>{this?.props?.data?.language === "en" ? r?.driverNumber : r?.driverNumber}</td>
                          <td>
                            {this?.props?.data?.language === "en"
