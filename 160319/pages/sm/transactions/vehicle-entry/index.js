...
function VehicleEntry() {
  ...
  const getAllVehicle = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((r) => {
        ...
        console.log("rrr22", result);
        let _res = result?.map((r, i) => {
          return {
            ...r,
            inTime: r.inTime,
            inTimeFormatted: r.inTime
              ? moment(r.inTime, "DD-MM-YYYY hh:mm:ss").format("DD-MM-YYYY hh:mm:ss")
              : "",
            outTime: r.outTime,
            outTimeFormatted: r.outTime
              ? moment(r.outTime, "DD-MM-YYYY hh:mm:ss").format("DD-MM-YYYY hh:mm:ss")
              : "",
  ...
  const onSubmitForm = (formData, btnType) => {
    ...
    if (btnSaveText === "Save" && btnType !== "Checkout") {
      ...
      console.log("2", _body, outDate.toISOString());
          ...
          <FormProvider {...methods}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                      ...
                      render={({ field }) => (
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          <DateTimePicker
                            ...
                            helperText={errors.vehicleOutDateTime ? errors.vehicleOutDateTime.message : null}
                      ...
                      render={({ field }) => (
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          <DateTimePicker
                            ...
                            helperText={errors.vehicleInDateTime ? errors.vehicleInDateTime.message : null}
                            inputFormat="DD-MM-YYYY hh:mm:ss"
                            defaultValue={new Date()}
                          />
                        </LocalizationProvider>
              ...
              <Grid container sx={{ padding: "10px" }}>
                ...
                >
                  <Typography>
                    <FormattedLabel id="vehiclePhoto" required />
                  </Typography>
                  <Box>
                    <UploadButtonThumbOP
                      appName={appName}
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={errors.travel_destination ? errors.travel_destination.message : null}
                          />
                        )}
                      />
                    </Grid>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            {...field}
                            label={<FormattedLabel id="approxKm" required />}
                            fullWidth
                            sx={{ width: "90%" }}
                            InputLabelProps={{ shrink: true }}
                            size="small"
              ...
              <Box className={styles.NightDepCheckBtns}>
