          ...
          let _res = result?.map((r, i) => {
            return {
              ...
              checkupDateAndTime: r.checkupDateTime
                ? moment(r.checkupDateTime, "DD-MM-YYYY hh:mm A").format("DD-MM-YYYY hh:mm A")
                : "-",
      ...
      {isOpenCollapse ? (
        <FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <RadioGroup
                        ...
                        sx={{ display: "flex", justifyContent: "space-evenly" }}
                      >
                        <FormControlLabel value="Y" control={<Radio />} label={<FormattedLabel id="on" />} />
                        <FormControlLabel value="N" control={<Radio />} label={<FormattedLabel id="off" />} />
                      </RadioGroup>
                    )}
                  />
                  <FormHelperText style={{ color: "red" }}>
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid xs={12} sm={12} md={6} lg={6} xl={6} item>
                <Typography sx={{ fontWeight: 900 }}>{<FormattedLabel id="FanOn_Off" required />}</Typography>
                <FormControl
                  fullWidth
                  required
                  size="small"
            ...
            <Grid container sx={{ padding: "10px" }}>
              ...
              <Grid xs={12} sm={12} md={6} lg={6} xl={6} item sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <TextField
                      ...
                      helperText={errors.presentEmployeeCount ? errors.presentEmployeeCount.message : null}
                    />
                  )}
                />
              </Grid>
