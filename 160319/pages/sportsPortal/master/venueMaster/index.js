...
const Index = () => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${URLS.SPURL}/venueMaster/saveVenueMaster`, body).then((res) => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    if (btnSaveText === "save") {
      const tempData = axios.post(`${URLS.SPURL}/venueMaster/saveVenueMaster`, _body).then((res) => {
        if (res.status == 200) {
          sweetAlert("Saved!", "Record Saved successfully !", "success");
                    ...
                    <div className={styles.row}>
                      ...
                      <div>
                        <TextField
                          ...
                          {...register("venue")}
                          error={!!errors.venue}
                          helperText={errors?.venue ? "Venue Name is Required !!!" : null}
                        />
                      </div>
                      <div>
                        <TextField
                          ...
                          helperText={errors?.capacity ? "Capacity is Required !!!" : null}
                        />
                      </div>
                    </div>
                    <div className={styles.row}>
                      ...
                      <div>
                        <TextField
                          ...
                          {...register("remark")}
                          error={!!errors.remark}
                          helperText={errors?.remark ? "Remark  is Required !!!" : null}
                        />
                      </div>
                    </div>
                  </div>
