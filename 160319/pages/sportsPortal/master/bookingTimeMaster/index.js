      ...
      .then((r) => {
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            //   "hh:mm A"
            // ),
            fromBookingTime: moment(r.fromBookingTime, "HH:mm:ss").format("HH:mm:ss"),
            // toBookingTime: moment(r.toBookingTime, "hh:mm A").format("hh:mm A"),
            toBookingTime: moment(r.toBookingTime, "HH:mm:ss").format("HH:mm:ss"),
              ...
              <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmitForm)}>
                    ...
                    <div className={styles.row}>
                      ...
                      <div className={styles.fieldss}>
                        <FormControl style={{ marginTop: 10 }} error={!!errors.date}>
                          ...
                          />
                          <FormHelperText>{errors?.date ? errors.toDate.message : null}</FormHelperText>
                        </FormControl>
                      </div>
                      <div className={styles.fieldss}>
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.capacityF}>
                      <TextField
                        id="standard-basic"
