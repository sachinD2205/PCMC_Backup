...
const Index = () => {
  ...
  useEffect(() => {
    axios.get(`${urls.SPURL}/swimmingPool/getById?id=${router?.query?.id}`).then((res) => {
            ...
            <div className={styles.two}>
              ...
              <div className={styles.date4} style={{ marginTop: "2vh" }}>
                <div className={styles.date3}>
                  ...
                  <h4 style={{ marginLeft: "10px" }}>{this?.props?.dataa?.id}</h4>
                </div>
              </div>
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  ...
                  <h4 style={{ marginLeft: "10px" }}>{" " + this?.props?.dataa?.swimmingPoolName}</h4>
                </div>
              </div>
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  ...
                  <h4 style={{ marginLeft: "10px" }}>{" " + this?.props?.dataa?.slots}</h4>
                </div>
              </div>
                ...
                <h5 style={{ marginLeft: "40px", marginRight: "40px" }}>
                  ...
                  <td colSpan={4}>10 रु</td>
                      ...
                      {/* <thead>
                        ...
                        <tr>
                          <td colSpan={4}>1)</td>
                          <td colSpan={4}>{this?.props?.dataa?.swimmingPoolName}</td>
                          <td colSpan={4}>Swimming Pool Daily Pass</td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={4}>
                            <b>एकूण रक्कम : {this?.props?.dataa?.totalAmount}</b>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    {/* {this?.props?.dataa?.marriageDate} */}व मैदान नोंदणीकृत आकारण्यात येणारे शुल्क
                  </b>
                  <b> एकूण फी</b> &nbsp;
                  {/* <b>{this?.props?.dataa?.loi?.amount}</b> */}
                  <b>रु .{this?.props?.dataa?.totalAmount} </b>
                  <br />
                  <br />
                  <b>
