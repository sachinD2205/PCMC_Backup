...
function getSteps(i) {
  return [
    <strong key={1}>Personal Details</strong>,

    <strong key={2}>Swimming Daily Booking</strong>,
...
const LinaerStepper = () => {
  ...
  const handleNext = (data) => {
    ...
    if (activeStep == steps.length - 1) {
      axios
        .post(`${URLS.SPURL}/swimmingPool/save`, data, {
          headers: {
            role: "CITIZEN",
          },
        })
        // .post(
        //   `${URL.SPURL}/sportsBooking/saveSwimmingPoolBooking`,
        //   data,
        //   {
        //     headers: {
        //       role: 'ADMIN',
        ...
        .then((res) => {
          ...
          if (res.status == 200) {
            ...
            // router.push("/components/SwimmingPoolBookingPay");
            // router.push("/sportsPortal/transaction/swimmingPool/PaymentCollection");
            // router.push({
            //   pathname: "/sportsPortal/transaction/swimmingPool/PaymentCollection",
            //   // query: { id: appId },
            // });
            router.push({
              pathname: "/sportsPortal/transaction/swimmingPool/PaymentCollection",
