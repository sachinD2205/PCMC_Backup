...
const Index = () => {
  ...
  //       .get(
  //         `${urls.BaseURL}/facilityAvailabilityStatus/checkStatus`,
  //         finalBodyForApi
  //       )
  //       .then((res) => {
  //         // if (res.status == 200) {
  ...
  //   console.log("Barobar aahe ka re data: ", data);
  //   const tempData = axios
  //     .post(`${urls.BaseURL}/facilityAvailabilityStatus/checkStatus`, data)
  //     .then((res) => {
  //       if (res.status == 200) {
  ...
  const cols = [
...

    {
      ...
      render: (record) => {
        return (
          <>
            {/* () => router.push(`/sportsPortal/transaction/sportBooking`), */}
                ...
                <button
                  onClick={() => {
                    router.push({
                      ...
                      // pathname: `/sportsPortal/transaction/groundsBooking`,

                      // query: { fromBookingTime: res.fromBookingTime },
                    });
                  }}
                >
                  Book Now
                ...
                <div className={styles.row}>
                  ...
                  <div className={styles.row}>
                    <FormControl style={{ marginTop: 0 }} error={!!errors.toDateTime}>
                      ...
                      />
                      <FormHelperText>{errors?.toDateTime ? errors.toDateTime.message : null}</FormHelperText>
                    </FormControl>
                  </div>
