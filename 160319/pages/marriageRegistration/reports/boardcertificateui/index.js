              ...
              >
                ...
                <tr>
                  <div className={styles.data1}>
                    <td>
                      <label>
                        <h3 style={{ marginLeft: '10vh', marginRight: '10vh' }}>
                          <b>
                          ...
                          विवाह नोंदणी <br /> अधिनियम , १९९८ या मधील तरतुदीनुसार
                          आणि मागील पानावरील अटी व शर्ती मधून राहून , सन २०१६ चे
                          विवाह मंडळ नोंदणी / <br />
                          नुतनीकरण रजिस्टर अनुक्रमांक :{' '}
                          <b>
                ...
                <tr className={styles.trrowf}>
                  <td colSpan={2} style={{ paddingBottom: '15vh' }}>
                    {' '}
                    <b>
                      विवाह निबंधक <br></br>{' '}
