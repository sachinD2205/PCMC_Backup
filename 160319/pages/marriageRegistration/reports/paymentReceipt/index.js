        ...
        <div>
          <div className="report">
            <Paper sx={{ padding: 5 }}>
              <table id="table-to-xls" className={styles.report_table}>
                <thead>
                  ...
                  <tr style={{ textAlign: 'left' }}>
                    <th colSpan={3} style={{ paddingLeft: "2vh", textAlign: "left" }}>Received From/कोणाकडून</th>
                    <td colSpan={9} style={{ paddingLeft: "2vh", textAlign: "left" }}>abc</td>
                  </tr>
                  <tr style={{ textAlign: 'left', textAlign: "left" }}>
                    <th colSpan={3} style={{ paddingLeft: "2vh", textAlign: "left" }}>Subject/विषय</th>
                    <td colSpan={9} style={{ paddingLeft: "2vh", textAlign: "left" }}>abc</td>
                  </tr>
                  <tr style={{ textAlign: 'left' }}>
                    <th colSpan={3} style={{ paddingLeft: "2vh", textAlign: "left" }}>Narration/विवरण</th>
                    <td colSpan={9} style={{ paddingLeft: "2vh", textAlign: "left" }}>qwe</td>
                  </tr>
                ...
                this.props.dataToMap.map((r) => (
                  ...
                  <tr colSpan="12" style={{ height: '30px' }}>
                    <td colSpan={12} style={{ textAlign: "left", paddingTop: "5vh" }}>
                      <b style={{ marginLeft: "2vh" }}>
                        PCMC Help Line 111000
                      </b>
                      <br />
              ...
              <table id="table-to-xls" className={styles.report_table} style={{ marginTop: '5vh' }}>
                <thead>
                  <tr >
                    <th colSpan="12" style={{ padding: "5vh" }}>
                      <h3 style={{ color: 'red' }}>
