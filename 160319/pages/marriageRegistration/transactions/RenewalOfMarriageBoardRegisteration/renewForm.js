...
const Index = (props) => {
  ...
  useEffect(() => {
    // axios
    //   .get(
    //     `${urls.MR}/transaction/marriageBoardRegistration/getapplicantById?applicationId=${4}`,
    //   )
    //   .then((resp) => {
  ...
  const onSubmitForm = (data) => {
    ...
    //           )
    //           .then((res) => {
    //             console.log('Save123', res.data[0])
    //             router.push({
                    ...
                    <>
                      ...
                      <div className={styles.row}>
                        <div style={{ marginTop: '20px' }}>
                          <Typography>Board Head Person Photo </Typography>
                      ...
                      <div className={styles.row}>
                        ...
                        <div style={{ marginTop: '20px' }}>
                          <Typography>Other Document</Typography>
                          <UploadButton
                            appName={appName}
                            serviceName={serviceName}
                      ...
                      <div className={styles.btn}>
                        ...
                        <div className={styles.btn1}>
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/marriageRegistration/transactions/boardRegistrationsmui`,
                              )
                            }
                          >
