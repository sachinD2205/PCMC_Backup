        ...
        return (
          <>
            <div className={styles.buttonRow}>
              {record?.row?.applicationStatus === 'APPLICATION SUBMITTED' &&
                (authority?.includes('DOCUMENT_CHECKLIST') ||
                  authority?.includes('ADMIN')) && (
                  <IconButton
                    onClick={() =>
              ...
              {record?.row?.applicationStatus === 'APPROVE BY LI' &&
                (authority?.includes('DOCUMENT_CHECKLIST') ||
                  authority?.includes('ADMIN')) && (
                  <IconButton
                    onClick={() =>
              ...
              {record?.row?.applicationStatus === 'APPROVE BY OS' &&
                (authority?.includes('DOCUMENT_CHECKLIST') ||
                  authority?.includes('ADMIN')) && (
                  <IconButton
                    onClick={() =>
              ...
              {/* MEMBERSHIP_CREATED  */}
              {record?.row?.applicationStatus === 'APPROVE BY HOD' &&
                authority?.find(
