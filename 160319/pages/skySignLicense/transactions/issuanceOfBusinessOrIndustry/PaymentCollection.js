...
const Index = () => {
  ...
  const handlePay = () => {
    setValue('payment.amount', dataa?.trnLoi[0]?.amount)
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.status == 200 || res.status == 201) {
          ...
          router.push({
            pathname:
              '/skySignLicense/transactions/issuanceOfBusinessOrIndustry/ServiceChargeRecipt',
            query: {
              id: router?.query?.id
            },
          })
    ...
    if (router?.query?.serviceId == 7) {
      axios
        ...
        .then((res) => {
          ...
          console.log('board data', res.data.trnApplicantDetailsDao[0])
        })
    }
  }, [])
        ...
        >
          ...
          <div className={styles.appDetails}>
            {/* <div className={styles.row} >
                            <div > */}
            <h4>अर्जाचा क्रमांक : {dataa?.id}</h4>
            {/* </div>
                        </div>
                        <div className={styles.row1}>
                            <div > */}
            <h4>अर्जादारचे नाव :{' ' + dataa?.marFirstName + ' ' + dataa?.marLastName}</h4>
            {/* </div>
                        </div>
                        <div className={styles.row1}>
                            <div > */}
            ...
            <h4>एकुण रक्कम : {dataa?.trnLoi[0]?.amount}</h4>
            ...
            <table id="table-to-xls" className={styles.report_table}>
              <thead>
                ...
                <tr>
                  ...
                  <td colSpan={4}>{dataa?.trnLoi[0]?.amount}</td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td colSpan={4}>
                    <b>एकूण रक्कम : {dataa?.trnLoi[0]?.amount}</b>
                  </td>
                </tr>
              </tbody>
            </table>
