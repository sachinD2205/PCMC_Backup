            ...
            <div className={styles.two}>
              <p>
                <b>
                  ...
                  {this?.props?.data?.trnLoi[0]?.amount}&nbsp;
              ...
              <div className={styles.date2}>
                <h4>LOI NO : </h4>{' '}
                <h4 style={{ marginLeft: '10px' }}>
                  {this?.props?.data?.trnLoi[0]?.loiNo}
                </h4>
              </div>
              ...
              <table id="table-to-xls" className={styles.report_table}>
                <thead>
                  ...
                  <tr>
                    ...
                    <td colSpan={4}>{this?.props?.data?.trnLoi[0]?.amount}</td>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td colSpan={4}>
                      <b>एकूण रक्कम (रु): {this?.props?.data?.trnLoi[0]?.amount}/-</b>
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <div className={styles.date2}>
                ...
                <h4 style={{ marginLeft: '10px' }}>
                  {this?.props?.data?.marFirstName + ' ' + this?.props?.data?.marLastName}
                </h4>
              </div>
              <div className={styles.date2}>
                <h4>संस्थेचे नाव : </h4>
                <h4 style={{ marginLeft: '10px' }}>
                  {this?.props?.data?.trnIndustryBussinessDetailsDao?.nameOfOrganization + ' '}
                </h4>
              </div>
              <div className={styles.date2}>
                <h4>अर्ज दिनांक :</h4>{' '}
