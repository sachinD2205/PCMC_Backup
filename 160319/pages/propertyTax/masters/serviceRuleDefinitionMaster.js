...
import Schema from "../../../containers/schema/propertyTax/masters/serviceRuleDefinitionMaster"
...
const Index = () => {
  ...
  const getAllzoneCategory = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/serviceRule/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let result = res.data?.serviceRule
  ...
  const getServiceRule = () => {
    axios.get(`${urls.PTAXURL}/master/serviceRule/getAll`).then((res) => {
      setZone(
        res.data?.serviceRule.map((r, i) => ({
          id: r.id,
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="serviceRuleDefinitionMaster" />
              </strong>
            </Grid>
          </Box>
