...
import Schema from "../../../containers/schema/propertyTax/masters/chargeNameMaster"
...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/chargeName/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/chargeName/save`, body)
            .then((res) => {
