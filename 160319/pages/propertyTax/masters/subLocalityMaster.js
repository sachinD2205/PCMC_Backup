...
const Index = () => {
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            administrativeZone1: zones?.find(
              (obj) => obj.id === val.administrativeZone
            )?.adZoneName,
            circle: val.circle,
            circleGat: val.circleGat,
            locality: val.locality,
            locality1: localitys?.find((obj) => obj.id === val.locality)
              ?.locality,
  ...
  const columns = [
    ...
    { field: <FormattedLabel id="status" />, headerName: "Status", flex: 1 },
    {
      field: "actions",
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={
                          errors?.subLocalityPrefix
                            ? errors.subLocalityPrefix.message
                            : null
                        }
                      />
                    </Grid>
