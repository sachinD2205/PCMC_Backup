...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/amenities/save`, finalBodyForApi)
      .then((res) => {
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={
                          errors?.amenity ? errors.amenity.message : null
                        }
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        variant="standard"
                        {...register("amenityMr")}
                        error={!!errors.amenityMr}
                        helperText={
                          errors?.amenityMr ? errors.amenityMr.message : null
                        }
                      />
                    </Grid>
