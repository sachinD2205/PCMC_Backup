    ...
    const searchApplication = () => {
        if (watch("applicationNo")) {
            if (logedInUser === "citizenUser") {
                axios
                    .get(
                        `${urls.RTI}/trnRtiApplication/searchByApplicationNumber?applicationNumber=${watch(
                            "applicationNo"
                        )}`, {
                        headers: {
                            UserId: user.id
                ...
                axios.get(`${urls.RTI}/trnRtiApplication/searchByApplicationNumber?applicationNumber=${watch("applicationNo")}`, {
                    headers: {
                        Authorization: `Bearer ${user.token}`,
                    },
                }
