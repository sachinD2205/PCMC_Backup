  ...
  return (
    <>
      ...
      <Paper elevation={8}
        ...
        >
          <h2> <FormattedLabel id='infoTransferMediumMaster' /></h2>
        </Box>
        {isOpenCollapse && (
              ...
              <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4} >
                  <TextField
                    ...
                    helperText={
                      errors?.mediumPrefix ? errors.mediumPrefix.message : null
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}  >
                  <TextField
                    ...
                    helperText={
                      errors?.nameOfMedium ? errors.nameOfMedium.message : null
                    }
                  />
                </Grid>
              </Grid>
