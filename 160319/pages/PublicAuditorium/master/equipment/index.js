      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          return {
            ...
            equipmentCategoryId: equipmentCategory.find((obj) => obj?.id == val.equipmentCategoryId)
              ?.equipmentCategoryName
              ? equipmentCategory.find((obj) => obj?.id == val.equipmentCategoryId)?.equipmentCategoryName
              : "Not Available",
            id: val.id,
              ...
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.equipmentName ? errors.equipmentName.message : null}
                  />
                </Grid>
              </Grid>
              <Grid container style={{ padding: "10px" }}>
