  ...
  useEffect(() => {
    if (router.query.id) {
      axios
        ...
        .then((res) => {
          // let yearOfRenewal = Number(moment(applicationDetails.applicationDate).format("YYYY")) + 1;
          ...
          setApplicationDetails({
            ...
            dateOfRenewal: moment(res.data.applicationDate).format("DD-MM-") + yearOfRenewal,
          });
        })
        .catch((error) => {
        ...
        <div className={styles.licenseWrapper} ref={componentRef}>
          ...
          <div className={styles.header}>
            ...
            <div className={styles.centerHeader}>
              ...
              <label>पाळीव प्राणी परवाना नूतनीकरण</label>
            </div>
          ...
          <div className={styles.subHeader1}>
            ...
            <span>{applicationDetails.licenseNo}</span>
          </div>
          ...
          <table className={styles.tableWrap}>
            ...
            <tr className={styles.tableRow}>
              <td className={styles.tableData1}>{"प्राण्याची नाव/(Pet Name)"}</td>
              <td className={styles.tableData2}>
                {
                  // @ts-ignore
            ...
            <tr className={styles.tableRow}>
              ...
              <td className={styles.tableData2}>{applicationDetails?.applicationDate}</td>
            </tr>
            <tr className={styles.tableRow}>
              <td className={styles.tableData1}>{"परवाना नुतनीकरण दिनांक/(Date of Renewal)"}</td>
              <td className={styles.tableData2}>{applicationDetails?.dateOfRenewal}</td>
            </tr>
            <tr className={styles.tableRow}>
              <td className={styles.tableHeader} colSpan={2}>
                परवाना शुल्क
            ...
            <tr className={styles.tableRow}>
              ...
              <td className={styles.tableData2}></td>
            </tr>
            <tr className={styles.tableRow}>
              <td className={styles.tableData1}>{"परवाना नुतनीकरण फी/(License Renewal Fees)"}</td>
              <td className={styles.tableData2}>Rs. 50.00</td>
            </tr>
            <tr className={styles.tableRow}>
          ...
          <div className={styles.licenseBody}>
            <label>
              श्री/श्रीमती. <span>{applicationDetails.ownerName} </span> राहणार{" "}
              <span>
                {" "}
                {
                  // @ts-ignore
              ...
              परवानगी देणेत येत आहे. परवाना धारकाने परवानगी दिलेल्या वर्षांमध्ये सदरचा परवाना मा. आयुक्त यांनी
              किंवा प्राधिकृत केलेल्या कोणत्याही अधिकाऱ्याने मागणी केलेस तो हजर केले पाहिजे.
            </label>
          </div>
          {/* Signature */}
