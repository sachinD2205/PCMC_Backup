...
const Index = () => {
    ...
    useEffect(() => {
        ...
        // setValue('newspaperLevel','Level 2')
    }, [fetchData]);
    ...
    const getBookClassifications = (_pageSize = 10, _pageNo = 0) => {
        ...
        axios
            ...
            .then((r) => {
                console.log(";r", r);
                let result = r.data.newspaperMasterList;
    ...
    const deleteById = (value, _activeFlag) => {
        ...
        if (_activeFlag === "N") {
            ...
            swal({
                ...
                if (willDelete === true) {
                    axios
                        .delete(`${urls.NRMS}/newspaperMaster/delete/${body.id}`)
                        .then((res) => {
                            console.log("delet res", res);
                            if (res.status == 201) {
    ...
    const columns = [
        { field: "srNo", headerName: "id", flex: 1 },
        {
            ...
            headerName: "Newspaper Agency Name",
            flex: 1,
        },
        {
                            ...
                            <Grid container sx={{
                                ...
                                <Grid item xs={12} sm={12} md={4} lg={4} xl={4}
                                    ...
                                    <TextField
                                        ...
                                        InputLabelProps={{
                                            ...
                                            //true
                                            shrink:
                                                (watch("newspaperAgencyName") ? true : false) ||
                                                (router.query.newspaperAgencyName ? true : false),
                                        }}
                                        helperText={
                                            // errors?.studentName ? errors.studentName.message : null
                                            errors?.newspaperAgencyName ? "Newspaper Agency Name is Required !!!" : null
                                        }
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12} sm={12} md={4} lg={4} xl={4} sx={{
                                    ...
                                    <TextField
                                        ...
                                        InputLabelProps={{
                                            ...
                                            //true
                                            shrink:
                                                (watch("newspaperName") ? true : false) ||
                                                (router.query.newspaperName ? true : false),
                                        }}
                                        helperText={
                                            // errors?.studentName ? errors.studentName.message : null
                                            errors?.newspaperName ? "Newspaper Name is Required !!!" : null
                                        }
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12} sm={12} md={4} lg={4} xl={4} sx={{
                                    ...
                                    <TextField
                                        ...
                                        InputLabelProps={{
                                            ...
                                            //true
                                            shrink:
                                                (watch("newspaperLevel") ? true : false) ||
                                                (router.query.newspaperLevel ? true : false),
                                        }}
                                        helperText={
                                            // errors?.studentName ? errors.studentName.message : null
                                            errors?.newspaperLevel ? "Newspaper Level is Required !!!" : null
                                        }
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12} sm={12} md={4} lg={4} xl={4} sx={{
                                    ...
                                    <TextField
                                        ...
                                        InputLabelProps={{
                                            ...
                                            //true
                                            shrink:
                                                (watch("contactNumber") ? true : false) ||
                                                (router.query.contactNumber ? true : false),
                                        }}
                                        helperText={
                                            // errors?.studentName ? errors.studentName.message : null
                                            errors?.contactNumber ? "Contact Number is Required !!!" : null
                                        }
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12} sm={12} md={4} lg={4} xl={4} sx={{
                                    ...
                                    <TextField
                                        ...
                                        helperText={
                                            // errors?.studentName ? errors.studentName.message : null
                                            errors?.remark ? "Remark Required !!!" : null
                                        }
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12} sm={12} md={4} lg={4} xl={4} sx={{
                                    ...
                                    <TextField
                                        ...
                                        helperText={
                                            // errors?.studentName ? errors.studentName.message : null
                                            errors?.emailId ? "Email Id is Required !!!" : null
                                        }
                                    />
                                </Grid>
