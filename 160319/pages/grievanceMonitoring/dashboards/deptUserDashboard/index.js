...
const DashboardHome = (props) => {
  ...
  const columns = [
    ...
    {
      field: "id",
      headerName: <FormattedLabel id="grievanceId" />,
      minWidth: 161,
      maxWidth: 250,
      headerAlign: "center",
      align: "center",
        ...
        return (
          ...
          >
            ...
            {params?.row?.complaintStatusText === "Open" && (
              ...
              >
                {language === "en" ? (
                  <Tooltip title={`FORWARD GRIEVANCE AGAINST THIS ID : ${params?.row?.id}`}>
                    <ArrowForwardIosIcon style={{ color: "green" }} />
                  </Tooltip>
                ) : (
                  <Tooltip title={`${params?.row?.id} : या आयडी विरुद्ध तक्रार पाठवा `}>
                    <ArrowForwardIosIcon style={{ color: "green" }} />
                  </Tooltip>
                )}
              </IconButton>
                        ...
                        >
                          ...
                          >
                            ...
                            {language == "en"
                              ...
                              : val.nameMr === "तक्रारी फॉरवर्ड केल्या" && (
                                  <Link
                                    style={{ fontWeight: "600" }}
                                    onClick={() => {
                                      setSelectedCard(true);
