...
const Form = () => {
  ...
  const getMediaNames = (_pageSize = 10, _pageNo = 0) => {
    axios.get(`${urls.GM}/mediaMaster/getAll`, {
      params: {
        pageSize: _pageSize,
        pageNo: _pageNo,
      },
  ...
  const columns = [
    ...
    { field: 'mediaName', headerName: <FormattedLabel id="mediaName" />, flex: 1 },
    { field: 'prefix', headerName: <FormattedLabel id="mediaPrefix" />, flex: 1 },
    ...
    <>
      <>
        ...
        >
            ...
            {isOpenCollapse && (
              ...
              >
                <Grid container>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4} style={{ paddingTop: 10 }}>
                    <TextField
                      autoFocus
                      sx={{ width: 250 }}
                      id="standard-basic"
                      label={<FormattedLabel id="mediaPrefix" />}
                      variant="standard"
                      {...register('prefix')}
                      error={!!errors.prefix}
                      helperText={
                        errors?.prefix ? errors.prefix.message : null
                      }
                    />
                  </Grid>
                  {/* </div> */}
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4} style={{ paddingTop: 10 }}>
                    <TextField
                      ...
                      sx={{ width: 250 }}
                      id="standard-basic"
                      label={<FormattedLabel id="mediaPrefixMr" />}
                      variant="standard"
                      {...register('prefixMr')}
                      error={!!errors.prefixMr}
                      helperText={
                        errors?.prefixMr ? errors.prefixMr.message : null
                      }
                    />
                  </Grid>
                  <Grid
          ...
          <DataGrid
            a components={{ Toolbar: GridToolbar }}
            componentsProps={{
              toolbar: {
