...
const DataList = () => {
  ...
  const getBusinessTypes = () => {
    axios.get(`${urls.CFCURL}/master/businessType/getBusinessTypeData`).then((r) => {
      setBusinessTypes(
        r.data.map((row) => ({
          id: row.id,
  ...
  const getBusinesSubType = () => {
    axios
      .get(`${urls.CFCURL}/master/businessSubType/getBusinessSubTypeData`)
      .then((res) => {
        setDataSource(
          res.data.map((r, i) => ({
            id: r.id,
  ...
  const columns = [
    ...
    { field: 'Application Type', headerName: 'Application type', flex: 1 },

    {
      field: 'Template',
      headerName: 'Template Data',
      flex: 1,
    },
    {
      field: 'Remark',
      ...
      <div className={styles.addbtn}>
        <Button
          ...
          onClick={() =>
            router.push({
              pathname:
                '/grievanceMonitoring/masters/applicationTypeMasters/form',
            })
          }
        >
          Add{' '}
