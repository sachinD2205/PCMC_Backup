...
const Index = () => {
  const {
    ...
    reset, watch,
    formState: { errors },
  } = useForm({ resolver: yupResolver(subUsageTypeSchema) });
  ...
  const getSubUsageType = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res, i) => {
        console.log(";res", res.data.mstSbSubUsageTypeList);
        ...
        const _res = result.map((res, i) => {
          ...
          return {
            ...
            remarks: res.remarks,
            // usageTypeName: res.usageTypeKey,
            // usageTypeName: usageType?.find((obj) => {
            //   if (obj?.id === res.usageTypeKey) {
            //     return obj.usageType
            //   }
            // })
              // ?.usageType,
              usageTypeName: usageType?.find((obj) => obj?.id === res.usageTypeKey)
              ?.usageType,
        ...
        console.log("RRRRRRr " + JSON.stringify(_res))
        setDataSource([..._res]);
  ...
  return (
    <>
      ...
      <Paper elevation={8}
        ...
        >
          <h2> <FormattedLabel id='subUsageType' /></h2>
        </Box>
        {isOpenCollapse && (
              ...
              >
                ...
                >
                  ...
                  >
                    <TextField
                      ...
                      helperText={
                        errors?.subUsageTypePrefix ? errors.subUsageTypePrefix.message : null
                      }
                    />
                  </Grid>
                  <Grid item xs={12} sm={6} md={3} lg={3} xl={3}></Grid>
                ...
                >
                  <TextField
                    ...
                    helperText={
                      errors?.subUsageTypeMr ? errors.subUsageTypeMr.message : null
                    }
                  />
                </Grid>
                {/* <Grid
        ...
        <DataGrid
          ...
          columns={columns}
          onPageChange={(_data) => {
            getSubUsageType(pageSize, _data);
          }}
