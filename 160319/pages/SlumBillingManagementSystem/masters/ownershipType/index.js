...
const Index = () => {
  const {
    ...
    reset,
    formState: { errors },
  } = useForm({ resolver: yupResolver(ownershipTypeSchema) });
  ...
  const getOwnershipType = (_pageSize = 10, _pageNo = 0) => {
    ...
    axios
      ...
      .then((res, i) => {
        console.log(";res", res.data.mstSbOwnershipTypeList);
  ...
  return (
    <>
      ...
      <Paper elevation={8}
        ...
        >
          <h2> <FormattedLabel id='ownershipType' /></h2>
        </Box>
        {isOpenCollapse && (
            ...
            <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4} >
                  ...
                  >
                    <TextField
                      ...
                      helperText={
                        errors?.ownershipTypePrefix ? errors.ownershipTypePrefix.message : null
                      }
                    />
                  </Grid>
                ...
                >
                  <TextField
                    ...
                    helperText={
                      errors?.ownershipTypeMr ? errors.ownershipTypeMr.message : null
                    }
                  />
                </Grid>
                {/* <Grid
