...
const Docket = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    // Update Data Based On ID
      ...
      axios
        .post(`${urls.MSURL}/trnNewDocketEntry/save`, finalBodyForApi)
        .then((res) => {
          if (res.status == 200) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.MSURL}/trnNewDocketEntry/save`, body)
            .then((res) => {
