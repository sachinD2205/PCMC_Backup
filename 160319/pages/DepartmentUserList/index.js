...
const DepartmentUserList = () => {
              ...
              <Tooltip title="View">
                <IconButton
                  onClick={(e) => {
                    ...
                    router.push({
                      pathname: "/common/masters/departmentUserRegister",
  ...
  return (
    <div
      style={
        {
          /* height: '100%', width: '100%', padding: '100px' */
        }
      }
    >
      <Box p={1} style={{ display: "flex", justifyContent: "end" }}>
        <Button
          variant="contained"
          onClick={() => {
