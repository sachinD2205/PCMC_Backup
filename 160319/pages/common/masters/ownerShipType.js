...
import BasicLayout from "../../../containers/Layout/BasicLayout";
  ...
  const OwnerShipType = () => {
    ...
    const deleteById = (value, _activeFlag) => {
      ...
      if (_activeFlag === "N") {
        swal({
          ...
          if (willDelete === true) {
            axios
              .post(`${urls.CFCURL}/master/ownershipTypeMaster/save`, body)
              .then((res) => {
    ...
    const onSubmitForm = (formData) => {
      ...
      axios
        .post(
          `${urls.CFCURL}/master/ownershipTypeMaster/save`,
          finalBodyForApi
        )
        .then((res) => {
    ...
    const columns = [
      ...
      {
        field: language === "en" ? "ownershipTypePrefix" : "ownershipTypePrefixMr",
