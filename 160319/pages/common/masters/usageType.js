        ...
        {isOpenCollapse && (
          <Slide direction="down" in={slideChecked} mountOnEnter unmountOnExit>
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <Grid container style={{ paddingx: "10px" }}>
                <Grid
                  item
                  xs={4}
                  style={{
                ...
                >
                  <FormControl style={{ backgroundColor: "white", marginTop: 5 }} error={!!errors.fromDate}>
                    <Controller
                      control={control}
                      name="fromDate"
                      defaultValue={null}
                ...
                >
                  <FormControl style={{ backgroundColor: "white", marginTop: 5 }} error={!!errors.toDate}>
                    <Controller
                      control={control}
                      name="toDate"
                      defaultValue={null}
