...
const BankMaster = () => {
  ...
  //   }).then((willDelete) => {
  //     axios
  //       .delete(`${urls.CFCURL}/master/bank/save/${value}`)
  //       .then((res) => {
  //         if (res.status == 226) {
  //           if (willDelete) {
                      ...
                      <div className={styles.row}>
                        {/* <div className={styles.fieldss}>
                          <TextField
                            ...
                            variant="standard"
                            {...register("bankPrefix")}
                            error={!!errors.bankPrefix}
                            helperText={
                              errors?.bankPrefix
                                ? errors.bankPrefix.message
                                : null
                            }
                          />
                        </div>
                        ...
                        <div className={styles.fieldss}>
                          <TextField
                            ...
                            helperText={
                              errors?.branchAddress ? errors.branchAddress.message : null
                            }
                          />
                        </div>
