...
// Add Form  applicationThroughCFCandHeadOffice
const View = () => {
  // All Const 
  ...
  // Define Form 
  const [applicationThroughCFCandHeadOffice] = Form.useForm()
  ...
  // resetForm Button 
  const resetForm = () => {
    applicationThroughCFCandHeadOffice.resetFields()
  }
  ...
  const handleSave = async () => {
    ...
    // Form Get Values
    const formFields = applicationThroughCFCandHeadOffice.getFieldValue()
    ...
    await axios.post(`${urls.BaseURL}/ApplicationThroughCFCAndHeadOffice/saveApplicationThroughCFCAndHeadOffice`, postValues).then(
      (resp) => {
        if (resp.status == 200) {
    ...
    <div>
      <BasicLayout titleProp={'Application through CFC and Head Office'}>
        <Form
          ...
          form={applicationThroughCFCandHeadOffice}
          layout='vertical'
          onFinish={handleSave}
        >
