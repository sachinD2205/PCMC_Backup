...
const Index = () => {
          ...
          <>
            <IconButton
              onClick={() => {
                ...
                router.push({
                  pathname: `${URLS.APPURL}/townPlanning/transactions/setBackCertificate/view`,
                  query: {
                    pageMode: 'view',
                    ...viewData,
                  },
  ...
  return (
    <>
      <Head>
        <title>Set Back Certificate</title>
      </Head>
      <div>
        <Button
          ...
          onClick={() =>
            router.push({
              pathname: `/townPlanning/transactions/setBackCertificate/view`,
              query: {
                pageMode: 'new',
