...
const Index = () => {
          ...
          <>
            <IconButton
              onClick={() => {
                ...
                router.push({
                  pathname: `${URLS.APPURL}/townPlanning/transactions/developmentPlanOpinion/view`,
                  query: {
                    pageMode: 'view',
                    ...viewData,
                  },
  ...
  return (
    <>
      <Head>
        <title>Developement Plan Opinion</title>
      </Head>
      <div>
        <Button
          ...
          onClick={() =>
            router.push({
              pathname: `/townPlanning/transactions/developmentPlanOpinion/view`,
              query: {
                pageMode: 'new',
