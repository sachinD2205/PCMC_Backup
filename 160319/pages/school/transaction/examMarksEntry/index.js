...
const Index = () => {
  ...
  useEffect(() => {
    getExamMarksEntryMaster();
  }, [fetchData]);


  // Get Table - Data
  const getExamMarksEntryMaster = (_pageSize = 10, _pageNo = 0) => {
  ...
  return (
    ...
    >
                    ...
                    >
                      ...
                      >
                        ...
                        <FormHelperText error={!!errors.academicYearKey}>
                          {errors.academicYearKey ? labels.academicYearRequired : null}
                        </FormHelperText>
                      </FormControl>
                    </Grid>
                    <Grid item
                    ...
                    >
                      ...
                      >
                        ...
                        <FormHelperText error={!!errors.classKey}>
                          {errors.classKey ? labels.academicYearRequired : null}
                        </FormHelperText>
                      </FormControl>
                    </Grid>
                    <Grid item
                    ...
                    >
                      ...
                      >
                        ...
                        <FormHelperText error={!!errors.divisionKey}>
                          {errors.divisionKey ? labels.academicYearRequired : null}
                        </FormHelperText>
                      </FormControl>
                    </Grid>
                    {/* <Grid item
                      ...
                      >
                        ...
                        >
                          ...
                          <Select variant="standard" value={studentId} onChange={(e) => setstudentId(e.target.value)}>
                            {studentList &&
                    ...
                    >
                      ...
                      >
                        ...
                        <FormHelperText error={!!errors.studentKey}>
                          {errors.studentKey ? labels.academicYearRequired : null}
                        </FormHelperText>
                      </FormControl>
                    </Grid>
      ...
      <DataGrid
        ...
        columns={columns}
        onPageChange={(_data) => {
          getExamMarksEntryMaster(data.pageSize, _data);
        }}
        onPageSizeChange={(_data) => {
          console.log("222", _data);
          // updateData("page", 1);   
          getExamMarksEntryMaster(_data, data.page);
        }}
      />
    </Paper>
  );
