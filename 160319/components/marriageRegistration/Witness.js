            ...
            <div className={styles.row}>
              ...
              <div>
                <TextField
                  ...
                  helperText={
                    errors?.witnesses?.[index]?.aadharNo
                      ? errors?.witnesses?.[index]?.aadharNo.message
                      : null
                  }
                />
              </div>
            ...
            >
              ...
              <div>
                    ...
                    render={({ field }) => (
                      <LocalizationProvider dateAdapter={AdapterMoment}>
                        <DatePicker
                          ...
                          //   //   m < 0 ||
                          //   //   (m === 0 &&
                          //   //     marriageDate.getDate() < dob.getDate())
                          //   // ) {
                          //   //   age--
                          //   // }
                          //   // console.log('age', age)
                ...
                {/* <FormControl error={!!errors.witnessDob} sx={{ marginTop: 0 }}>
                  ...
                  />
                  <FormHelperText>
                    {errors?.witnessDob ? errors.witnessDob.message : null}
                  </FormHelperText>
                </FormControl> */}
              </div>
              ...
              <div>
                <TextField
                  ...
                  // InputLabelProps={{
                  //   shrink: true,
                  //   // getValues(`witnesses.${index}.witnessAge`)
                  //   // ? true
                  //   // : false,
                  // }}
                  // InputLabelProps={{ shrink: (watch('witnesses.${index}.witnessAge') ? true : false) }}
                  sx={{ width: 230 }}
                  id="standard-basic"
                  //  disabled={disabledrouter?.query?.disabled}
