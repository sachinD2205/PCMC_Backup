    ...
    if (e.target.checked) {
      ...
      if (getValues("marriageDate")) {
        setValue(
          "bage",
          Math.floor(
            moment(getValues("marriageDate")).format("YYYY") - moment(getValues("bbirthDate")).format("YYYY"),
          ),
        );
      }
        ...
        <div className={styles.row}>
          ...
          <div>
            <FormControl variant="standard" sx={{ marginTop: 2 }} error={!!errors.breligionByAdoption}>
              <InputLabel id="demo-simple-select-standard-label">
                {<FormattedLabel id="Religion2" required />}
              </InputLabel>
              <Controller
                render={({ field }) => (
                  <Select
            ...
            <FormControl variant="standard" sx={{ marginTop: 2 }} error={!!errors.bstatusAtTimeMarriageKey}>
              ...
              <Controller
                render={({ field }) => (
                  ...
                  >
                    {/* {breligionByAdoption &&
                              breligionByAdoption.map((bStatusAtTimeOfMarriage, index) => (
                                <MenuItem key={index} value={bStatusAtTimeOfMarriage.id}>
                                  {bStatusAtTimeOfMarriage.bStatusAtTimeOfMarriage}
                                </MenuItem>
                              ))} */}

                    {/* <MenuItem value={2}>Unmarried</MenuItem>
                    <MenuItem value={3}>Divorce</MenuItem>
                    <MenuItem value={3}>Window / Windower</MenuItem> */}
