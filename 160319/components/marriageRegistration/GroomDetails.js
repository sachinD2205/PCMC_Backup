...
const GroomDetails = () => {
  ...
  // useEffect(() => {
  //     setValue('gtitle', getValues('gtitleMar'))
  // }, [getValues('gtitleMar')])
    ...
    if (e.target.checked) {
      ...
      if (getValues("marriageDate")) {
        setValue(
          "gage",
          Math.floor(
            moment(getValues("marriageDate")).format("YYYY") - moment(getValues("gbirthDate")).format("YYYY"),
          ),
        );
      }
                    ...
                    {gStatusAtTimeMarriageKeys &&
                      gStatusAtTimeMarriageKeys.map((gstatusAtTimeMarriageKey, index) => (
                        <MenuItem key={index} value={gstatusAtTimeMarriageKey.id}>
                          {/* {gstatusAtTimeMarriageKey.gstatusAtTimeMarriageKey} */}
