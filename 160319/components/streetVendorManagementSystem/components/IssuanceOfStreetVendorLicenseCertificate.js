...
const IssuanceOfStreetVendorLicenseCertificate = (props) => {
  ...
  //   axios
  //     .get(`${urls.HMSURL}/master/title/getAll`)
  //     .then((r) => {
  ...
  useEffect(() => {
    ...
    console.log("issuanceOfHawkerLicenseCertificate", props?.props?.id);
  }, [props]);
...
class ComponentToPrint extends React.Component {
  render(props) {
    const { applicantName, dateOfBirth, gender, hawkerType, mobile, fullAddressCrMr } =
            ...
            <tr style={{ border: "2px solid black" }}>
              <div className={styles.main}>
                <div className={styles.one}>
                  <Image src="/sign.png" alt="Maharashtra Logo" height={200} width={200}></Image>
                  <tr>
                ...
                <tr>
                  <center>
                    ...
                    <h3>(मुंबई प्रांतिक मनपा अधिनियम १९४९ चे कलम ३७६ व उपविधी अन्वये)</h3>
                    <h3>(नागरी व प्रशासकीय सेवेसाठी ISO 9001 : 2008 प्रमाणपत्र प्राप्त संस्था )</h3>
                  </center>
                </tr>
                <div className={styles.three}>
                  <Image src="/rts_servicelogo.png" alt="Maharashtra Logo" height={197} width={197}></Image>
                  <tr>
                    <div style={{ marginTop: "5px" }}>
                      <right>
                        <h3>
                ...
                <td>
                  <h3 className={styles.extraWidth1}>
                    <p className={styles.p1}>
                      श्री./श्रीमती. योगेश अशोक रूपवते यांना भारत सरकारच्या "दि स्ट्रीट व्हेंडर्स (प्रोटेक्शन
                      ऑफ लाईव्हलिहूड अँड रेग्युलेशन ऑफ स्ट्रीट व्हेंडींग) अधिनियम २०१४" चे मधील प्रकरण २ कलम ४
                      (१) अन्वये सदर फेरीवाला नोंदणी प्रमाणपत देणेत येते की, महाराष्ट्र शासनाचे आदेशान्वये
                      लागू असलेल्या राष्ट्रीय फेरीवाला धोरण २००९ चे प्रकरण क्र. ४.५.४ मधील तरतूदींनुसार पिंपरी
                      चिंचवड शहरातील ‘‘फेरीवाला व्यावसायिक” म्हणून पिंपरी चिंचवड महानगरपालिकेकडून मॉडर्न
                      इलेक्ट्रॉनिक समोर सिद्धटेक सोसायटी कॉर्नर या चालू व्यवसाय जागेवरील बायोमेट्रीक सर्वेक्षण
                      करण्यात येऊन महानगरपालिका स्तरावर खालील तक्त्यात दर्शविल्याप्रमाणे नोंद घेणेत आलेली आहे.
                    </p>
                  </h3>
                </td>
              </tr>
                ...
                <div className={styles.extraWidth1}>
                  <tr>
                    ...
                    <td colSpan={10} rowSpan={4} className={styles.borderBlack}>
                      <img src="/sign.png" alt="Maharashtra Logo" width={200}></img>
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={20} className={styles.borderBlack}>
                      <h3 className={styles.center} style={{ marginLeft: "5px", marginRight: "5px" }}>
                        निवासाचा पत्ता: आर एच 35, थरमॅक्स चौक, संभाजीनगर चिंचवड पुणे 19
                      </h3>
                    </td>
                  </tr>
                  <tr>
                ...
                <td>
                  <h3 className={styles.extraWidth1}>
                    <p className={styles.p1}>
                      ...
                      सदर नियम व कायदेशीर तरतूदींचा आपणाकडू न भंग झाल्यास आपले फे रीवाला नोंदणी प्रमाणपत्र
                      रद्द करण्यात येईल.
                    </p>
                  </h3>
                </td>
                ...
                <tr>
                  <td rowSpan="4" colSpan={10}>
                    <div style={{ width: "600px", marginLeft: "50px" }}>
                      <img src="/sign.png" alt="Maharashtra Logo" width={200} height={100}></img>
                    </div>
                  </td>
                </tr>
