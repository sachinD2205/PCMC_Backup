...
// ApplicationPaymentReceipt
const ApplicationPaymentReceipt = (props) => {
  const { register, control, setValue, getValue, methods, handleSubmit } = useFormContext();
...
class ComponentToPrint extends React.Component {
  render() {
    const {
      ...
      emailAddress,
      fullAddressCrMr,
      paymentCollection: { receiptDate, receiptNo, receiptAmount, paymentType, paymentMode },
          ...
          >
            ...
            <div>
              ...
              >
                <h3>
                  <b>
                    देय रक्कम :&nbsp;&nbsp; &nbsp;{receiptAmount} ({totalInWords})
                  </b>
                </h3>
