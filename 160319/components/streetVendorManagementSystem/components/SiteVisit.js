...
import UploadButton from "../../streetVendorManagementSystem/fileUpload/UploadButtonHawker";
...
const SiteVisit = (props) => {
  ...
  //   console.log("siteVisitFinalBody ", finalBodyForApi);
  ...
  useEffect(() => {
    console.log("siteVisitProps", props);
  }, []);
