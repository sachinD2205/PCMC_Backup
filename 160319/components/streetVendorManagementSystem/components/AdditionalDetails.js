          ...
          setHawkingDurationDaily(
            r.data.hawkingDurationDaily.map((row) => ({
              ...
              hawkingDurationDailyEn:
                moment(row.hawkingDurationDailyFrom, "HH:mm:ss").format("hh:mm:ss A") +
                " To " +
                moment(row.hawkingDurationDailyTo, "HH:mm:ss").format("hh:mm:ss A"),
              hawkingDurationDailyMr:
                moment(row.hawkingDurationDailyFromMr, "HH:mm:ss").format("hh:mm:ss A") +
                " To " +
                moment(row.hawkingDurationDailyToMr, "HH:mm:ss").format("hh:mm:ss A"),
            })),
          );
        } else {
          <Failed />;
