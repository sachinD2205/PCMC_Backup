...
const Document = () => {
  ...
  useEffect(() => {
    ...
    if (
      getValues("fireDrawingFloorWiseAlsoApprovedByComplianceAuthority") != null
    ) {
      setLift(
        getValues("fireDrawingFloorWiseAlsoApprovedByComplianceAuthority")
      );
    }
  }, []);
      ...
      >
        ...
        <Grid item xs={6} sm={4} md={3} lg={2} xl={1} sx={{ marginTop: 4 }}>
          <Typography variant="subtitle2">
            ...
            Explosive License (for LGP, CNG , Petrol Pump ,Gas Station , Gas
            Storage)
          </Typography>
          <UploadButton
            appName="FBS"
