...
export default class DepartmentWiseCountDetailsToPrint extends React.Component {
  render() {
    ...
    const renderedData = this.props.data.map((r) => {
      return {
        id: r.id,
        deptName: r.deptName,
        deptRunningCount: r.deptRunningCount,
        deptFinalCount: r.deptFinalCount,
        deptOrderJudgementCount: r.deptOrderJudgementCount,
        deptTotalCount: r.deptTotalCount,
        srNo: r.srNo,
      };
    });
            ...
            >
              ...
              >
                ...
                <tr>
                  ...
                  <th style={border}>Department Name</th>
                ...
                {renderedData.map((r) => {
                  return (
                    <tr key={r.id}>
                      ...
                      <td style={border}>{r.deptName}</td>
                      <td style={border}>{r.deptRunningCount}</td>
                      <td style={border}>{r.deptFinalCount}</td>
                      <td style={border}>{r.deptOrderJudgementCount}</td>
                      <td style={border}>{r.deptTotalCount}</td>
                    </tr>
                  );
                })}
              </table>
