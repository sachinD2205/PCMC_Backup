...
const ApplicantDetails = () => {
  ...
  //   axios
  //     .get(
  //       `${urls.BaseURL}/transaction/provisionalBuildingFireNOC/getTrnProvisionalBuildingFireNOCData`
  //     )
  //     .then((res) => {
  ...
  //     axios
  //       .post(
  //         `${urls.BaseURL}/transaction/provisionalBuildingFireNOC/saveTrnProvisionalBuildingFireNOC`,
  //         finalBodyForApi
  //       )
  //       .then((res) => {
  //         if (res.status == 201) {
  ...
  //       axios
  //         .delete(
  //           `${urls.BaseURL}/transaction/provisionalBuildingFireNOC/discardTrnProvisionalBuildingFireNOC/${value}`
  //         )
  //         .then((res) => {
  //           if (res.status == 226) {
