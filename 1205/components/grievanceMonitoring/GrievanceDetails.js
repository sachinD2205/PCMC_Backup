...
const GrievanceDetails = () => {
  ...
  const [openDocArea, setOpenDocArea] = useState(false);
  ...
  useEffect(() => {
    if (watch("complaintTypeId")) {
      // alert("complaintTypes");
      let filterObj = complaintTypes?.filter((obj) => obj.id === watch("complaintTypeId"));
      console.log("complaintTypes", filterObj);
  ...
  ////////////////////////////////
  useEffect(() => {
    if (watch("complaintSubTypeId")) {
      let filterObj = complaintSubTypes?.filter((obj) => obj.id === watch("complaintSubTypeId"));
      console.log("complaintSubTypeId", filterObj);
        ...
        >
          ...
          >
            <TextField
              ...
              variant="standard"
              {...register("subjectMr")}
              error={!!errors.subjectMr}
              helperText={errors?.subjectMr ? errors.subjectMr.message : null}
            />
          </Grid>
          {/* //////////////////////////////////////////////////// */}
          <Grid
          ...
          >
            <TextField
              ...
              helperText={errors?.complaintDescriptionMr ? errors.complaintDescriptionMr.message : null}
            />
          </Grid>
          {/* <Grid
            item
          ...
          {/* {!openDocArea && (
            ...
            >
              <Button
                disabled={openDocArea ? true : false}
                onClick={() => {
                  setOpenDocArea(!openDocArea);
                }}
              >
