...
export default class LeavingCertificateToPrint extends React.Component {
  render() {
    ...
    let isDuplicate = this?.props?.data?.isDuplicate ? "(Duplicate)" : "";
            ...
            <Grid container sx={{ padding: "6px" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    {language == "en" ? `School Leaving Certificate` : `शाळा सोडल्याचा दाखला`}
                  </Box>
                  {isDuplicate && (
                    <div
                      style={{
            ...
            <div style={{ marginLeft: "5px" }}>
              <Grid container sx={{ padding: "6px" }} style={{ textAlign: "center" }}>
                ...
                <Grid item xs={4}>
                  {" "}
                  {language == "en" ? (
                    <Typography>UDICE Code: 11111111111</Typography>
                  ) : (
                    <Typography>UDICE कोड: 11111111111</Typography>
                  )}
                </Grid>
              </Grid>
