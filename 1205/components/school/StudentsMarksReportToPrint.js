        ...
        <div className={styles.main} style={{ border: "2px solid black" }}>
          <div className={styles.small} style={{ margin: "5px" }}>
            <Grid container sx={{ padding: "10px" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    {language == "en" ? "Class 1st to 7th" : "इयत्ता १ ली ते ७ वी"}
                  </Box>
                  <Divider />
                  <Box
                    sx={{
                  ...
                  >
                    ● {language == "en" ? "Student Progress Sheet" : "विद्यार्थी प्रगति पत्रक"}●
                  </Box>
                  <Box
                    sx={{
                      display: "flex",
                  ...
                  >
                    {language == "en" ? "AY : 2022-2023" : "सन : 2022-2023"}
                  </Box>
                </Typography>
              </Grid>
            </Grid>
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={12}>
                <Typography>
                  {language == "en" ? `Roll Number: ${stuData?.id}` : `हजेरी क्र: ${stuData?.id}`}
                </Typography>
              </Grid>
            </Grid>
            <Divider />
            <Grid container sx={{ padding: "10px" }} style={{ textAlign: "center" }}>
              ...
              <Grid item xs={2}>
                <Typography>
                  {language == "en" ? "Division" : "तुकडी"} : {stuData?.divisionName}
                </Typography>
              </Grid>
              <Grid item xs={6}>
                {" "}
                <Typography>
                  {language == "en" ? "Reg.No." : "रजि.नं."} : {stuData?.admissionRegitrationNo}
                </Typography>
              </Grid>
            </Grid>
            <Divider />
            <Grid container sx={{ padding: "10px" }} style={{ textAlign: "center" }}>
              ...
              <Grid item xs={6}>
                <Typography>
                  {language == "en" ? "Business" : "व्यवसाय"} : {stuData?.parentOccupation}
                </Typography>
              </Grid>
            </Grid>
            <Divider />
            ...
            <Grid container sx={{ padding: "10px" }} style={{ textAlign: "center" }}>
              <Grid item xs={6}>
                <Typography style={{ float: "left" }}>
                  {language == "en"
                    ? `MotherTongue: ${stuData?.motherTongue}`
                    : `मातृभाषा: ${stuData?.motherTongueMr}`}
                </Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography>{language == "en" ? "Medium: Marathi" : "माध्यम: मराठी"} </Typography>
              </Grid>
            </Grid>
            <Divider />
            <Grid container sx={{ padding: "10px" }} style={{ textAlign: "center" }}>
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={12}>
                <Typography>
                  {" "}
                  {language == "en" ? "Address" : "पत्ता"}: {stuData?.parentAddress}
                </Typography>
              </Grid>
            </Grid>
            <Divider />
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={12}>
                <Typography>
                  {language == "en" ? "Health information : -" : "आरोग्यविषयक माहिती : -"} -{" "}
                </Typography>
              </Grid>
            </Grid>
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={6}>
                <Typography>{language == "en" ? "Weight" : "वजन"} : </Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography>{language == "en" ? "Height" : "उंची"} : </Typography>
              </Grid>
            </Grid>
            <Divider sx={{ borderBottomWidth: 5 }} />
            <div style={{ marginTop: "100px" }}>
              <TableContainer component={Paper}>
                ...
                >
                  {language == "en" ? "Descriptive Entries" : "वर्णनात्मक नोंदी"}
                </Typography>
                <Divider />
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                  <TableHead>
                    <TableRow>
                      <TableCell style={borderRight}>{language == "en" ? "Subjects" : "विषय"}</TableCell>
                  ...
                  <TableBody>
                    {term1?.map((row) => {
                      ...
                      let T2subjects = term2?.find((i) => i?.subject === subject);
                  ...
                  <TableHead>
                    <TableRow>
                      <TableCell style={borderRight}>
                        {language == "en" ? "Range of Marks" : "गुणांचे वर्गांतर"}
                      </TableCell>
                      {grades?.map((obj) => {
                        return (
                    ...
                    <TableRow>
                      <TableCell style={borderRight}>{language == "en" ? "Grade" : "श्रेणी"}</TableCell>
                      {grades?.map((obj) => {
                        return (
                          <TableCell key={obj?.id} style={borderRight}>
                            {obj?.grade}
