        ...
        >
          ...
          <Grid item xs={12} sm={6} md={4} lg={3} xl={2} sx={{ marginTop: 2 }}>
            <FormControl flexDirection="row">
              ...
              >
                {<FormattedLabel id="oldLicenseYN" />}
              </FormLabel>
            ...
            <>
              <Grid item xs={12} sm={6} md={4} lg={3} xl={2}>
                <TextField
                  ...
                  helperText={errors?.oldLicenseNo ? errors?.oldLicenseNo?.message : null}
                />
              </Grid>
              <Grid item xs={12} sm={6} md={4} lg={3} xl={2}>
            ...
            <Stack direction="row">
              <div style={{ marginRight: "1vh" }}>
                <TextField
                  disabled={watch("disabledFieldInputState")}
                  sx={{ width: "20vh" }}
                  label=<FormattedLabel id="years" />
                  variant="standard"
                  {...register("periodOfResidenceInPCMCYear")}
                  error={!!errors?.periodOfResidenceInPCMCYear}
                  helperText={
                    errors?.periodOfResidenceInPCMCYear ? errors?.periodOfResidenceInPCMCYear?.message : null
                  }
                />
              </div>
              ...
              <div>
                <TextField
                  ...
                  id="standard-basic"
                  sx={{ width: "10vh" }}
                  label=<FormattedLabel id="months" />
                  variant="standard"
            ...
            <Stack direction="row">
              <div style={{ marginRight: "1vh" }}>
                <TextField
                  ...
                  label=<FormattedLabel id="years" />
                  variant="standard"
                  {...register("periodOfResidenceInMaharashtraYear")}
                  error={!!errors?.periodOfResidenceInMaharashtraYear}
                  helperText={
                    errors?.periodOfResidenceInMaharashtraYear
