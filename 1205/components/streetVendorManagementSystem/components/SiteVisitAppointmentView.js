import { Box, Button, CssBaseline, FormControl, FormHelperText, Grid, IconButton, InputLabel, MenuItem, Modal, Paper, Select, Stack, TextField, ThemeProvider } from '@mui/material';
        ...
        <FormProvider {...methods}>
          ...
          <Grid item xs={4} md={4} xl={4} lg={4} sm={4}>
                ...
                render={({ field }) => (
                  <LocalizationProvider dateAdapter={AdapterMoment}>
                    <DatePicker
                      disabled
                      inputFormat="DD/MM/YYYY"
                      label={<span style={{ fontSize: 16 }}>{<FormattedLabel id="siteVisitDate" />}</span>}
                      value={field.value}
                      onChange={(date) => field.onChange(moment(date).format("YYYY-MM-DD"))}
                      selected={field.value}
                      center
            ...
            <TextField
              ...
              helperText={errors?.siteVisitTime ? errors?.siteVisitTime?.message : null}
              />
          ...
          <IconButton
           ...
           {/** Site Visit Schedule Modal OK*/}
                    ...
                    >
                      ...
                      >
                        <CssBaseline />
                        <SiteVisitSchedule appID={getValues("applicationId")} />
                        <Grid container>
                          <Grid
                            item
                            xs={12}
