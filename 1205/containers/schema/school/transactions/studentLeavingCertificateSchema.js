...
let studentLeavingCertificateSchema = yup.object().shape({
  ...
  leavingReason: yup.string().required("Write a reason for Leaving the School(in English"),
  reasonForLeavingSchoolMr: yup.string().required("Write a reason for Leaving the School(in Marathi"),
