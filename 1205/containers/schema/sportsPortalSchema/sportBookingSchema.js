...
export let BookingDetailSchema = yup.object().shape({
  ...
  fromDate: yup.string().required(<FormattedLabel id="VfromDate" />),
  toDate: yup.string().required(<FormattedLabel id="VtoDate" />),
  bookingType: yup.string().required(<FormattedLabel id="VbookingType" />),
});
...
export let documentsUpload = yup.object().shape({
  aadharCard: yup.string().required(<FormattedLabel id="VaadharCard" />),
  panCard: yup.string().required(<FormattedLabel id="VpanCard" />),
  // photo: yup.string().required(<FormattedLabel id="Vphoto" />),
});
