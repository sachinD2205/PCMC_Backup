...
let Schema = yup.object().shape({
  ...
  concessionName: yup.string().required("This field is Required !!!"),
  concessionNameMr: yup.string().required("This field is Required !!!"),
  concessionType: yup.string().required("This field is Required !!!"),
