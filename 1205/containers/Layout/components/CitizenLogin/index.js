      ...
      <Grid container direction="column" spacing={1}>
        ...
        <Grid item>
          <Box className={styles.forgotPwContainer}>
            ...
            /> */}
            <Link tabIndex={0} component="button" color="inherit" onClick={handleForgotPasswordClick}>
        ...
        <Grid item>
          ...
          <div className={styles.formbottom}>
            <Typography>
              ...
              <br />
              <Link tabIndex={1} component="button" onClick={(e) => handleRegisterClick(e)} color="inherit">
