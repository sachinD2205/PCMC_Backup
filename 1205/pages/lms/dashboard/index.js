...
const Index = () => {
  ...
  const getMyApplications = async () => {
    ...
    axios
      .get(`${urls.LMSURL}/reportController/getTotalApplication?userKey=${user.id}`
      )
      .then((resp) => {
    ...
    axios
      .get(`${urls.LMSURL}/reportController/getTotalApprovedApplication?userKey=${user.id}`
      )
      .then((resp) => {
    ...
    axios
      .get(`${urls.LMSURL}/reportController/getTotalPendingApplication?userKey=${user.id}`
      )
      .then((resp) => {
    ...
    axios
      .get(`${urls.LMSURL}/reportController/getTotalMembersInLibrary?userKey=${user.id}`
      )
      .then((resp) => {
                  ...
                  >
                    <Chart
                      options={{
                        ...
                        labels: ["Pending Application", "Approved Application"],
                        responsive: [
                          {
                            breakpoint: 480,
                            options: {
                      ...
                      series={[pendingApplication?.length, approvedApplication?.length]}
