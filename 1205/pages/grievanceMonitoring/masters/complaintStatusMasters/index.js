...
const Form = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    if (btnSaveText === "Save") {
      axios.post(`${urls.GM}/complaintStatusMaster/save`, finalBodyForApi).then((res) => {
        if (res.status == 201) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.GM}/complaintStatusMaster/save`, body).then((res) => {
                ...
                <Grid container>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                    <TextField
                      ...
                      sx={{ width: 250 }}
                      id="standard-basic"
                      label={<FormattedLabel id="complaintStaus" />}
                      variant="standard"
                      {...register("complaintStatus")}
                      error={!!errors.complaintStatus}
                      helperText={errors?.complaintStatus ? errors.complaintStatus.message : null}
                    />
                  </Grid>
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                    <TextField
                      ...
                      helperText={errors?.complaintStatusMr ? errors.complaintStatusMr.message : null}
                    />
                  </Grid>
                </Grid>
