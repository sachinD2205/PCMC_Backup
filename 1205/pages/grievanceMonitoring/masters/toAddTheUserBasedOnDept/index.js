...
const Index = () => {
        ...
        if (res?.status === 200 || res?.status === 201) {
          ...
          let _res = result?.map((val, i) => {
            ...
            return {
              ...
              complaintTypeNameEn: newFunctionForNullValues("en", val.complaintTypeName),
              complaintTypeNameMr: newFunctionForNullValues("mr", val.complaintTypeNameMr),
              ///////////////////////////////////////////
              complaintSubTypeKey: val.complaintSubTypeKey,
              complaintSubTypeNameEn: newFunctionForNullValues("en", val.complaintSubTypeName),
  ...
  const columns = [
    ...
    {
      field: language === "en" ? "complaintSubTypeNameEn" : "complaintSubTypeNameMr",
