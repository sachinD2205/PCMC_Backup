          ...
          <div style={{ display: "flex", justifyContent: "center", alignContent: "center", gap: 10 }}>
            <IconButton
              ...
              onClick={() => {
                ...
                ////////////////////////////ESCALATION////////////////////////////
                setSelectedOption(params?.row?.durationType);
                {
                  params?.row?.durationType === "days" && setValue("days", params?.row?.duration / 1440);
                }
                {
                  params?.row?.durationType === "hours" && setValue("hours", params?.row?.duration / 60);
                }
              }}
            >
