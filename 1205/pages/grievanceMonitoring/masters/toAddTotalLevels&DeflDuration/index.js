...
const Index = () => {
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          return {
            ...
            complaintSubTypeName: newFunctionForNullValues("en", val.complaintSubTypeName),
            complaintSubTypeNameMr: newFunctionForNullValues("mr", val.complaintSubTypeNameMr),
            ////////////////////////////////
            complaintTypeName: newFunctionForNullValues("en", val.complaintTypeName),
            complaintTypeNameMr: newFunctionForNullValues("mr", val.complaintTypeNameMr),
            ///////////////////////////////
  ...
  const columns = [
    ...
    {
      field: language === "en" ? "complaintSubTypeName" : "complaintSubTypeNameMr",
                                ...
                                >
                                  ...
                                  >
                                    <FormControlLabel
                                      ...
                                      label={<FormattedLabel id="escDurationInDays" />}
                                    />
                                    <FormControlLabel
                                      value="hours"
                                      control={<Radio color="primary" />}
                                      label={<FormattedLabel id="escDurationInHours" />}
                                    />
                                  </div>
                                </RadioGroup>
                              )}
                          ...
                          >
                            {selectedOption === "days" ? (
                              <Controller
                                ...
                                render={({ field }) => (
                                  <>
                                    ...
                                    <TextField label={<FormattedLabel id="days" />} {...field} />
                                  </>
                                )}
                              />
                            ) : (
                              <Controller
                                ...
                                render={({ field }) => (
                                  <>
                                    {<FormattedLabel id="hours" />} :{" "}
                                    <Select sx={{ width: "100px" }} label="Hours" {...field}>
                                      {[...Array(18)].map((_, i) => (
