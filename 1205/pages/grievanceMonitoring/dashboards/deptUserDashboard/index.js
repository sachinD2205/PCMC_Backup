      ...
      {loading ? (
        ...
        <>
                          ...
                          >
                            ...
                            {language == "en"
                              ? val.name === "Resolved Grievances" && (
                                  <Link
                                    style={{ fontWeight: "800", color: "green", letterSpacing: "1px" }}
                                    onClick={() => {
                            ...
                            {language == "en"
                              ? val.name === "Unresolved Grievances" && (
                                  <Link
                                    style={{ fontWeight: "800", color: "red", letterSpacing: "1px" }}
                                    onClick={() => {
                                      setSelectedCard(true);
                            ...
                            {language == "en"
                              ...
                              : val.nameMr === "एकूण तक्रारी" && (
                                  <Link
                                    style={{ fontWeight: "800", cursor: "default", letterSpacing: "1px" }}
                                    tabIndex={0}
                                  >
                                    {val.nameMr}
                                  </Link>
          ...
          >
            ...
            >
              <Grid container style={{ padding: "10px" }} justifyContent="center" alignItems="center">
                <Grid item xs={10}></Grid>
                <Grid item xs={2} style={{ display: "flex", justifyContent: "center" }}>
                  <Button
                    variant="contained"
