...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    sweetAlert({
      title: "Are you sure?",
      text: "Do you want to forward this grievance?",
      icon: "warning",
      buttons: ["Cancle", "Yes"],
      dangerMode: false,
      ...
      if (willDelete) {
        axios
          ...
          .then((res) => {
            if (res.status == 200 || res.status == 201) {
              sweetAlert({
                title: "FORWARDED",
                text: `Application Number ${router?.query?.id} Forwarded successfully !`,
                icon: "success",
                dangerMode: false,
                closeOnClickOutside: false,
              }).then((will) => {
        ...
        sweetAlert("Your Grievance is not Forwarded");
      }
    });
  };
                ...
                >
                  <strong style={{ textDecorationColor: "red" }}>
                    {language === "en"
                      ...
                      : "पूर्वी अपलोड केलेला दस्तऐवज विभाग"}
                  </strong>
                </Grid>
