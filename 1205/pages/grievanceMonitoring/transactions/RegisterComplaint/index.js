...
const Index = () => {
  ...
  let callingAxiosReq = (bodyToSend) => {
    if (logedInUser === "citizenUser") {
      // alert("callingAxiosReq > citizenUser");
      return axios.post(`${urls.GM}/trnRegisterComplaint/save`, bodyToSend, {
        headers: { UserId: userCitizen },
      });
    } else {
      // alert("callingAxiosReq > DEPT/CFC USER");
      return axios.post(`${urls.GM}/trnRegisterComplaint/save`, bodyToSend, {
                ...
                sweetAlert({
                  ...
                  text: ` Your Application Number Is : ${
                    res?.data?.applicationNo !== undefined
                      ...
                      : "YOUR GRIEVANCE APPLICATION NUMBER IS NOT GENERATED!"
                  }`,
                  icon: "success",
