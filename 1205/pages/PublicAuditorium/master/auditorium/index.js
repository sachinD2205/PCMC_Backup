...
const Auditorium = () => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          ...
          axios.post(`${urls.PABBMURL}/mstAuditorium/save`, body).then((res) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName:
        language == "en" ? <FormattedLabel id="auditorium" /> : <FormattedLabel id="auditoriumMr" />,
      flex: 1,
      headerAlign: "center",
    },
    {
      field: language == "en" ? "addressEn" : "addressMr",
      headerName: language == "en" ? <FormattedLabel id="address" /> : <FormattedLabel id="addressMr" />,
      // field: "address",
  ...
  return (
    <div>
      <Paper>
        ...
        >
          <h2>
            <FormattedLabel id="newAuditoriumEntry" /> {/* New Auditorium Entry */}
          </h2>
        </Box>
        {loading ? (
          <Loader />
              ...
              <FormProvider {...methods}>
                ...
                <form onSubmit={handleSubmit(onSubmitForm)}>
                  <Grid container style={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.auditoriumNameEn ? errors.auditoriumNameEn.message : null}
                      />
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.auditoriumNameMr ? errors.auditoriumNameMr.message : null}
                      />
                    </Grid>
                  </Grid>
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <FormControl sx={{ width: "90%" }} error={!!errors.startTime}>
                        <Controller
                          name="startTime"
                          control={control}
                          defaultValue={null}
                          render={({ field }) => (
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                              <TimePicker
                                ...
                                renderInput={(params) => (
                                  <TextField {...params} size="small" error={!!errors.startTime} />
                                )}
                              />
                            </LocalizationProvider>
                          )}
                        />
                        <FormHelperText>{errors?.startTime ? errors.startTime.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <FormControl sx={{ width: "90%" }} error={!!errors.endTime}>
                        <Controller
                          name="endTime"
                          control={control}
                          defaultValue={null}
                          render={({ field }) => (
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                              <TimePicker
                                ...
                                renderInput={(params) => (
                                  <TextField {...params} size="small" error={!!errors.endTime} />
                                )}
                              />
                            </LocalizationProvider>
                          )}
                        />
                        <FormHelperText>{errors?.endTime ? errors.endTime.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
                  </Grid>
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.addressEn ? errors.addressEn.message : null}
                      />
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.addressMr ? errors.addressMr.message : null}
                      />
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <TextField
                        sx={{ width: "90%" }}
                        id="standard-basic"
                        label={<FormattedLabel id="gisIdGeocode" />}
                        variant="standard"
