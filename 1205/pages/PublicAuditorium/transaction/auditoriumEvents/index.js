...
const AuditoriumEvents = () => {
  ...
  const columns = [
    ...
    {
      field: language == "en" ? "eventNameEn" : "eventNameMr",
      headerName:
        language == "en" ? <FormattedLabel id="eventNameEn" /> : <FormattedLabel id="eventNameMr" />,
      flex: 1,
      headerAlign: "center",
    },
          ...
          <>
            <IconButton
              onClick={() => {
                ...
                setValue("eventDate", moment(params.row._eventDate).format("YYYY-MM-DDThh:mm:ss"));
              }}
            >
  ...
  const getAuditoriumEvents = (_pageSize = 10, _pageNo = 0) => {
    setLoading(true);
    axios
  ...
  const onSubmitForm = (formData) => {
    ...
    const finalBodyForApi = {
      ...
      eventDate: moment(formData.eventDate).format("YYYY-MM-DDThh:mm:ss"),
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.PABBMURL}/trnAuditoriumEvents/save`, body).then((res) => {
  ...
  return (
    <div>
      <Paper style={{}}>
        ...
        >
          <h2>
            <FormattedLabel id="auditoriumEvents" /> {/* New Auditorium Entry */}
          </h2>
        </Box>
        {loading ? (
          <Loader />
                  ...
                  <FormControl error={errors.auditoriumId} variant="standard" sx={{ width: "90%" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.eventNameEn ? errors.eventNameEn.message : null}
                      />
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.eventNameMr ? errors.eventNameMr.message : null}
                      />
                    </Grid>
                  </Grid>
