...
const BookedPublicAuditorium = () => {
      ...
      renderCell: (params) => {
        return (
          <>
            ...
            {authority?.includes("APPROVAL_REMARK") && params.row.status === "SEND_TO_CLARK" && (
              <Tooltip title="Clerk Action">
                <Button
                  ...
                  onClick={() => {
                    ...
                    setValue("eventDay", moment(params?.row?.eventDate, "DD/MM/YYYY").format("dddd"));
                    setValue("auditoriumBookingNumber", params?.row?.auditoriumBookingNo);
                    setValue("auditoriumId", params?.row?._auditoriumId);
                    setValue("serviceId", params?.row?.serviceId);
                    ...
                    const levelsOfRolesDaoList = params.row.equipmentBookingList.map((val) => {
                      return {
            ...
            {authority?.includes("HOD") && params.row.status === "APPROVE_BY_HOD" && (
              <Tooltip title="LOI Genration">
                <Button
                  ...
                  onClick={() => {
                    ...
                    router.push({
                      pathname: "./bookedPublicAuditorium/LoiGenerationComponent",
                      query: {
            ...
            {authority?.includes("APPROVAL_REMARK") && params.row.status === "LOI_GENERATED" && (
              <Tooltip title="Pay">
                <Button
                  variant="outlined"
                  size="small"
            ...
            {authority?.includes("HOD") && params.row.status === "APPROVE_BY_CLARK" && (
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          return {
            ...
            organizationOwnerFirstName: val.organizationOwnerFirstName ? val.organizationOwnerFirstName : "-",
          };
        });
  ...
  const onSubmitForm = (formData, event) => {
    ...
    const finalBodyForApi = {
      ...
      eventDate: moment(bookedData?.eventDate, "DD-MM-YYYY").format(`YYYY-MM-DD`),
      ...
      remarks: authority?.includes("HOD") ? formData?.approvalRemarkByHod : formData?.approvalRemarkByClark,
      isApproved: submitAction == "save" || submitAction == "approve" ? true : false,
      // serviceId: 113,
  ...
  return (
    <div>
      <Paper>
        ...
        >
          <h2>Booked Public Auditorium</h2>
        </Box>
        {loading ? (
          <Loader />
        ) : (
                      ...
                      <Grid container sx={{ padding: "10px" }}>
                        ...
                        >
                          <TextField
                            ...
                            helperText={errors?.eventDate ? errors.eventDate.message : null}
                          />
                  ...
                  {authority?.includes("APPROVAL_REMARK") ? (
                    <Grid container sx={{ padding: "10px", display: "flex", justifyContent: "center" }}>
                      <TextField
                        ...
                        helperText={
                          errors?.approvalRemarkByClark ? errors.approvalRemarkByClark.message : null
                        }
                      />
                    </Grid>
                  ) : (
                    <>
                      ...
                      <Grid container sx={{ padding: "10px", display: "flex", justifyContent: "center" }}>
                        <TextField
                          ...
                          helperText={errors?.approvalRemarkByHod ? errors.approvalRemarkByHod.message : null}
                        />
                      </Grid>
                    </>
                  )}
                  ...
                  <DataGrid
                    ...
                    getCellClassName={(params) => {
                      if (params.field === "city" || params.value == null) {
                        ...
                        return "yellow";
                      } else if (params.value == "APPROVE_BY_CLARK") {
                        return "gray";
