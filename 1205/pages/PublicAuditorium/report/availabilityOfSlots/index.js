        ...
        .then((res) => {
          ...
          if (res?.status === 200 || res?.status === 201) {
            if (res?.data?.auditoriumBookingDetailsList?.length > 0) {
              let _res = res?.data?.auditoriumBookingDetailsList?.map((r, i) => {
                ...
                return {
                  ...
                  srNo: i + 1,
                  eventDate: moment(r?.bookingDate, "YYYY/MM/DD").format("DD/MM/YYYY"),
                  ...
                  applicationNumber: r?.applicationNumberKey ? r?.applicationNumberKey : "-",
                  applicantMobile: r?.applicantMobileNo,
                  eventTitle: r?.trnAuditoriumBookingOnlineProcess?.eventTitle,
