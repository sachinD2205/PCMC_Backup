  ...
  const getSingleApplicationData =(id,_pageSize = 10, _pageNo = 0)=>{
    ...
    .then((r) => {
      ...
      let temp=result && result.find(each=>each.id==id)
       setsiteVisitData(temp.trnSiteVisite[0].trnExcavationDetailsDao)
        ...
        const tempData = axios
          ...
          .then((res) => {
            if (res.status == 201 || res.status == 200) {
              sweetAlert("Saved!", "Scrutiny Process Saved successfully !", "success");
          ...
          <form onSubmit={handleSubmit(onSubmitFunc)}>
            ...
            >
              ...
              <TextField
                ...
                InputLabelProps={{
                  shrink: router.query.applicationNo || watch("applicationNumber") ? true : false,
                }}
            ...
            <Typography sx={{ marginLeft: "20px" }}>
                <h2>Excavation Details</h2>
                    ...
                    {siteVisitData && siteVisitData.map((item,i)=><>
                      <Grid
                    container
                    spacing={2}
                    style={{
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`zoneId${i}`) ? true : false,
                  }}                 
                ...
                />
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`wardId${i}`) ? true : false,
                  }}                 
                   error={!!errors.wardId}
                  helperText={errors?.wardId ? errors.wardId.message : null}
                />
                    </Grid>
                    <Grid
                      item
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`roadId${i}`) ? true : false,
                  }}                 
                   error={!!errors.roadId}
                  helperText={errors?.roadId ? errors.roadId.message : null}
                /></Grid>
                    {/* ////////////////////////////////////////// */}
                    <Grid
                      item
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`locationOfExcavation${i}`) ? true : false,
                  }}                 
                   error={!!errors.locatonOfExcavation}
                  helperText={errors?.locatonOfExcavation ? errors.locatonOfExcavation.message : null}
                />
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`lengthOfRoad${i}`) ? true : false,
                  }}                 
                ...
                />
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`widthOfRoad${i}`) ? true : false,
                  }}                 
                ...
                />
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`depthOfRoad${i}`) ? true : false,
                  }}                 
                ...
                />
                  ...
                  InputLabelProps={{
                    shrink: router.query.id || watch(`excavationPattern${i}`) ? true : false,
                  }}                 
