                    ...
                    <div >
                        ...
                        <div style={{ margin: "80px", }}>
                            ...
                            प्लॉट क्र. पहिला मजला, ए ब्लॉक, 27. <br></br>
                             ...
                             नरवीर तानाजी वाडी ५- पुणे, शिवाजीनगर.</b><br></br>
                            ...
                            <div >
                                <table className={styles.table} style={{ marginTop: "30px", }}>
                                    <tr className={styles.tr}>
                                        ...
                                        <th className={styles.th}>चेनेज</th>
                                        <th className={styles.th}>रस्त्याचा प्रकार</th>
                                        <th className={styles.th}>लांबी</th>
                                        <th className={styles.th}>रस्ता खोदाईचे शुल्क र.रु. प्रति मी.साठी</th>
                                        <th className={styles.th}>एकूण र.रु.</th>
                                    </tr>
                                    <tr>
                                        <td className={styles.th}>१ </td>
                                        <td className={styles.th}>० ते ३५८८ </td>
                                        <td className={styles.th}>फुटपाथ/रस्ता</td>
                                        <td className={styles.th}>३५८८.००</td>
                                        <td className={styles.th}>३०००</td>
                                        <td className={styles.th}>१,०७,६४,०००/-</td>
                                    </tr>
                                    <tr>
                                        <td className={styles.th}> </td>
                                        <td className={styles.th}>एकूण लांबी</td>
                                        <td className={styles.th}>३५८८.००</td>
                                        <td className={styles.th}>एकूण र.रु. (अ)</td>
                                        <td className={styles.th}>१,०७,६४,०००/-</td>
                                    </tr>
                                </table>
                            </div>
...
<br></br> १३.रस्ता खोदाई सुरू करणे पूर्वी वाहतुक पोलिसांची परवानगी घ्यावी व परवानगीची एक प्रत मनपाच्या स्थापत्य विभागाच्या संबंधित कार्यकारी अभियंता व इकडील कार्याकारी अभियंता यांची पूर्व परवानगी घेणेत यावी व तशी परवानगीची एक प्रत इकडील कार्यालयाकडे देणेत यावी,
...
<br></br>
१४. वाहतुक सावधानतेचा फलक (Safety Cautionary Board)
<br></br>
१५. वाहतुक वळविणेसंबंधीचा फलक (Traffic Diversion Board)
<br></br>
१६. संपूर्ण खोदकामाभोवती लोखंडी कडे (Complete Barricading at work)
<br></br>
१७. विद्युत ब्ब्निकर्स दिवे बसविणे (Light Blinkers at night)
<br></br>
१८. सर्व बोर्डस व दिशादर्शक फलकासाठी रिट्रो रिल्फेक्टीव्ह पेन्टचाच वापर करावा..
<br></br>
१९. सकाळी / संध्याकाळी गर्दीच्या वेळी (Peak Hrs) ट्रैफिक सुरक्षितपणे हाताळणेसाठी ट्रॅफीक वॉर्डन नेमण्यात यावा.
<br></br>
२०. वरील प्रमाणे सर्व नियम कामाचे संपुर्ण दिवसांसाठी (Work Period) काटेकोरपणे पाळणे आवश्यक आहे.
<br></br>
२१. माहिती फलक व दिशादर्शक फलकांसाठी भारतीय रस्ते परिषदेचे (Indian Roads Congress ) नियम व
...
<br></br>३०. आपणास विषयांकीत ठिकाणी आपल्या मागणीनुसार व संबंधित क्षेत्रिय कार्यालयाचे कार्यकारी अभियंता यांनी
...
<br></br>३१. भविष्यात मनपामार्फत ठरविणेत येणारे रस्ता खोदाई शुल्क / भाड्याबाबतचे धोरण मे. महाराष्ट्र नॅचरल गॅस लि. यांना बंधनकारक राहील.
<br></br>३२. प्रत्यक्ष काम संपल्यानंतर प्रस्तावित केलेनुसार संबंधित कंपनीने विषयांकीत काम पूर्ण केले असून त्या व्यतिरीक्त जादा मोजमापाचे काम केलेले नाही याबाबतचा दाखला संबंधित विभागाने मा. आयुक्त यांचेकडे सादर करणे
आवश्यक आहे.
...
<br></br>सोबत :- विषयांकित कामाची नकाशाची प्रत
                        ...
                        <div  style={{ marginTop: "30px", }}>
                                    ...
                                    <br></br>२) मा. कार्यकारी अभियंता, जलनि:सारण विभाग

                                    <br></br>३) मा. कार्यकारी अभियंता, पाणीपुरवठा विभाग

                                    <br></br>४) मा. कार्यकारी अभियंता, विद्युत विभाग

                                    <br></br>५) मा. पोलीस उप-आयुक्त, वाहतूक शाखा

                                    <br></br>६) सन्मा. नगरसदस्य श्री/सौ. 
                                    </b>
                                    </div>
                        </div>
