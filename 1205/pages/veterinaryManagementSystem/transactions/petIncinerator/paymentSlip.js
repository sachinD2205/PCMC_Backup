...
import styles from "../petLicense/paymentSlip.module.css";
      ...
      <Paper className={styles.main}>
          ...
          <div className={styles.officeCopy}>
            ...
            <table className={styles.tableWrap}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>Regarding Small Pet Incineration fee </span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
                <td className={styles.tableData1}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>{applicationDetails.ownerAddress}</span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
                <td className={styles.tableData1}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData2}>
                  <span>{language === "en" ? "₹ 1000.00" : "₹ १०००.००"}</span>
                </td>
                <td className={styles.tableData2}>
                  <span>
                    {language === "en"
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData2}>
                  <span>{language === "en" ? "Incineration Fee" : "अंतिम संस्काराचे शुल्क"}</span>
                </td>
                <td className={styles.tableData2}>
                  <span>{language === "en" ? "₹ 1000.00" : "₹ १०००.००"}</span>
                  <br />
              ...
              <tr className={styles.tableRow}>
                <td className={styles.tableData2}>
                  <label> {language === "en" ? "₹ 1000.00" : "₹ १०००.००"}</label>
                </td>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData3} colSpan={2}>
                  <span>{language === "en" ? "One Thousand Rupees Only" : " एक हजार रुपये फक्त"}</span>
                </td>
          ...
          <div className={styles.customerCopy}>
            ...
            <table className={styles.tableWrap}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData2}>
                  <span>{language === "en" ? "Incineration Fee" : "अंतिम संस्काराची फी"}</span>
                </td>
                <td className={styles.tableData2}>
                  <span>{language === "en" ? "₹ 1000.00" : "₹ १०००.००"}</span>
                  <br />
        ...
        <div className={styles.buttons}>
          ...
          <Button
            ...
            onClick={() => {
              isDeptUser
                ? router.push(`/veterinaryManagementSystem/transactions/petIncinerator/clerk`)
