...
import styles from "../../transactions/petLicense/paymentSlip.module.css";
...
const Index = () => {
  ...
  const handleToPrint = useReactToPrint({
    ...
    documentTitle: "IPD Payment Slip",
  });
  ...
  useEffect(() => {
    if (router.query.id && bankName) {
      axios
        .get(`${URLs.VMS}/trnAnimalTreatmentIpd/getById?id=${router.query.id}`)
        .then((res) => {
          setApplicationDetails({
            ...
            paymentDao: {
              ...res.data.paymentDao,
              bankNameEn: bankName.find((obj) => obj.id == res.data.paymentDao.bankName)?.bankNameEn,
              bankNameMr: bankName.find((obj) => obj.id == res.data.paymentDao.bankName)?.bankNameMr,
            },
          ...
          <div className={styles.officeCopy}>
            ...
            <table className={styles.tableWrap}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData2}>
                  <span>
                    {language === "en" ? "Veterinary Management System" : "पशुवैद्यकीय व्यवस्थापन प्रणाली"}
                  </span>
                </td>
                <td className={styles.tableData2}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>{language === "en" ? "Ipd Registration" : "आंतररुग्ण विभाग नोंदणी"}</span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
                <td className={styles.tableData1}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>
                    {language === "en"
                      ? "Regarding Ipd Registration Fees"
                      : "आंतररुग्ण विभाग नोंदणी बाबत शुल्क"}
                  </span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
              ...
              <tr className={styles.tableRow}>
                <td className={styles.tableData2}>
                  <span>{applicationDetails?.paymentDao?.paymentType}</span>
                </td>
                <td className={styles.tableData2}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData2}>
                  {/* <span>{language === "en" ? "₹ 75.00" : "₹ ७५.००"}</span> */}
                  <span> ₹ {language === "en" ? applicationDetails?.paymentDao?.amount : "₹ ७५.००"}</span>
              ...
              <tr className={styles.tableRow}>
                <td className={styles.tableData2}>
                  ...
                  <label>₹ {applicationDetails?.paymentDao?.amount}</label>
                </td>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData3} colSpan={2}>
                  <span style={{ textTransform: "capitalize" }}>
                    {converter.toWords(applicationDetails?.paymentDao?.amount ?? 0)} rupees
                  </span>
                </td>
          ...
          <div className={styles.customerCopy}>
            ...
            <table className={styles.tableWrap}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>
                    {language === "en" ? "Regarding Ipd Registration" : "आंतररुग्ण विभाग नोंदणी बाबत"}
                  </span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
