...
const Index = () => {
  ...
  let petSchema = yup.object().shape({
    ...
    animalgender: yup.number().required("Please enter the gender of the animal"),
    antiRabiesVaccinationStatus: yup.string().required("Please select whether the animal is vaccinated"),
    vaccinationDate: yup.string().nullable().required(`Please select pet's birthdate`),

    vetDocName: yup.string().required("Please enter name of the veterinary doctor"),
  });
        ...
        <form onSubmit={handleSubmit(finalSubmit)} style={{ padding: "5vh 3%" }}>
          <div className={styles.row}>
            <FormControl variant="standard" error={!!error.petAnimal}>
              ...
              <Controller
                ...
                control={control}
              />
              <FormHelperText>{error?.petAnimal ? error.petAnimal.message : null}</FormHelperText>
            </FormControl>
          ...
          <div className={styles.row}>
            <TextField
              ...
              helperText={error?.flatOrHouseNo ? error.flatOrHouseNo.message : null}
            />
            <TextField
              sx={{ width: "250px" }}
          ...
          <div className={styles.row}>
            ...
            <FormControl variant="standard" error={!!error.animalBreed}>
              ...
              <Controller
                ...
                control={control}
              />
              <FormHelperText>{error?.animalBreed ? error.animalBreed.message : null}</FormHelperText>
            </FormControl>
          </div>
          <div className={styles.row}>
            <TextField
          ...
          <div className={styles.row}>
            <FormControl variant="standard" error={!!error.antiRabiesVaccinationStatus}>
              <InputLabel id="demo-simple-select-standard-label">
