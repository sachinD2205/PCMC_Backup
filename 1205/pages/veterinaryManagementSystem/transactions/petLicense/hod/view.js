...
import { Paper, Button, InputLabel, Select, MenuItem, TextField } from "@mui/material";
          ...
          .then((res) => {
            if (res.status === 200 || res.status === 201) {
              if (watch("action") === "Approved by HOD") {
                ...
                sweetAlert("Success!", "Application rejected!", "success");
              }
        ...
        <form onSubmit={handleSubmit(finalSubmit)} style={{ padding: "5vh 3%" }}>
          ...
          <div className={styles.buttons}>
            ...
            <Button
              ...
              onClick={() => {
                router.push({
                  pathname: `/veterinaryManagementSystem/transactions/petLicense/hod`,
                });
              }}
            >
