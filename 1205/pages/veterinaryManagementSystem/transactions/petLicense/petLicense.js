      ...
      axios
        ...
        .then((res) => {
          if (res.data.status != "License Generated") {
            axios
              .post(`${URLs.VMS}/trnPetLicence/save`, { ...res.data, status: "License Generated" })
              .then((response) => {
          ...
          console.log(moment(res.data.dateOfExpiry).subtract(1, "day"));
            ...
            <div className={styles.licenseWrapper} ref={componentRef}>
              ...
              <div className={styles.subHeader1}>
                ...
                <span>
                  {
                    // @ts-ignore
                    applicationDetails.petLicenceNo
                  }
                </span>
              </div>
