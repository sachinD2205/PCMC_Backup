...
const Login = () => {
  ...
  const [checkedLanguage, setCheckedLanguage] = useState(_language == "en" ? true : false);
    ...
    axios
      ...
      .then((r) => {
        if (r.status == 200) {
          ...
          dispatch(mountLabels(labels));
          localStorage.setItem("isPasswordChanged", r.data.userDao.isPasswordChanged);
              ...
              <Box sx={{ display: "flex", flexDirection: "row" }}>
                <Box style={{ width: "100%" }}>
                  ...
                  >
                    ...
                    <Typography sx={{ typography: { sm: "h5", xs: "subtitle1" } }}>
                  ...
                  <Box sx={{ width: "100%" }}>
                    <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                      ...
                      >
                        <Tab label={findLoginLabel("citizen")} {...a11yProps(0)} />
                        <Tab label={findLoginLabel("department")} {...a11yProps(1)} />
                        <Tab label={findLoginLabel("cfcUser")} {...a11yProps(2)} />
                      </Tabs>
                    </Box>
