...
const Index = () => {
  ...
  useEffect(() => {
    if(zoneDetails && slumDetails && owershipDetails && constrctionDetails){
      getHutMaster();
    }
  }, [zoneDetails,slumDetails,owershipDetails,constrctionDetails])
  ...
  const getUsageSubTypeDetails = (id) => {
    axios
      .get(
        `${urls.SLUMURL}/mstSbSubUsageType/getSubUsageByUsageId?id=${id}`
      )
      .then((res) => {
                      ...
                      render={({ field }) => (
                        <Select
                          ...
                          onChange={(value) => {
                            ...
                            getUsageSubTypeDetails(value.target.value)
                          }}
                        >
                          {usageDetails &&
