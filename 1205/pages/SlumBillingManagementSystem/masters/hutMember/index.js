...
const Index = () => {
  ...
  const getSubCasteDetails = () => {
        axios.get(`${urls.CFCURL}/master/subCast/getAll`).then((r)=>{
        setSubCasteDetails(
        ...
        .then((res, i) => {
          ...
          const _res = result.map((res, i) => {
            return {
              ...
              firstNameMr: res.firstNameMr,
              middleNameMr: res.middleNameMr,
              lastNameMr: res.lastNameMr,
