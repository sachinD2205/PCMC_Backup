...
const Index = () => {
  const {
    ...
    reset, watch,
    formState: { errors },
  } = useForm({ resolver: yupResolver(educationCategorySchema) });
  ...
  return (
    <>
      ...
      <Paper elevation={8}
        ...
        >
          <h2> <FormattedLabel id='educationCategory' /></h2>
        </Box>
        {isOpenCollapse && (
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={
                      errors?.educationCategoryPrefix ? errors.educationCategoryPrefix.message : null
                    }
                  />
                </Grid>
              ...
              <Grid item xs={12} sm={6} md={4} lg={4} xl={4} >
                <TextField
                  ...
                  helperText={
                    errors?.educationCategory ? errors.educationCategory.message : null
                  }
                />
              </Grid>
              <Grid item xs={12} sm={6} md={3} lg={3} xl={3}></Grid>
              ...
              >
                <TextField
                  ...
                  helperText={
                    errors?.educationCategoryMr ? errors.educationCategoryMr.message : null
                  }
                />
              </Grid>
              <Grid
      ...
      <DataGrid
        ...
        columns={columns}
        onPageChange={(_data) => {
          getEducationCategory(pageSize, _data);
        }}
