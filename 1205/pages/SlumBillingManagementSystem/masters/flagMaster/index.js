...
import flagMasterSchema from "../../../../containers/schema/slumManagementSchema/flagMasterSchema";
...
const Index = () => {
  const {
    ...
    reset, watch,
    formState: { errors },
  } = useForm({ resolver: yupResolver(flagMasterSchema) });
  ...
  const getFlagDetails = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.SLUMURL}/mstSbFlag/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res, i) => {
        let result = res.data.mstSbFlagList;
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.SLUMURL}/mstSbFlag/save`, body)
            .then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.SLUMURL}/mstSbFlag/save`, finalBodyForApi)
      .then((res) => {
  ...
  return (
    <>
      ...
      <Paper elevation={8}
        ...
        >
          <h2> <FormattedLabel id='flagName' /></h2>
        </Box>
        {isOpenCollapse && (
              ...
              <Grid container>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  ...
                  >
                    ...
                    />
                    <FormHelperText>
                      {errors?.applicableOn ? errors.applicableOn.message : null}
                    </FormHelperText>
                  </FormControl>
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                      ...
                      <TextField
                        ...
                        error={!!errors.setFor}
                        helperText={
                          errors?.setFor ? errors.setFor.message : null
                        }
                      />
                    </Grid>
                    <Grid item xs={12} sm={6} md={3} lg={3} xl={3}></Grid>
                  ...
                  >
                    <TextField
                      ...
                      id="outlined-basic"
                      // label="CFC Name Mr"
                      label={<FormattedLabel id="flagNameMr" />}
                      variant="standard"
                      {...register("flagNameMr")}
                      error={!!errors.flagNameMr}
                      helperText={
                        errors?.flagNameMr ? errors.flagNameMr.message : null
                      }
                    />
                  </Grid>
                  {/* <Grid
