...
const Index = () => {
    ...
    if (loggedInUser === "citizenUser") {
      axios
        ...
        .then((r) => {
          ...
          let result = r.data.trnIssueNocList;
  ...
  const handleAddButton = () => {
    router.push("/SlumBillingManagementSystem/transactions/issuanceOfNoc/addApplicantDetails");
  };
                ...
                <Tooltip title="Reschedule Site Visit">
                  <IconButton
                    onClick={() => {
                      router.push({
                        pathname:
                          "/SlumBillingManagementSystem/transactions/issuanceOfNoc/scheduleSiteVisit",
                        query: {
                          id: params.row.id,
                        },
                      });
