...
const Index = () => {
  ...
  const [ownershipData, setOwnershipData] = useState([{ id: 1, ownershipType: "" }]);
  const [usageTypeData, setUsageTypeData] = useState([{ id: 1, usageType: "" }]);
  ...
  useEffect(() => {
    if (router.query.id) {
      //Get Bill Data
      axios.get(`${URLs.SLUMURL}/trnBill/getById?id=${router.query.id}`, config).then((res) => {
        setBillData({
          billNo: res.data.billNo ?? "--",
          billDate: moment(res.data.billDate).format("DD / MM / YYYY") ?? "--",
          slumName: slumData.find((obj) => obj.id == res.data.slumKey)?.slumName ?? "--",
          ownership: ownershipData.find((obj) => obj.id == res.data.ownershipKey)?.ownershipType ?? "--",
          ownerName:
            res.data.ownerFirstName + " " + res.data.ownerMiddleName + " " + res.data.ownerLastName ?? "--",
          areaName: areaData.find((obj) => obj.id == res.data.areaKey)?.areaName ?? "--",
          usageType: usageTypeData.find((obj) => obj.id == res.data.usageTypeKey)?.usageType ?? "--",
          hutNo: res.data.hutNo ?? "--",
          area: res.data.areaOfHut ?? "--",
          fromDate: moment(res.data.billFromDate).format("DD / MM / YYYY") ?? "--",
          toDate: moment(res.data.billToDate).format("DD / MM / YYYY") ?? "--",
      ...
      <Paper className={styles.main}>
        <div className={styles.wrapper} ref={componentRef}>
          <div className={styles.head}>
            ...
            <div className={styles.headContent}>
              ...
              <span className={styles.heading}>झोपडपट्टी निर्मुलन व पुनर्वसन विभाग</span>
              <span className={styles.subHeading}>एकत्रित सेवा शुल्क बील</span>
              <span className={styles.subHeading}>
                महाराष्ट्र शासन निर्णय क्र. गवसु/१२२०/प्रक-२०४(१)झोपसु(१), दिनांक ११ जुलै २००१
              </span>
              <span className={styles.subHeading}>
                महाराष्ट्र शासन निर्णय क्र. गवसु/१२२०/प्रक-३६४(२)झोपसु(१), दिनांक ३ मे २००३
              </span>
            </div>
          </div>
          ...
          <table className={styles.billDetails1}>
            ...
            <tr>
              <td>
                <span>झोपडी धरकाचे नाव/ पत्ता:</span>
              </td>
              <td>
          ...
          <p className={styles.highlightContent}>
            पिंपरी चिंचवड महानगरपालिकेच्या हद्दीत आपल्या वर नमूद केलेल्या झोपडीवरील एकत्रित सेवा शुकाची
            खालीलप्रमाणे आपणांस मागणी करण्यात येत आहे. या बीलात मागणी केलेली रक्कम, हे बील आपणांस मिळाले पासून
            पंधरा दिवसाच्या आत महानगरपालिकेच्या झोपडपट्टी निर्मुलन व पुनर्वसन कार्यालयात रोख भरावी.
          </p>
          <table className={styles.billDetails2}>
            ...
            <tr>
              ...
              <td>
                <span className={styles.dataText}>{billData.billPreviousAmount}</span>
              </td>
              <td>
                <span className={styles.dataText}>{billData.billCurrentAmount}</span>
              </td>
              <td>
                <span className={styles.dataText}>{billData.balanceAmount}</span>
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "left" }}>
          ...
          <div className={`${styles.instructions} ${styles.highlightContent}`}>
            ...
            <p>
              १) एकत्रित सेवा शुल्काबाबतची सविस्तर माहिती कार्यालयात पहावयास मिळेल. <br />
              २) रोख रक्कम झोपडपट्टी निर्मुलन व पुनर्वसन कार्यालयामध्ये भरावी व पावती घ्यावी. <br />
              ३) पावतीशिवाय पैसे भरले आहेत, असे ग्राह्य धरले जाणार नाही. <br />
              ४) एकत्रित सेवा शुल्काची रक्कम धरण्याची कार्यालयीन वेळ (सुट्टीचे दिवस सोडून) १०-०० ते दुपारी
              ४-०० वाजेपर्यंत <br />
              ५) रक्कम भरण्यास येताना कृपया हे बील सोबत आणावे. काही तक्रारअसल्यास मागील पावत्या सोबत आणाव्यात.
              <br />
              ६) सेवा आकार हा महापालिकेकडून मिळणाऱ्या सेवा, सुविधायांचे प्रीत्यर्थ आहे. सेवा आकार भरला म्हणजे
              झोपडीचा अथवा जागेचा अधिकृतपणा झाला असे समजले जाणार नाही.
            </p>
          </div>
          <div className={styles.row}>
            <span>बिलातील झोपडी क्षेत्रापेक्षा वाढीव क्षेत्र अढळून आल्यास त्याप्रमाणे वाढीव</span>
            <span>क्षेत्राची एकत्रित सेवा शुल्क आकारणी व वसुली करण्यात येईल.</span>
          </div>
        ...
        <div className={styles.buttons}>
          ...
          <Button
            ...
            endIcon={<ExitToApp />}
            onClick={() => {
              router.push("/SlumBillingManagementSystem/transactions/hutBillGeneration/billsGenerated");
            }}
          >
            Exit
          </Button>
