...
//funxtion to get photopass issuance data by filter by application no
  ...
  const getLoiGenerationData = (applicationNo) => {
    ...
    if (logedInUser === "citizenUser") {
      axios.get(`${urls.SLUMURL}/trnIssuePhotopass/search/applicationNumber?applicationNumber=${applicationNo}`, {
        headers: {
          UserId: user.id
        }
      }).then((res) => {
  ...
  const getApplicationDetails = (data) => {
    if (logedInUser === "citizenUser") {
      axios.get(`${urls.SLUMURL}/trnIssuePhotopass/getAll`, {
        headers: {
          UserId: user.id
        }
      },).then((res) => {
  ...
  return (
    <div>
         <br/>
      <div>
        <ComponentToPrint ref={componentRef} data={data} slumData={slumData} areaData={areaData} villageData={villageData} cityData={cityData}  application={applications} deptNm={deptnm} />
      </div>
        ...
        <div className={styles.main}>
          <div className={styles.small}>
            ...
            <div className={styles.two}>
              <p>
                <b>
                  <h3><FormattedLabel id="ackDear" />, {this?.props?.data?.applicantFirstName + " " + this?.props?.data?.applicantMiddleName + " " + this?.props?.data?.applicantLastName}</h3>
                  <br></br> <FormattedLabel id="rtiApplicationAmt" />: {this?.props?.data?.feesApplicable} <br />
              ...
              <table id="table-to-xls" className={styles.report_table} style={{ marginLeft: "10px"}}>
                <thead>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colSpan={4}><FormattedLabel id="insuranceOfPhotopass" /></td>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colSpan={4}>
                      <b><FormattedLabel id="totalAmount" /> : {this?.props?.data?.feesApplicable}</b>
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <div className={styles.date2}>
                ...
                <h4 style={{ marginLeft: "10px" }}>{this?.props?.data?.applicantFirstName + " " + this?.props?.data?.applicantMiddleName + " " + this?.props?.data?.applicantLastName}</h4>
              </div>
