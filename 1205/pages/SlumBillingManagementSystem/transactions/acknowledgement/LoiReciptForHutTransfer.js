...
const LoiGenerationRecipt = () => {
  ...
  const [hutTransferData, setHutTransferData] = useState({});
            ...
            <div className={styles.two}>
              <p>
                <b>
                  ...
                  <br></br> <FormattedLabel id="hutTransferAmt" />: {this?.props?.data?.feesApplicable} <br />
              ...
              <table id="table-to-xls" className={styles.report_table} style={{marginLeft: "10px"}}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colSpan={4}>
                      <b><FormattedLabel id="totalAmount" /> : { this?.props?.data?.penaltyCharge ? this?.props?.data?.feesApplicable + this?.props?.data?.penaltyCharge : this?.props?.data?.feesApplicable} </b>
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <div className={styles.date2}>
                ...
                <h4 style={{ marginLeft: "5px" }}>{this?.props?.data?.applicationNo}</h4>
              </div>
