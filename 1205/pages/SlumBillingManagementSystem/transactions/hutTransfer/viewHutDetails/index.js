      ...
      const tempData = axios
        ...
        .then((res) => {
          if (res.status == 201) {
            sweetAlert(
              "Revert!",
              `Hut Transfer ${dataSource.applicationNo} Revert Back successfully !`,
              "success",
            );
            router.push("/SlumBillingManagementSystem/transactions/hutTransfer/hutTransferDetails");
          }
      ...
      const tempData = axios
        ...
        .then((res) => {
          if (res.status == 201) {
            sweetAlert(
              "Rejected!",
              `Hut Transfer ${dataSource.applicationNo} Rejected successfully !`,
              "success",
            );
            router.push("/SlumBillingManagementSystem/transactions/hutTransfer/hutTransferDetails");
          }
              ...
              <Grid container xl={12} lg={12} md={12} sm={12} xs={12}>
                {dataSource?.status == 21 ? (
                  ...
                  <>
                    ...
                    (dataSource?.status == 14 || dataSource?.status == 2 || dataSource?.status == 22) ? (
                      <Grid
                        item
                        xl={4}
                        lg={4}
