...
const EntryForm = () => {
    ...
    const onSubmitForm = (formData) => {
        ...
        console.log("Save New COnnection ............ 28")
        const tempData = axios
            .post(`${urls.SLUMURL}/save`, body)
            .then((res) => {
                console.log("res", res);
                if (res.status == 201) {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <h2> <FormattedLabel id="collection" /></h2>
                </Box>
                                ...
                                <Grid container sx={{ padding: "10px" }}>
                                    ...
                                    >
                                        ...
                                        >
                                                ...
                                                render={({ field }) => (
                                                    <LocalizationProvider dateAdapter={AdapterMoment}>
                                                        <DatePicker
                                                            ...
                                                            onChange={
                                                                (date) =>
                                                                setMeterConnectionDate(moment(date).format("YYYY-MM-DDThh:mm:ss"))
                                                            }
                                            ...
                                            />
                                            <FormHelperText>
                                                {errors?.trnCollectionDate ? errors.trnCollectionDate.message : null}
                                            </FormHelperText>
                                        </FormControl>
                                    </Grid>
                                    ...
                                    >
                                        <TextField
                                            ...
                                            helperText={
                                                errors?.collectionCenter ? errors.collectionCenter.message : null
                                            }                                        />
                                    </Grid>
                                    <Grid
                                        item
                                    ...
                                    >
                                        <TextField
                                            ...
                                            helperText={
                                                errors?.codeDescription ? errors.codeDescription.message : null
                                            }
                                        />
                                    </Grid>
                                     <Grid
