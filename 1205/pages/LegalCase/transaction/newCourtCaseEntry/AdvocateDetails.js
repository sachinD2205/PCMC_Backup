      ...
      <ThemeProvider theme={theme}>
        <Grid container style={{ marginLeft: 70, padding: "10px" }}>
          ...
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
            <FormControl variant="standard" sx={{ minWidth: 190 }} error={!!errors?.advocateName}>
              ...
              <Controller
                    ...
                    {advocateNames &&
                      advocateNames.map((advocateName, index) => (
                        <MenuItem key={index} value={advocateName?.id}>
                          {language == "en" ? advocateName?.advocateName : advocateName?.advocateNameMr}
                        </MenuItem>
                      ))}
                  </Select>
                )}
                ...
                defaultValue=""
              />
              <FormHelperText>{errors?.advocateName ? errors?.advocateName?.message : null}</FormHelperText>
            </FormControl>
          </Grid>
          ...
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
            <TextField
              ...
              helperText={errors?.opponentAdvocate ? errors?.opponentAdvocate?.message : null}
            />
          </Grid>
          {/** OppenentAdovovateMr */}
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
            <TextField
              ...
              helperText={errors?.opponentAdvocateMr ? errors?.opponentAdvocateMr?.message : null}
            />
          </Grid>
          {/** depet name */}
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
            <FormControl variant="standard" sx={{ minWidth: 190 }} error={!!errors?.department}>
              <InputLabel id="demo-simple-select-standard-label">
                    ...
                    {departmentNames &&
                      departmentNames.map((deptName, index) => (
                        <MenuItem key={index} value={deptName?.id}>
                          {language == "en" ? deptName?.department : deptNameMr?.departmentMr}
                        </MenuItem>
                      ))}
                  </Select>
                )}
          ...
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
            <TextField
              ...
              helperText={errors?.concernPerson ? errors?.concernPerson?.message : null}
            />
          </Grid>
          {/**concernPersonMr */}
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
          ...
          {/**applicationDate */}
          <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
            <FormControl style={{ marginTop: 10 }} error={!!errors?.appearanceDate}>
              <Controller
                control={control}
                name="appearanceDate"
                defaultValue={null}
              ...
              />
              <FormHelperText>
                {errors?.appearanceDate ? errors?.appearanceDate?.message : null}
              </FormHelperText>
            </FormControl>
          </Grid>
        </Grid>
