    ...
    return (
      <>
        <div className={styles.main} >
          <div className={styles.small1} style={{ display: "flex", width: "100vw", flexDirection: "column"}}>
          ...
          >
            ...
            <Grid container>
              ...
              >
                ...
                >Writtern Statement in English :{this?.props?.data?.lawyerRemarkEn}</label>
              </Grid>
            </Grid>
            ...
            <Grid container>
              <Grid item xs={12}>
                ...
                >Writtern Statement in Marathi:{this?.props?.data?.lawyerRemarkMr}</label>
              </Grid>
            </Grid>
            ...
            marginTop:"100px",
             ...
             paddingLeft:"500px"
              ...
              <Grid item xs={12} style={{alignContent:"end", width: "50px"}}>
                <label
                style={{
                  fontSize:"20px"
                }}
              ...
              <Grid item xs={10.3} style={{alignContent:"end", width: "50px"}}>
                <label
                style={{
                  fontSize:"20px"
                }}
                >{this?.props?.data?.advocateName2}</label>
              </Grid>
            </Grid>
          </Grid>
          </div>
