...
const Documents = (props) => {
  ...
  const [trnOpinionAttachmentDao, settrnOpinionAttachmentDao] =
    useState([]);
  ...
  useEffect(() => {
    if (localStorage.getItem("trnOpinionAttachmentDao") !== null) {
      setAdditionalFiles(
        JSON.parse(localStorage.getItem("trnOpinionAttachmentDao")),
      );
    }
    // delete
  ...
  useEffect(() => {
    settrnOpinionAttachmentDao([...mainFiles, ...additionalFiles]);
    localStorage.setItem(
      "trnOpinionAttachmentDao",
    ...
    <>
      ...
      >
        ...
        <FileTable
          ...
          rows={trnOpinionAttachmentDao} //state to be displayed in table
