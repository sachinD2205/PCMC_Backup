    ...
    axios
      ...
      .then((r) => {
        ...
        let _res = result
          ...
          // }
          // })
          .filter((op) => ['OPINION_CREATED', 'ADV_OPINION_PARTIALLY_SUBMITTED'].includes(op.status))
          .map((r, i) => {
            console.log("44");
            return {
              ...
              // showToOpUser: (r.opinionAdvPanelList.length > 0 && r.advPanelremark == true) ? false : true,
              // showToRptUser: (r.reportAdvPanelList.length > 0 && r.advRptRemark == true) ? false : true
            };
          });
