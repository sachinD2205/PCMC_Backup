    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <>
            {/* NOTICE_DRAFT */}
            {(authority?.includes("NOTICE_ENTRY") || authority?.includes("NOTICE_CREATED")) &&
              ...
              params.row.status === "PARAWISE_REPORT_APPROVED" && (
                <Button
                  ...
                  onClick={() => {
                    ...
                    router.push({
                      pathname: "/LegalCase/transaction/responseToNotice/addForm",
                    });
                  }}
                >
            ...
            {authority?.includes("FINAL_APPROVAL") && params.row.status === "FINAL_APPROVED" && (
              <Button
                variant="outlined"
                sx={{
                  cursor: "pointer",
