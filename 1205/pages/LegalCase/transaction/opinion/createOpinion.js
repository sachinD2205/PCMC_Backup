...
const View = () => {
  ...
  const handleChange = (event) => {
    ...
    setSelectedID(event.target.value.map((v) => advocateNames.find((o) => o.FullName === v).id));
  };
  ...
  const handleChange1 = (event) => {
    ...
    setSelectedID1(event.target.value.map((v) => advocateNames.find((o) => o.FullName === v).id));
  };
  ...
  useEffect(() => {
    if (
      ...
      axios.get(`${urls.LCMSURL}/transaction/opinion/getById?id=${router?.query?.id}`).then((res) => {
        ...
        console.log("advPanel------", res.data.advPanel, "type:", typeof router.query.advPanel);

        console.log("reportAdvPanel------", res.data.reportAdvPanel, "type:", typeof router.query.advPanel);
            ...
            <Box p={4}>
              <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmitForm)}>
                  ...
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.opinionNo ? errors.opinionNo.message : null}
                        InputLabelProps={{
                          //true
                          shrink:
                            (watch("opinionNo") ? true : false) || (router.query.opinionNo ? true : false),
                        }}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        InputLabelProps={{
                          //true
                          shrink:
                            (watch("inwardNo") ? true : false) || (router.query.inwardNo ? true : false),
                        }}
                      />
                    </Grid>
                  ...
                  {/* Container for Department Name and Opinion Subject */}
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.opinionSubjectMr ? errors.opinionSubjectMr.message : null}
                        InputLabelProps={{
                          //true
                          shrink:
                              ...
                              >
                                {advocateNames.map((advocateName) => (
                                  ...
                                  >
                                    <Checkbox
                                      checked={
                                        selected.indexOf(advocateName.FullName) > -1
                                        // selected.indexOf( language === "en"
                                        // ? advocateName?.FullName
                                        // : advocateName?.FullNameMr) > -1
                                      }
                                    />
                                    <ListItemText
                                      primary={
                                        // advocateName.FullName
                                        language === "en" ? advocateName?.FullName : advocateName?.FullNameMr
                                      }
                                    />
                                  </MenuItem>
                                ))}
                      ...
                      <Box>
                        {isOpenCollapse1 && (
                          <TextField
                            ...
                            helperText={errors?.panelRemarks ? errors.panelRemarks.message : null}
                          />
                        )}
                      </Box>
                    </Grid>
                      ...
                      <Box>
                        {isOpenCollapse1 && (
                          <TextField
                            ...
                            helperText={errors?.panelRemarksMr ? errors.panelRemarksMr.message : null}
                          />
                        )}
                      </Box>
                    </Grid>
                          ...
                          >
                            ...
                            >
                              {advocateNames.map((advocateNames) => (
                                ...
                                >
                                  <Checkbox checked={selected1.indexOf(advocateNames.FullName) > -1} />
                                  <ListItemText
                                    primary={
                                      // advocateNames.FullName

                                      language === "en" ? advocateNames?.FullName : advocateNames?.FullNameMr
                                    }
                                  />
                                </MenuItem>
                              ))}
                        ...
                        <>
                          <Box>
                            <TextField
                              ...
                              helperText={errors?.reportRemarks ? errors.reportRemarks.message : null}
                            />
                          </Box>
                        </>
                      )}
                        ...
                        <>
                          <Box>
                            <TextField
                              ...
                              helperText={errors?.reportRemarksMr ? errors.reportRemarksMr.message : null}
                            />
                          </Box>
                        </>
                      )}
