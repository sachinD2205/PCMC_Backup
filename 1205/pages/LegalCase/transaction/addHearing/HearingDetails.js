      ...
      >
        ...
        <Grid item xl={3} lg={3} md={4} xs={12} sm={6}>
          ...
          >
            ...
            <FormHelperText>{errors?.caseNumber ? errors.caseNumber.message : null}</FormHelperText>
          </FormControl>
        </Grid>
              ...
              render={({ field }) => (
                <LocalizationProvider dateAdapter={AdapterMoment}>
                  <DatePicker
                    ...
                    value={field.value}
                    onChange={(date) => field.onChange(moment(date,"DD-MM-YYYY").format("YYYY-MM-DD"))}
      ...
      >
        ...
        <Grid item xl={3} lg={3} md={4} xs={12} sm={6}>
          ...
          >
            ...
            />
            <FormHelperText>{errors?.hearingDate ? errors?.hearingDate?.message : null}</FormHelperText>
          </FormControl>
        </Grid>
        ...
        >
          ...
          >
            ...
            <Controller
              ...
              defaultValue=""
            />
            <FormHelperText>{errors?.caseStage ? errors?.caseStage?.message : null}</FormHelperText>
          </FormControl>
        </Grid>
      </Grid>
        ...
        <Grid item xl={3} lg={3} md={4} xs={12} sm={6}>
          ...
          {showDatePicker === 2 && (
            ...
            >
              ...
              />
              <FormHelperText>
                {errors?.interimOrderDate ? errors?.interimOrderDate?.message : null}
              </FormHelperText>
            </FormControl>
          )}
          ...
          {showDatePicker === 3 && (
            ...
            >
              ...
              />
              <FormHelperText>
                {errors?.finalOrderDate ? errors?.finalOrderDate?.message : null}
              </FormHelperText>
            </FormControl>
          )}
        </Grid>
