...
/** Author - Sahin Durge */
// Site Visit Schedule
// http://localhost:4000/streetVendorManagementSystem/transactions/issuanceOfSteetVendorLicense/SiteVisitScheduleNew
const SiteVisitScheduleNew = ({ appID }) => {
  const {
    control,
    register,
    reset,
  ...
  const bookApptSubmit = (data) => {
    ...
    axios
      .post(`${urls.HMSURL}/master/slot/bookNow`, finalBody)
      .then((res) => {
            ...
            <form onSubmit={handleSubmit(onFinish)}>
              <div className={styles.box}>
                <div className={styles.titlemodelT} style={{ marginLeft: "25px" }}>
                  ...
                  <IconButton onClick={() => router.push(`/streetVendorManagementSystem/dashboards`)}>
                    <CloseIcon />
                  </IconButton>
                </div>
                ...
                <div container style={{ padding: "10px", backgroundColor: "#F9F9F9" }}>
...
export default SiteVisitScheduleNew;
