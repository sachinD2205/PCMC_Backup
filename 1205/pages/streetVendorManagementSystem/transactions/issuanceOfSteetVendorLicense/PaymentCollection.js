...
const PaymentCollection = () => {
  ...
  useEffect(() => {
    console.log("paymentMode", watch("paymentCollection.paymentMode"));
                ...
                {shrinkTemp && (
                  ...
                  >
                    <marquee width="100%" direction="left" scrollamount="12">
                      ...
                      >
                        <strong>{<FormattedLabel id="PaymentCollection" />}</strong>
                      </Typography>
                    </marquee>
                    <br /> <br />
                    {/***
                  ...
                  */}
                    ...
                    <Grid container>
                      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        ...
                        >
                          <Button type="submit"> {<FormattedLabel id="submit" />} </Button>
                          <Button
                            onClick={() => {
