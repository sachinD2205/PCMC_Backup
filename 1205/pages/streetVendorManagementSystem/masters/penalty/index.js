...
import styles from "../../../../components/streetVendorManagementSystem/styles/penalty.module.css";
import schema from "../../../../components/streetVendorManagementSystem/schema/PenaltySchema";
...
const Index = () => {
  ...
  const getPenaltyDetails = () => {
    axios
      .get(`${urls.HMSURL}/penaltyMaster/getPenaltyMasterData`)
      .then((res) => {
        console.log(res);
        setDataSource(
          res.data.map((r, i) => ({
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.HMSURL}/penaltyMaster/savePenaltyMaster`, finalBodyForApi)
      .then((res) => {
        if (res.status == 201) {
          formData.id
  ...
  const deleteById = (value) => {
    swal({
      ...
      axios
        .delete(`${urls.HMSURL}/penaltyMaster/discardPenaltyMaster/${value}`)
        .then((res) => {
          if (res.status == 226) {
            if (willDelete) {
