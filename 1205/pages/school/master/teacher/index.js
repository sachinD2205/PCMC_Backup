...
const Index = () => {
  ...
  // Get Table - Data
  const getTeachersMaster = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
  ...
  const onSubmitForm = (formData) => {
    ...
    if (btnSaveText === "Save") {
      ...
      const tempData = axios.post(`${urls.SCHOOL}/mstTeacher/save`, _body).then((res) => {
        console.log("res---", res);
        if (res.status == 201) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.SCHOOL}/mstTeacher/save`, body).then((res) => {
                    ...
                    <Grid container sx={{ padding: "10px" }}>
                      ...
                      >
                        <TextField
                          ...
                          helperText={errors?.emailDetails ? errors.emailDetails.message : null}
                          // InputLabelProps={{
                          //     //true
                          //     shrink:
                          //         (watch("label2") ? true : false) ||
                      ...
                      >
                        <TextField
                          ...
                          helperText={errors?.aadharNumber ? errors.aadharNumber.message : null}
                          // InputLabelProps={{
                          //     //true
                          //     shrink:
                          //         (watch("label2") ? true : false) ||
                      ...
                      >
                        <Grid item xl={4} lg={4} md={4} sm={4} xs={4}>
                          <label>Teacher Photograph</label>
                        </Grid>
                        <Grid item xl={4} lg={4} md={4} sm={4} xs={4}>
                          <UploadButton
                            // appName="SCHOOL"
