...
const Index = () => {
            ...
            if (res?.data.length > 0) {
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  systemEntryDate: moment(r.systemEntryDate).format("DD-MM-YYYY"),
                  currentStatus: getStatusCode(+r.currentStatus),
  ...
  const columns = [
    {
      field: "serialNumber",
      headerName: <FormattedLabel id="serialNumber" />,
      minWidth: 300,
      headerAlign: "center",
      align: "center",
    },
    ...
    },
    {
      ...
      headerName: <FormattedLabel id="systemEntryDate" />,
      minWidth: 200,
      headerAlign: "center",
      align: "center",
    },
