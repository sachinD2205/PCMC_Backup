...
const Index = () => {
  ...
  const [gatName, setGatName] = useState([{ id: 1, gatNo: 1, gatNameEn: "Gat 1", gatNameMr: "Gat 1" }]);
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          ...
          return {
            ...
            circleNo1: circleNo?.find((obj) => obj.id === val.circleNo)?.circleNo,
            circleName: val.circleName,
            circleName1: circleName?.find((obj) => obj.id === val.circleName)?.circleName,
            circleGat: val.circleGat,
            gatNo: val.gatNo,
            gatName: val.gatName,
            address: val.address,
            pincode: val.pincode,
            pinCodeName: pincodes?.find((obj) => obj.id === val.pincode)?.pincode,
  ...
  useEffect(() => {
    //Get Gat
    // axios.get(`${urls.CFCURL}/master/gat/getAll`).then((res) => {
    //   setGatNames(
    //     res.data?.gat?.map((r, i) => ({
    //       id: r.id,
    //       gatNo: r.gatNo,
    //       gatNameEn: r.gatName,
    //       gatNameMr: r.gatNameMr,
    //     })),
    //   );
    // });
                ...
                <Grid container style={{ padding: "10px" }} spacing={2}>
                  ...
                  >
                    <TextField
                      ...
                      helperText={errors?.circleNo ? errors.circleNo.message : null}
                    />
                  </Grid>
                </Grid>
                  ...
                  >
                    <FormControl error={!!errors.circleName} style={{ width: "230px" }}>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select
                            ...
                            onChange={(value) => {
                              setValue(
                                "circleNo",
                                circleName.find((obj) => obj.id == value.target.value).circleNo,
                              );
                        ...
                        defaultValue=""
                      />
                      <FormHelperText>{errors?.circleName ? errors.circleName.message : null}</FormHelperText>
                    </FormControl>
                  </Grid>
                ...
                <Grid container style={{ padding: "10px" }}>
                  ...
                  >
                    <TextField
                      ...
                      helperText={errors?.employeeDetails ? errors.employeeDetails.message : null}
                    />
                  </Grid>
