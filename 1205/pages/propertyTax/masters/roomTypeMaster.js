...
import Schema from "../../../containers/schema/propertyTax/masters/roomTypeMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllRoomType = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/roomType/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/roomType/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/roomType/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "roomType",
      headerName: <FormattedLabel id="roomType" />,
      flex: 1,
    },
    {
      field: "roomTypeMr",
      headerName: "Room Type Name Mr",
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="roomTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.roomType ? errors.roomType.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Room Type Name Mr"
                        variant="standard"
                        {...register("roomTypeMr")}
                        error={!!errors.roomTypeMr}
                        helperText={errors?.roomTypeMr ? errors.roomTypeMr.message : null}
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllRoomType(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllRoomType(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
