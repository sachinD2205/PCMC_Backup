...
import Schema from "../../../containers/schema/propertyTax/masters/industryTypeMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllIndustryName = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res) => {
        ...
        let result = res.data?.industryType;
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            industryNameMr: val.industryNameMr,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.PTAXURL}/master/industryType/save`, finalBodyForApi).then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/industryType/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "industryName",
      headerName: <FormattedLabel id="industryName" />,
      flex: 1,
    },
    {
      field: "industryNameMr",
      headerName: "Industry Name Mr",
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="industryTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        label={<FormattedLabel id="industryName" />}
                        // variant="outlined"
                        variant="standard"
                        {...register("industryName")}
                        error={!!errors.industryName}
                        helperText={errors?.industryName ? errors.industryName.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Industry Name Mr"
                        // variant="outlined"
                        variant="standard"
                        {...register("industryNameMr")}
                        error={!!errors.industryNameMr}
                        helperText={errors?.industryNameMr ? errors.industryNameMr.message : null}
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllIndustryName(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllIndustryName(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
