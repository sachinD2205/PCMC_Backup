...
import Schema from "../../../containers/schema/propertyTax/masters/propertyTypeMaster";
...
const Index = () => {
  ...
  const getAllOccupancy = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res) => {
        ...
        let result = res.data?.propertyType;
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            propertyTypeMr: val.propertyTypeMr,
            propertyTypePrefix: val.propertyTypePrefix,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/propertyType/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/propertyType/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "propertyTypePrefix",
      headerName: <FormattedLabel id="propertyTypePrefix" />,
    },
    {
      field: "propertyType",
    ...
    {
      field: "propertyTypeMr",
      headerName: "Property Type Mr",
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="propertyTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        size="small"
                        id="standard-basic"
                        label={<FormattedLabel id="propertyTypePrefix" />}
                        variant="standard"
                        {...register("propertyTypePrefix")}
                        error={!!errors.propertyTypePrefix}
                        helperText={errors?.propertyTypePrefix ? errors.propertyTypePrefix.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Property Type Name Mr"
                        variant="standard"
                        {...register("propertyTypeMr")}
                        error={!!errors.propertyTypeMr}
                        helperText={errors?.propertyTypeMr ? errors.propertyTypeMr.message : null}
                      />
                    </Grid>
