...
import Schema from "../../../containers/schema/propertyTax/masters/rebateMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllRebate = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/rebate/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            rebateName: val.rebateName,
            rebateNameMr: val.rebateNameMr,
  ...
  const gettingFinancialYear = () => {
    axios.get(`${urls.CFCURL}/master/financialYearMaster/getAll`).then((res) => {
      console.log("res", res);
      setFinYear(
  ...
  const gettingTaxName = () => {
    axios.get(`${urls.PTAXURL}/master/taxName/getAll`).then((res) => {
      console.log("res", res);
      setTaxNames(
  ...
  //   const gettingTaxType = () => {
  //     axios
  //       .get("${urls.PTAXURL}/master/taxType/getAll")
  //       .then((res) => {
  //         console.log("res", res);
  //         setTaxTypes(
  ...
  const getPropertyType = () => {
    axios.get(`${urls.PTAXURL}/master/propertyType/getAll`).then((res) => {
      setPropertyTypes(
  ...
  const getPropertySubType = () => {
    axios.get(`${urls.PTAXURL}/master/propertySubType/getAll`).then((res) => {
      setPropertySubTypes(
  ...
  const getSubUsageType = () => {
    axios.get(`${urls.PTAXURL}/master/subUsageType/getAll`).then((res) => {
      setSubUsageType(
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/rebate/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/rebate/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "rebateName",
      headerName: <FormattedLabel id="rebateName" />,
      flex: 1,
    },
    {
      field: "rebateNameMr",
      headerName: "Rebate Name Mr",
      flex: 1,
    },
    {
      field: "taxName1",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="rebateMaster" />
              </strong>
            </Grid>
          </Box>
              ...
              <div>
                <form onSubmit={handleSubmit(onSubmitForm)}>
                  ...
                  >
                    ...
                    >
                      <FormControl error={!!errors.financialYear} style={{ width: "230px" }}>
                        <InputLabel>{<FormattedLabel id="financialYear" />}</InputLabel>
                        <Controller
                          control={control}
                          render={({ field }) => (
                            <Select
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        label={<FormattedLabel id="rebateName" />}
                        variant="standard"
                        {...register("rebateName")}
                        error={!!errors.rebateName}
                        helperText={errors?.rebateName ? errors.rebateName.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Rebate Name Mr"
                        variant="standard"
                        {...register("rebateNameMr")}
                        error={!!errors.rebateNameMr}
                        helperText={errors?.rebateNameMr ? errors.rebateNameMr.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <FormControl error={!!errors.propertyType} style={{ width: "230px" }}>
                        <InputLabel>{<FormattedLabel id="propertyType" />}</InputLabel>
                        <Controller
                          control={control}
                          render={({ field }) => (
                            <Select
                    ...
                    >
                      <FormControl error={!!errors.propertySubType} style={{ width: "230px" }}>
                        <InputLabel> {<FormattedLabel id="propertySubType" />}</InputLabel>
                        <Controller
                          control={control}
                          render={({ field }) => (
                            <Select
                    ...
                    >
                      <FormControl error={!!errors.taxName} style={{ width: "230px" }}>
                        <InputLabel>{<FormattedLabel id="applicableOnTaxes" />}</InputLabel>
                        <Controller
                          control={control}
                          render={({ field }) => (
                            <Select
                              fullWidth
                              value={field.value}
                              label={<FormattedLabel id="applicableOnTaxes" />}
                              onChange={(value) => field.onChange(value)}
                              // style={{ height: 40, padding: "14px 14px" }}
                              variant="standard"
                            >
                          ...
                          defaultValue=""
                        />
                        <FormHelperText>{errors?.taxName ? errors.taxName.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
                    ...
                    >
                      <FormControl error={!!errors.usageType} style={{ width: "230px" }}>
                        ...
                        <Controller
                          ...
                          defaultValue=""
                        />
                        <FormHelperText>{errors?.usageType ? errors.usageType.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.constraint ? errors.constraint.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.noOfDays ? errors.noOfDays.message : null}
                      />
                    </Grid>
            ...
            <Grid item xs={2} style={{ display: "flex", justifyContent: "center" }}>
              <Button
                ...
                onClick={() => {
                  ...
                  setBtnSaveText("Save");
                  setBtnSaveTextMr("जतन करा"), setButtonInputState(true);
                  setSlideChecked(true);
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllRebate(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllRebate(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
