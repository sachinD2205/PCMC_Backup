...
import Schema from "../../../containers/schema/propertyTax/masters/usageTypeMaster";
...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/usageType/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/usageType/save`, body)
            .then((res) => {
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="usageTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.usagePrefix ? errors.usagePrefix.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Usage Type Name Mr"
                        variant="standard"
                        {...register("usageTypeMr")}
                        error={!!errors.usageTypeMr}
                        helperText={errors?.usageTypeMr ? errors.usageTypeMr.message : null}
                      />
                    </Grid>
