...
import Schema from "../../../containers/schema/propertyTax/masters/constructionTypeMaster";
...
const Index = () => {
  ...
  const getAllOccupancy = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res) => {
        ...
        let result = res.data?.constructionType;
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            id: val.id,
            srNo: i + 1,
            constructionTypeName: val.constructionTypeName,
            constructionTypeNameMr: val.constructionTypeNameMr,
            constructionTypeNamePrefix: val.constructionTypeNamePrefix,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/constructionType/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/constructionType/save`, body)
            .then((res) => {
  ...
  const resetValuesCancell = {
    ...
    constructionTypeNameMr: "",
    constructionTypeNamePrefix: "",
    remark: "",
    fromDate: null,
    toDate: null,
  };
  ...
  const columns = [
    { field: "srNo", headerName: <FormattedLabel id="srNo" /> },
    {
      ...
      headerName: <FormattedLabel id="constructionTypeName" />,
      flex: 1,
    },
    {
      field: "constructionTypeNameMr",
      headerName: "Construction Type Name Mr",
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="constructionTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        size="small"
                        id="standard-basic"
                        label="ConstructionTypeNamePrefix"
                        // variant="outlined"
                        variant="standard"
                        {...register("constructionTypeNamePrefix")}
                        error={!!errors.constructionTypeNamePrefix}
                        helperText={
                          errors?.constructionTypeNamePrefix
                            ? errors.constructionTypeNamePrefix.message
                            : null
                        }
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        // label="Bill prefix"
                        label={<FormattedLabel id="constructionTypeName" />}
                        // variant="outlined"
                        variant="standard"
                        {...register("constructionTypeName")}
                        error={!!errors.constructionTypeName}
                        helperText={errors?.constructionTypeName ? errors.constructionTypeName.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        // label="Bill prefix"
                        label="Construction Type Name Mr"
                        // variant="outlined"
                        variant="standard"
                        {...register("constructionTypeNameMr")}
                        error={!!errors.constructionTypeNameMr}
                        helperText={
                          errors?.constructionTypeNameMr ? errors.constructionTypeNameMr.message : null
                        }
                      />
                    </Grid>
