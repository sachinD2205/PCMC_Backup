...
import Schema from "../../../containers/schema/propertyTax/masters/transferTypeMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllTransferType = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/transferType/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let result = res.data?.transferType;
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            transferTypeMr: val.transferTypeMr,
            paymentMode: val.paymentMode,
            paymentModeEn: paymentModes.find((obj) => obj.id == val.paymentMode)?.paymentMode,
            paymentType: val.paymentType,
            paymentTypeEn: paymentTypes.find((obj) => obj.id == val.paymentType)?.paymentType,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/transferType/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/transferType/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "transferTypeMr",
      headerName: "Transfer Type Mr",
      flex: 1,
    },
    {
      field: "paymentModeEn",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="transferTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.transferType ? errors.transferType.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Transfer Type Mr"
                        variant="standard"
                        {...register("transferTypeMr")}
                        error={!!errors.transferTypeMr}
                        helperText={errors?.transferTypeMr ? errors.transferTypeMr.message : null}
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllTransferType(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllTransferType(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
