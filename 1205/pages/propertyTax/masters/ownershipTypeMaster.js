...
import Schema from "../../../containers/schema/propertyTax/masters/ownershipTypeMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllOwnershipType = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/ownershipTypeMaster/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            id: val.id,
            srNo: i + 1,
            ownershipType: val.ownershipType,
            ownershipTypeMr: val.ownershipTypeMr,
            ownershipTypePrefix: val.ownershipTypePrefix,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/ownershipTypeMaster/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/ownershipTypeMaster/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    { field: "ownershipTypePrefix", headerName: <FormattedLabel id="srNo" /> },
    {
      field: "ownershipType",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="ownershipTypeMaster" />
              </strong>
            </Grid>
          </Box>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllOwnershipType(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllOwnershipType(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
