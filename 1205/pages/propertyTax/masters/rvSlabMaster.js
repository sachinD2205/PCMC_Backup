...
import Schema from "../../../containers/schema/propertyTax/masters/rvSlab";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllRvSlabs = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/rvSalb/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            usageType1: usageTypes?.find((obj) => obj.id === val.usageType)?.usageType,
            rvSlab: val.rvSlab,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/rvSalb/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/rvSalb/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "rvSlab",
      headerName: <FormattedLabel id="rvSlab" />,
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="rvSlabMaster" />
              </strong>
            </Grid>
          </Box>
              ...
              <div>
                <form onSubmit={handleSubmit(onSubmitForm)}>
                  ...
                  >
                    ...
                    >
                      <FormControl variant="standard" sx={{ marginTop: 2 }} error={!!errors.usageType}>
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        label={<FormattedLabel id="rvSlab" />}
                        variant="standard"
                        {...register("rvSlab")}
                        error={!!errors.rvSlab}
                        helperText={errors?.rvSlab ? errors.rvSlab.message : null}
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllRvSlabs(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllRvSlabs(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
