...
import Schema from "../../../containers/schema/propertyTax/masters/occupancyMaster";
...
const Index = () => {
  ...
  const getAllOccupancy = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/occupancy/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            occupancyMr: val.occupancyMr,
            occupancyPrefix: val.occupancyPrefix,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/occupancy/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/occupancy/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "occupancyPrefix",
      headerName: <FormattedLabel id="occupancyPrefix" />,
    },
    {
      field: "occupancy",
      headerName: <FormattedLabel id="occupancy" />,
      flex: 1,
    },
    { field: "occupancyMr", headerName: "Occupancy Mr", flex: 1 },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="occupancyMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        size="small"
                        id="standard-basic"
                        label={<FormattedLabel id="occupancyPrefix" />}
                        // variant="outlined"
                        variant="standard"
                        {...register("occupancyPrefix")}
                        error={!!errors.occupancyPrefix}
                        helperText={errors?.occupancyPrefix ? errors.occupancyPrefix.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        // label="Bill prefix"
                        label={<FormattedLabel id="occupancy" />}
                        // variant="outlined"
                        variant="standard"
                        {...register("occupancy")}
                        error={!!errors.occupancy}
                        helperText={errors?.occupancy ? errors.occupancy.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        // variant="outlined"
                        variant="standard"
                        {...register("occupancyMr")}
                        error={!!errors.occupancyMr}
                        helperText={errors?.occupancyMr ? errors.occupancyMr.message : null}
                      />
                    </Grid>
