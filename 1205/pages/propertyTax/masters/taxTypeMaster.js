...
import Schema from "../../../containers/schema/propertyTax/masters/taxTypeMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllTaxType = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            srNo: i + 1,
            taxType: val.taxType,
            taxTypeMr: val.taxTypeMr,
            taxSubType: val.taxSubType,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/taxTypeMaster/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/taxTypeMaster/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "taxType",
      headerName: <FormattedLabel id="taxType" />,
      flex: 1,
    },
    {
      field: "taxTypeMr",
    ...
    {
      field: "taxSubType",
      headerName: <FormattedLabel id="taxSubType" />,
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="taxTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        label={<FormattedLabel id="taxType" />}
                        variant="standard"
                        {...register("taxType")}
                        error={!!errors.taxType}
                        helperText={errors?.taxType ? errors.taxType.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.taxTypeMr ? errors.taxTypeMr.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label={<FormattedLabel id="taxSubType" />}
                        variant="standard"
                        {...register("taxSubType")}
                        error={!!errors.taxSubType}
                        helperText={errors?.taxSubType ? errors.taxSubType.message : null}
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllTaxType(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllTaxType(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
