...
import Schema from "../../../containers/schema/propertyTax/masters/zoneCategoryMaster"
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllzoneCategory = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res) => {
        ...
        let result = res.data?.zoneCategory
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            zoneCategoryMr: val.zoneCategoryMr,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/zoneCategory/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/zoneCategory/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "zoneCategoryMr",
      headerName: "Zone Category Mr",
      flex: 1,
    },
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="zoneCategoryMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Zone Category Mr"
                        variant="standard"
                        {...register("zoneCategoryMr")}
                        error={!!errors.zoneCategoryMr}
                        helperText={
                          errors?.zoneCategoryMr
                            ? errors.zoneCategoryMr.message
                            : null
                        }
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllzoneCategory(data?.pageSize, _data)
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data)
                // updateData("page", 1);
                getAllzoneCategory(_data, data?.page)
              }}
            />
          </Box>
        </Paper>
