...
const Index = () => {
  ...
  // Tax Type
  const getTypeOfTax = () => {
    axios.get(`${urls.PTAXURL}/master/taxTypeMaster/getAll`).then((res) => {
      setTypeOfTaxes(
              ...
              <div>
                <form onSubmit={handleSubmit(onSubmitForm)}>
                  ...
                  >
                    ...
                    >
                      <FormControl error={!!errors.typeOfTax} style={{ width: "230px" }}>
                        <InputLabel>{<FormattedLabel id="typeOfTax" />}</InputLabel>
                        <Controller
                          control={control}
                          render={({ field }) => (
                            <Select
                          ...
                          defaultValue=""
                        />
                        <FormHelperText>{errors?.typeOfTax ? errors.typeOfTax.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.taxName ? errors.taxName.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.taxNameMr ? errors.taxNameMr.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.applicabilityOn ? errors.applicabilityOn.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.propertyArea ? errors.propertyArea.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label={<FormattedLabel id="priorityOfCollectionOrder" />}
                        variant="standard"
                        {...register("priorityOfCollectionOrder")}
                        error={!!errors.priorityOfCollectionOrder}
                        helperText={
                          errors?.priorityOfCollectionOrder ? errors.priorityOfCollectionOrder.message : null
                        }
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={
                          errors?.priorityOfBillDisplay ? errors.priorityOfBillDisplay.message : null
                        }
                      />
                    </Grid>
