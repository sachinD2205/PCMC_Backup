...
import Schema from "../../../containers/schema/propertyTax/masters/roadNameMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllRoad = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/road/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            id: val.id,
            srNo: i + 1,
            roadNamePrifix: val.roadNamePrifix,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/road/save`, finalBodyForApi)
      .then((res) => {
        if (res.status === 201) {
          formData.id
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/road/save`, body)
            .then((res) => {
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="roadNameScreenMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        autoFocus
                        id="standard-basic"
                        label={<FormattedLabel id="roadNamePrefix" />}
                        variant="standard"
                        {...register("roadNamePrifix")}
                        error={!!errors.roadNamePrifix}
                        helperText={errors?.roadNamePrifix ? errors.roadNamePrifix.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <FormControl error={!!errors.circle} style={{ width: "230px" }}>
                        ...
                        <Controller
                          ...
                          defaultValue=""
                        />
                        <FormHelperText>{errors?.circle ? errors.circle.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
                    ...
                    >
                      <FormControl error={!!errors.gat} style={{ width: "230px" }}>
                        ...
                        <Controller
                          ...
                          defaultValue=""
                        />
                        <FormHelperText>{errors?.gat ? errors.gat.message : null}</FormHelperText>
                      </FormControl>
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllRoad(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllRoad(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
