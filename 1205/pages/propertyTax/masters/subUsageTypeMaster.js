...
const Index = () => {
      ...
      .then((res) => {
        ...
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            usageType1: UsageType?.find((obj) => obj.id === val.usageType)?.usageType,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.PTAXURL}/master/subUsageType/save`, finalBodyForApi).then((res) => {
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.subUsePrefix ? errors.subUsePrefix.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <FormControl error={!!errors.usageType} style={{ minWidth: "230px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.subUsageType ? errors.subUsageType.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.subUsageTypeMr ? errors.subUsageTypeMr.message : null}
                      />
                    </Grid>
