...
import Schema from "../../../containers/schema/propertyTax/masters/readyReckonerRateMaster";
...
const Index = () => {
  ...
  const getAllReadyReckonerRate = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/readyReckonerRate/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let result = res.data?.readyReckonerRate;
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            id: val.id,
            srNo: i + 1,
            readyReckonerPrefix: val.readyReckonerPrefix,
            landmark: val.landmark,
            landNumber: val.landNumber,
            typeOfArea: val.typeOfArea,
            subCircle: val.subCircle,
            rate: val.rate,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/readyReckonerRate/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/readyReckonerRate/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    { field: "readyReckonerPrefix", headerName: "Reckoner Prefix" },
    {
      field: "landmark",
    ...
    {
      field: "typeOfArea",
      headerName: <FormattedLabel id="typeOfArea" />,
      flex: 1,
    },
    {
      field: "landNumber",
      headerName: <FormattedLabel id="landNumber" />,
      flex: 1,
    },
    {
      field: "rate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="readyReckonerRateMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        size="small"
                        id="standard-basic"
                        label="ReadyReckonerPrefix"
                        variant="standard"
                        {...register("readyReckonerPrefix")}
                        error={!!errors.readyReckonerPrefix}
                        helperText={errors?.readyReckonerPrefix ? errors.readyReckonerPrefix.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        label={<FormattedLabel id="typeOfArea" />}
                        variant="standard"
                        {...register("typeOfArea")}
                        error={!!errors.typeOfArea}
                        helperText={errors?.typeOfArea ? errors.typeOfArea.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label={<FormattedLabel id="subCircle" />}
                        variant="standard"
                        {...register("subCircle")}
                        error={!!errors.subCircle}
                        helperText={errors?.subCircle ? errors.subCircle.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label={<FormattedLabel id="landNumber" />}
                        variant="standard"
                        {...register("landNumber")}
                        error={!!errors.landNumber}
                        helperText={errors?.landNumber ? errors.landNumber.message : null}
                      />
                    </Grid>
