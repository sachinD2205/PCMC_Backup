...
import Schema from "../../../containers/schema/propertyTax/masters/circleMaster"
        ...
        <Main>
          <Paper style={{ margin: "30px" }}>
            ...
            >
              ...
              >
                <strong>
                  <FormattedLabel id="circleMaster" />
                </strong>
              </Grid>
            </Box>
                ...
                <form onSubmit={handleSubmit(onSubmitForm)}>
                  ...
                  <Grid container spacing={2} style={{ padding: "10px" }}>
                    ...
                    >
                      ...
                      // label="Upload Photo"
                      variant="standard"
                      {...register("circlePhoto")}
                      error={!!errors.circlePhoto}
                      helperText={
                        // errors?.studentName ? errors.studentName.message : null
                        errors?.circlePhoto
                          ? "zone Address is  !!!"
