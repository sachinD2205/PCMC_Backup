...
import Schema from "../../../containers/schema/propertyTax/masters/propertySubTypeMaster";
...
const Index = () => {
  ...
  const getAllPropertySubType = (_pageSize = 10, _pageNo = 0) => {
    axios
      ...
      .then((res) => {
        ...
        let result = res.data?.propertySubType;
        let _res = result?.map((val, i) => {
          ...
          return {
            ...
            propertyType1: propertyTypes?.find((obj) => obj.id === val.propertyType)?.propertyType,
            propertySubTypePrefix: val.propertySubTypePrefix,
            propertySubType: val.propertySubType,
            propertySubTypeMr: val.propertySubTypeMr,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/propertySubType/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/propertySubType/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: "propertySubTypePrefix",
      headerName: <FormattedLabel id="propertySubTypePrefix" />,
    },
    {
      field: "propertyType1",
      headerName: <FormattedLabel id="propertyType" />,
      flex: 1,
    },
    {
      field: "propertySubType",
      headerName: <FormattedLabel id="propertySubType" />,
      flex: 1,
    },
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="propertySubTypeMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        size="small"
                        id="standard-basic"
                        label={<FormattedLabel id="propertySubTypePrefix" />}
                        // variant="outlined"
                        variant="standard"
                        {...register("propertySubTypePrefix")}
                        error={!!errors.propertySubTypePrefix}
                        helperText={
                          errors?.propertySubTypePrefix ? errors.propertySubTypePrefix.message : null
                        }
                      />
                    </Grid>
                            ...
                            >
                              {propertyTypes &&
                                propertyTypes.map((propertyType, i) => (
                                  <MenuItem key={i} value={propertyType.id}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.propertySubType ? errors.propertySubType.message : null}
                      />
                    </Grid>
                    ...
                    >
                      <TextField
                        ...
                        style={{ backgroundColor: "white" }}
                        id="outlined-basic"
                        label="Property SubType Mr"
                        // variant="outlined"
                        variant="standard"
                        {...register("propertySubTypeMr")}
                        error={!!errors.propertySubTypeMr}
                        helperText={errors?.propertySubTypeMr ? errors.propertySubTypeMr.message : null}
                      />
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllPropertySubType(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllPropertySubType(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
