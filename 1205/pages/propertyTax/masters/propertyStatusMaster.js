...
import Schema from "../../../containers/schema/propertyTax/masters/propertyStatusMaster";
...
const Index = () => {
  ...
  // Get Table - Data
  const getAllPropertyStatus = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(`${urls.PTAXURL}/master/propertyStatus/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        ...
        let result = res.data?.propertyStatus;
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      .post(`${urls.PTAXURL}/master/propertyStatus/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.PTAXURL}/master/propertyStatus/save`, body)
            .then((res) => {
  ...
  const columns = [
...

    {
      ...
      headerName: <FormattedLabel id="propertyStatus" />,
      flex: 1,
    },
    {
      field: "fromDate",
      ...
      <div>
        <Paper style={{ margin: "30px" }}>
          ...
          >
            ...
            >
              <strong>
                <FormattedLabel id="propertyStatusMaster" />
              </strong>
            </Grid>
          </Box>
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.propertyStatus ? errors.propertyStatus.message : null}
                      />
                    </Grid>
                  ...
                  <Grid container style={{ padding: "10px" }} spacing={2}>
                    ...
                    >
                      <Button type="submit" variant="contained" color="success" endIcon={<SaveIcon />}>
                        {/* {btnSaveText} */}
                        {language === "en" ? btnSaveText : "जतन करा"}
                      </Button>
                    </Grid>
          ...
          <Box style={{ height: "auto", overflow: "auto", padding: "10px" }}>
            <DataGrid
              ...
              columns={columns}
              onPageChange={(_data) => {
                getAllPropertyStatus(data?.pageSize, _data);
              }}
              onPageSizeChange={(_data) => {
                console.log("222", _data);
                // updateData("page", 1);
                getAllPropertyStatus(_data, data?.page);
              }}
            />
          </Box>
        </Paper>
