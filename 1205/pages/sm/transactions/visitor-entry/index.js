    ...
    return (
      <div className={styles.main} ref={props.toPrint}>
        <div className={styles.small}>
          ...
          <Grid container sx={{ padding: "10px" }}>
            <Grid item xs={12}>
              <Typography>3) सोबत आलेल्या व्यक्ती : {props?.data?.accompanyingPerson}</Typography>
            </Grid>
          </Grid>
          <Grid container sx={{ padding: "10px" }}>
            <Grid item xs={12}>
              <Typography>4) कोणाला भेटायचे : {props?.data?.toWhomWantToMeet}</Typography>
            </Grid>
          </Grid>
          <Grid container sx={{ padding: "10px" }}>
            <Grid item xs={12}>
              <Typography>5) भेटण्याचे कारण : {props?.data?.purpose}</Typography>
            </Grid>
          </Grid>
          <Grid container sx={{ padding: "10px" }}>
            <Grid item xs={12}>
              <Typography>6) मोबाईल नंबर : {props?.data?.mobileNumber}</Typography>
            </Grid>
          </Grid>
          <Grid container sx={{ padding: "10px" }}>
            <Grid item xs={12}>
              <Typography>7) विभागाचे नाव : {props?.data?.departmentName}</Typography>
            </Grid>
          </Grid>
          <Grid container sx={{ padding: "10px" }}>
            <Grid item xs={12}>
                                  ...
                                  onChange={(value) => {
                                    ...
                                    searchEmpData.map((item) => {
                                      if (item.id == value.target.value) {
                                        ...
                                        setValue("accompanyingPerson", item?.accompanyingPerson);
                  ...
                  <Grid container sx={{ padding: "10px" }}>
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                      <TextField
                        ...
                        size="small"
                        fullWidth
                        InputLabelProps={{ shrink: watch("accompanyingPerson") ? true : false }}
