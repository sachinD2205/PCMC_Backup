...
const View = () => {
  ...
  const finalSubmit = async () => {
    ...
    let isAllClear = files.find(
      (obj) => obj.isDocumentMandetory && obj.filePath === ''
    )
                        ...
                        <div className={styles.fieldsStepper}>
                          ...
                          <div className={styles.row}>
                            ...
                            >
                              ...
                              />
                              <FormHelperText>
                                {error1?.title ? error1.title.message : null}
                              </FormHelperText>
                            </FormControl>
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <FormHelperText>
                                {error1?.gender ? error1.gender.message : null}
                              </FormHelperText>
                            </FormControl>
                          </div>
                          <div
                          ...
                          >
                            <TextField
                              ...
                              error={!!error1.mobile}
                              helperText={
                                error1?.mobile ? error1.mobile.message : null
                              }
                            ...
                            <TextField
                              ...
                              error={!!error1.panNo}
                              helperText={
                                error1?.panNo ? error1.panNo.message : null
                              }
                        ...
                        >
                          <Paper className={styles.leftSide}>
                            ...
                            >
                              ...
                              />
                              <FormHelperText>
                                {error2?.reservationNo
                                  ? error2.reservationNo.message
                                  : null}
                              </FormHelperText>
                            </FormControl>
                            ...
                            >
                              ...
                              />
                              <FormHelperText>
                                {error2?.gatNo ? error2.gatNo.message : null}
                              </FormHelperText>
                            </FormControl>
                            ...
                            <TextField
                              ...
                              helperText={
                                error2?.pincode ? error2.pincode.message : null
                              }
                            ...
                            >
                              ...
                              />
                              <FormHelperText>
                                {error2?.serviceCompletionDate
                                  ? error2.serviceCompletionDate.message
                                  : null}
                              </FormHelperText>
                            </FormControl>
                          </Paper>
