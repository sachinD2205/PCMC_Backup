      ...
      .then((res) => {
        ...
        let _res = result.map((j, i) => {
          ...
          return {
            ...
            wardId: j.wardId,
            wardIdCol: wardDropDown.find((obj) => obj?.id == j.wardId)?.wardName,
            serviceId: j.serviceId,
            serviceName: serviceDropDown.find((obj) => obj?.id == j.serviceId)?.serviceName,
            // serviceName: serviceDropDown[j.serviceName] ? serviceDropDown[j.serviceName].serviceName : "-",

            zoneId: j.zoneId,
            zoneIdCol: zoneDropDown.find((obj) => obj?.id === j.zoneId)?.zoneName,
          ...
          <>
            {params.row.activeFlag == "Y" ? (
              <IconButton
                ...
                onClick={() => {
                  setBtnSaveText("Update"), setID(params.row.id), setCollapse(true), setSlideChecked(true);
                          ...
                          <Controller
                            render={({ field }) => (
                              <Select
                                ...
                                // value={field.value}
                                disabled={isDisabled}
                                value={router.query.zoneId ? router.query.zoneId : field.value}
                          ...
                          <Controller
                            render={({ field }) => (
                              <Select
                                ...
                                // value={field.value}
                                disabled={isDisabled}
                                value={router.query.wardId ? router.query.wardId : field.value}
                                onChange={(value) => field.onChange(value)}
                                label="Ward Name"
                              >
                                {wardDropDown &&
