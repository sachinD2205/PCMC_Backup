...
const FactorMaster = () => {
      ...
      .then((res) => {
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            applicationNameEng: application?.find((obj) => obj?.id == r.applicationId)?.applicationNameEng,
  ...
  const onSubmitForm = (fromData) => {
    ...
    // Update Data Based On ID
      ...
      axios.post(`${urls.CFCURL}/master/factorMaster/save`, finalBodyForApi).then((res) => {
        if (res.status == 200) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/factorMaster/save`, body).then((res) => {
                    ...
                    <div className={styles.row}>
                      <div>
                        <TextField
                          ...
                          helperText={errors?.factorPrefix ? errors.factorPrefix.message : null}
                        />
                      </div>
                      <div>
                        <FormControl
                    ...
                    <div className={styles.row}>
                      ...
                      <div>
                        <TextField
                          ...
                          helperText={errors?.factorName ? errors.factorName.message : null}
                        />
                      </div>
                      <div>
                        <TextField
