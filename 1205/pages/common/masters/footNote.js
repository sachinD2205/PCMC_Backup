...
const FootNote = () => {
  ...
  const getFootNote = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
      ...
      .then((res, i) => {
        ...
        let _res = result.map((val, i) => {
          return {
            ...
            serviceNameCol: services.find((f) => f.id === val.serviceId)?.serviceName,
  ...
  const onSubmitForm = (fromData) => {
    ...
    // Save - DB
    if (btnSaveText === "Save") {
      axios.post(`${urls.CFCURL}/master/footNote/save`, finalBodyForApi).then((res) => {
        if (res.status == 200) {
                  ...
                  <div className={styles.small}>
                    <div className={styles.row}>
                      <div>
                        ...
                        >
                          <InputLabel id="demo-simple-select-standard-label">serviceName</InputLabel>
                          <Controller
                            render={({ field }) => (
                              <Select
                                sx={{ width: 250 }}
                      ...
                      <div>
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }} error={!!errors.zoneId}>
                      ...
                      <div>
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }} error={!!errors.wardId}>
                    ...
                    <div className={styles.row}>
                      ...
                      <div>
                        <TextField
                          ...
                          {...register("noteMr")}
                          error={!!errors.noteMr}
                          helperText={errors?.noteMr ? errors.noteMr.message : null}
                        />
                      </div>
                    </div>
