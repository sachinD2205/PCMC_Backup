...
const Index = () => {
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          ...
          return {
            ...
            toDate: moment(val.toDate).format("YYYY-MM-DD"),
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/serviceChargeType/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/serviceChargeType/save`, finalBodyForApi).then((res) => {
  ...
  const columns = [
    ...
    {
      field: language === "en" ? "serviceChargeTypePrefix" : "serviceChargeTypePrefixMr",
  ...
  return (
    <>
      ...
      <Paper style={{ margin: "50px", paddingTop: "40px" }}>
        {isOpenCollapse && (
          <Slide direction="down" in={slideChecked} mountOnEnter unmountOnExit>
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={
                      errors?.serviceChargeTypePrefix ? errors.serviceChargeTypePrefix.message : null
                    }
                  />
                </Grid>
                <Grid
              ...
              <Grid container style={{ padding: "10px", paddingBottom: "40px" }}>
                <Grid
                  item
                  xs={4}
                  style={{
                ...
                >
                  <TextField
                    ...
                    helperText={
                      errors?.serviceChargeTypePrefixMr ? errors.serviceChargeTypePrefixMr.message : null
                    }
                  />
                </Grid>
                <Grid
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.serviceChargeType ? errors.serviceChargeType.message : null}
                  />
                </Grid>
                <Grid
                  item
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.serviceChargeTypeMr ? errors.serviceChargeTypeMr.message : null}
                  />
                </Grid>
