...
const DocumentMaster = () => {
  ...
  const getDocumentType = () => {
    axios.get(`${urls.CFCURL}/master/documentType/getAll`, {}).then((res) => {
  ...
  const getAgeProofDocument = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          return {
            ...
            applicationCol: applications[val.application] && applications[val.application].applicationNameEng,
            ...
            typeOfDocumentCol: documentTypes.find((f) => f.id == val.typeOfDocument)?.documentTypeEng,
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/documentMaster/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/documentMaster/save`, finalBodyForApi).then((res) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: "Document Checklist(In Marathi)",
      // type: "number",
      flex: 1,
      align: "center",
      headerAlign: "center",
              ...
              <Grid container style={{ padding: "10px", paddingTop: "40px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.documentChecklistEn ? errors.documentChecklistEn.message : null}
                  />
                </Grid>
              </Grid>
              ...
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.documentChecklistMr ? errors.documentChecklistMr.message : null}
                  />
                </Grid>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <FormHelperText>
                      {errors?.typeOfDocument ? errors.typeOfDocument.message : null}
                    </FormHelperText>
                  </FormControl>
                </Grid>
              </Grid>
