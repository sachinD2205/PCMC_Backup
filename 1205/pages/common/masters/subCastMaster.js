...
const SubCastMaster = () => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    // Save - DB
    if (btnSaveText === "Save") {
      axios.post(`${urls.BaseURL}/subCast/saveSubCast`, finalBodyForApi).then((res) => {
        if (res.status == 200) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/subCast/saveSubCast`, body).then((res) => {
      ...
      swal({
        ...
        console.log("inn", willDelete);
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/subCast/save`, body).then((res) => {
            console.log("delet res", res);
            if (res.status == 200) {
                  ...
                  <div className={styles.small}>
                    <div className={styles.row}>
                      <div className={styles.fieldss}>
                        <FormControl style={{ marginTop: 10 }} sx={{ width: 250 }} error={!!errors.fromDate}>
                          <Controller
                            control={control}
                            name="fromDate"
                            defaultValue={null}
                      ...
                      <div className={styles.fieldss}>
                        <FormControl style={{ marginTop: 10 }} sx={{ width: 250 }} error={!!errors.toDate}>
                          <Controller
                            control={control}
                            name="toDate"
                            defaultValue={null}
                      ...
                      <div className={styles.fieldss}>
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }} error={!!errors.cast}>
                          <InputLabel id="demo-simple-select-standard-label">Cast *</InputLabel>
                          <Controller
                            render={({ field }) => (
                              <Select
                                sx={{ width: 250 }}
                      ...
                      <div className={styles.fieldss}>
                        <TextField
                          ...
                          helperText={errors?.subCast ? errors.subCast.message : null}
                        />
                      </div>
                      ...
                      <div className={styles.fieldss}>
                        <TextField
                          ...
                          helperText={errors?.subCastMr ? errors.subCastMr.message : null}
                        />
                      </div>
                      ...
                      <div className={styles.fieldss}>
                        <TextField
                          ...
                          helperText={errors?.subCastPrefix ? errors.subCastPrefix.message : null}
                        />
                      </div>
