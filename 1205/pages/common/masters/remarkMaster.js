...
const Index = () => {
  ...
  // Get Table - Data
  const getRemarkMaster = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
    axios
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.BaseURL}/remarkMaster/save`, finalBodyForApi).then((res) => {
      if (res.status == 200) {
        formData.id
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/remarkMaster/save`, body).then((res) => {
                    ...
                    <Grid container spacing={2} style={{ marginTop: "5px", marginLeft: "5%" }}>
                      <Grid item xs={4}>
                        <TextField
                          ...
                          helperText={errors?.remarkEn ? errors.remarkEn.message : null}
                        />
                      </Grid>
                      <Grid item xs={4}>
                        <TextField
                          ...
                          helperText={errors?.remarkMa ? errors.remarkMa.message : null}
                        />
                      </Grid>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <FormHelperText>
                            {errors?.typeOfRemarks ? errors.typeOfRemarks.message : null}
                          </FormHelperText>
                        </FormControl>
                      </Grid>
                    </Grid>
