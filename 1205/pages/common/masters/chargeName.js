...
const ChargeName = () => {
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          ...
          return {
            ...
            chargeNamePrefix: val.chargeNamePrefix,
            chargeNamePrefixMr: val.chargeNamePrefixMr,

            charge: val.charge,
            chargeMr: val.chargeMr,
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/chargeName/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/chargeName/save`, finalBodyForApi).then((res) => {
  ...
  const columns = [
    ...
    {
      field: language === "en" ? "charge" : "chargeMr",
    ...
    {
      field: language === "en" ? "chargeNamePrefix" : "chargeNamePrefixMr",
              ...
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.chargeNamePrefix ? errors.chargeNamePrefix.message : null}
                  />
                </Grid>
                <Grid
                  item
              ...
              <Grid container style={{ padding: "10px", paddingBottom: "40px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.chargeMr ? errors.chargeMr.message : null}
                  />
                </Grid>
