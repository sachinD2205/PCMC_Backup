...
const VishapatraUpload = ({ appName, serviceName, label, filePath, fileUpdater, view = false }) => {
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (e.target.files[0]) {
                    console.log(":123", e.target.files[0].type);
                    // @ts-ignore
          ...
          {filePath && (
            <div>
              ...
              >
                ...
                {fileNameOrig !== null ? fileNameOrig : "vishaypatra"}
              </Button>
              {!view && (
                <IconButton
                  onClick={() => {
...
export default VishapatraUpload;
