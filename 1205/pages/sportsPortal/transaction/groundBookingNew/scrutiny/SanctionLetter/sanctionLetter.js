...
const Index = () => {
  ...
  useEffect(() => {
    axios.get(`${urls.SPURL}/groundBooking/getById?id=${router?.query?.id}`).then((res) => {
          ...
          <div className={styles.small}>
            ...
            <div className={styles.two}>
              <p>
                ...
                ,<br></br>
                This is an acknowledgement that your applicationwith listed detailsreceived for Ground Booking
                ...
                <div>
                  <table className={styles.table}>
                    {/* <tr>
                      <td className={styles.table}> {this?.props?.dataa?.groundName}</td>
                      <td className={styles.table}> {this?.props?.dataa?.lastName}</td>
                      <td className={styles.table}> {this?.props?.dataa?.lastName}</td>
                    </tr> */}
