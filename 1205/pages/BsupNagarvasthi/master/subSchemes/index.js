              ...
              <Grid container style={{ marginLeft: "50px" }}>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={errors?.subSchemeName ? errors.subSchemeName.message : null
                     }
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={
                      errors?.subSchemeNameMr ? errors.subSchemeNameMr.message : null}
                  />
                </Grid>
                {/* sub Scheme prefix */}
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={errors?.subSchemePrefix ? errors.subSchemePrefix.message : null}
                  />
                </Grid>
                <Grid item xs={12} sm={6} md={3} lg={3} xl={3}></Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={errors?.benefitAmount ? errors.benefitAmount.message : null}
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={errors?.installments ? errors.installments.message : null}
                  />
                </Grid>
