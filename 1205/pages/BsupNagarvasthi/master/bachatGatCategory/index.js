...
const Index = () => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    if (btnSaveText === "Save") {
      ...
      const tempData = axios.post(`${urls.BSUPURL}/mstBachatGatCategory/save`, _body).then((res) => {
        console.log("res---", res);
        if (res.status == 201) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.BSUPURL}/mstBachatGatCategory/save/`, body).then((res) => {
  ...
  const columns = [
    ...
    // {
    //   field: "bgCategoryNo",
    //   headerName: <FormattedLabel id="categoryNo" />,
    //   flex: 1,
    // },
          ...
          {isOpenCollapse && (
            <Slide direction="down" in={slideChecked} mountOnEnter unmountOnExit>
              <Grid container style={{ marginLeft: "50px" }}>
                <Grid item xs={12} sm={3} md={5} lg={5} xl={5}></Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={
                      ...
                      errors?.bgCategoryPrefix ? errors.bgCategoryPrefix.message : null
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    helperText={errors?.bgCategoryName ? errors.bgCategoryName.message : null}
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                  <TextField
                    ...
                    // label="Category Name (In Marathi)"
                    id="standard-basic"
                    variant="standard"
                    ...
                    InputLabelProps={{
                      ...
                      //true
                      shrink:
                        (watch("bgCategoryMr") ? true : false) || (router.query.bgCategoryMr ? true : false),
                    }}
                    helperText={
                      // errors?.studentName ? errors.studentName.message : null
                      errors?.bgCategoryMr ? errors.bgCategoryMr.message : null
                    }
                  />
                </Grid>
