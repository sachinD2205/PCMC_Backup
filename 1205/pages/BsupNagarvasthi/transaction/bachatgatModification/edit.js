...
import { addDocumentToLocalStorage, getDocumentFromLocalStorage, removeDocumentToLocalStorage } from "../../../../components/bsupNagarVasthi/LocalStorageFunctions/bsupDoc";
...
import Document from "../bachatgatRegistration/editDocument";
...
const memColumns = [
        ...
        for (var i = 0; i < fields.length; i++) {
            for (var j = 0; j < memberDesignation.length; j++) {
                if (memberDesignation[j].department != fields[i].designation) {
                    ...
                    console.log("new fields ", (memberDesignation[j]))
    ...
    const onSubmitForm = (formData) => {
        ...
        const finalBodyForApi = {
            ...
            // id: router.query.id,
            // activeFlag: "Y",
            // oldBachatGatRegKey:router.query.id,
