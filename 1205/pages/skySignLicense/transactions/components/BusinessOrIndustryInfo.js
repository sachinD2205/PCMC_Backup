 ...
 */}
          ...
          <FormControl sx={{ display: "flex", flexDirection: "row", alignItems: "baseline", justifyContent: "space-between" }} style={{ marginTop: 10, marginLeft: 35 }}>
            ...
            />
            <FormHelperText>
              {errors?.trnIndustryBussinessDetailsDao?.industryDate ? errors.trnIndustryBussinessDetailsDao.industryDate.message : null}
            </FormHelperText>
          </FormControl>
          ...
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={{ marginTop: 2 }}>
            ...
            <FormControl sx={{ display: "flex", flexDirection: "row", alignItems: "baseline", justifyContent: "space-between" }} style={{ marginTop: 10, marginLeft: 35 }}>
              ...
              />
              <FormHelperText>
                {errors?.trnIndustryBussinessDetailsDao?.temporarylicDate ? errors.trnIndustryBussinessDetailsDao.temporarylicDate.message : null}
              </FormHelperText>
            </FormControl>
          </Grid>
        </Grid>
        ...
        >
          <Grid item
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.numbertype"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
          ...
          <Grid item
            ...
            <TextField
              ...
              variant='standard'
              {...register("trnIndustryBussinessDetailsDao.prCityName")}
          ...
          <Grid item
            ...
            <TextField
              ...
              variant='standard'
              {...register("trnIndustryBussinessDetailsDao.prState")}
