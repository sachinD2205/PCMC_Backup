...
const IndustryAndEmployeeDetaills = (props) => {
  ...
  useEffect(() => {
    if (watch('trnIndustryBussinessDetailsDao.officeStaff') || watch('trnIndustryBussinessDetailsDao.permanentEmployees') || watch('trnIndustryBussinessDetailsDao.temporaryEmployees') || watch('trnIndustryBussinessDetailsDao.contractualEmployees') || watch('trnIndustryBussinessDetailsDao.totalEmployees')) {
      let tempTotal = 0;
      tempTotal = Number(watch('trnIndustryBussinessDetailsDao.officeStaff')) + Number(watch('trnIndustryBussinessDetailsDao.permanentEmployees')) + Number(watch('trnIndustryBussinessDetailsDao.temporaryEmployees')) + Number(watch('trnIndustryBussinessDetailsDao.contractualEmployees'))
      console.log("temptotal", tempTotal);
      setValue('trnIndustryBussinessDetailsDao.totalEmployees', Number(tempTotal))
    }

  }, [watch('trnIndustryBussinessDetailsDao.officeStaff'), watch('trnIndustryBussinessDetailsDao.permanentEmployees'), watch('trnIndustryBussinessDetailsDao.temporaryEmployees'), watch('trnIndustryBussinessDetailsDao.contractualEmployees'), watch('trnIndustryBussinessDetailsDao.totalEmployees')])
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: 'center' }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", width: '45vw', margin: "5vh" }}>
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.fireEquirepment"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.firstAidKit"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.toilets"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.storageofrawmaterial"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.disposalSystemOfWaste"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.nuisanceOfResidents"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.ObjectionCertificate"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryBussinessDetailsDao.separatebusiness"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
