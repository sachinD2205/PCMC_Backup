...
const SiteVisitSchedule = ({ appID }) => {
  ...
  const bookApptSubmit = (data) => {
    ...
    axios
      .post(`${urls.SSLM}/master/slot/bookNow`, finalBody)
      .then((res) => {
            ...
            <form onSubmit={handleSubmit(onFinish)}>
              <div className={styles.box}>
                <div className={styles.titlemodelT} style={{ marginLeft: "25px" }}>
                  ...
                  <IconButton onClick={() => router.push(`/skySignLicense/dashboards`)}>
                    <CloseIcon />
                  </IconButton>
                </div>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  let data = {
                                    ...
                                    fromTime: moment(getValues(`slotss.${index}.fromTime`), "HH:mm:ss a").format("HH:mm:ss"),
                                    toTime: moment(getValues(`slotss.${index}.toTime`), "HH:mm:ss a").format("HH:mm:ss")
                                  };
