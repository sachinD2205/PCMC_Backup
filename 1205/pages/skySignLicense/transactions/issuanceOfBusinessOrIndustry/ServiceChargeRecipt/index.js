          ...
          <div className={styles.small}>
            ...
            <div>
              <h2 className={styles.heading}>
                <b>पावती</b>
                <h5>
                  (महाराष्ट्र आकाश चिन्ह परवाना व्यवस्थापन विनियमन व्यवसाय  परवाना जारी करणे)
                </h5>
              </h2>
            </div>
            ...
            <div className={styles.two}>
              ...
              <div className={styles.date4} style={{ marginBottom: '2vh' }}>
                <div className={styles.date2}>
                  ...
                  <h4 style={{ marginLeft: '10px' }}>
                    {' ' +
                      this?.props?.dataa?.trnIndustryBussinessDetailsDao?.nameOfOrganization}
                  </h4>
                </div>
              </div>
              ...
              <p>
                <h5 style={{ marginLeft: '40px', marginRight: '40px' }}>
                  <b>
                    ...
                    <table id="table-to-xls" className={styles.report_table}>
                      <thead>
                        ...
                        <tr>
                          ...
                          <td colSpan={4}>
                            {this?.props?.dataa?.trnLoi[0]?.amount}
                          </td>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={4}>
                            <b>
                              एकूण रक्कम (रु): {this?.props?.dataa?.trnLoi[0]?.amount}/-
                            </b>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    आकाश चिन्ह परवाना व्यवस्थापन आकारण्यात येणारे व्यवसाय  परवाना जारी करणे &nbsp;
                  </b>
                  <b>एकूण फी</b> &nbsp;
                  {/* <b>{this?.props?.dataa?.loi?.amount}</b> */}
                  <b>{this?.props?.dataa?.trnLoi[0]?.amount} (रु) .</b>
                  <br />
                  <br />
                  <b>
