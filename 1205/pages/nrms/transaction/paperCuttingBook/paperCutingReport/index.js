              ...
              <div className={styles.two}>
                <div className={styles.date4} style={{ marginTop: "2vh", marginLeft: "6vh" }}>
                  <div className={styles.date3}>
                    ...
                    <h4 style={{ marginLeft: "10px" }}>{this?.props?.dataa?.newspaperName}</h4>
                  </div>
                  <div className={styles.date3} style={{ marginRight: "5vh" }}>
                    ...
                    <h4 style={{ marginLeft: "10px" }}>
                      {" " +
                        moment(this?.props?.dataa?.createDtTm, "YYYY-MM-DD HH:mm:ss A").format(
                          "DD-MM-YYYY hh:mm A",
                        )}
                    </h4>
                  </div>
                ...
                <div className={styles.kahipnB}>
                  <div className={styles.mainB}>
                    <div className={styles.oneB}>
                      {this?.props?.dataa?.paperCuttingAttachment.map((item, index) => {
                        return (
                          <div style={{ margin: "1vh", display: "inline", background: "red" }}>
                            <img
