...
const Index = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `${urls.NRMS}/trnNewspaperAgencyBillSubmission/getById?id=${localStorage.getItem(
            ...
            <div className={styles.two}>
              ...
              <div className={styles.date7} style={{ marginBottom: "2vh" }}>
                <div className={styles.date8}>
                  <div className={styles.add7}>
                    <h3>
                      <b>पिंपरी चिंचवड महानगरपालिका, पिंपरी-411018/-</b>
                    </h3>
                    ...
                    <h4>
                      ...
                      {moment(this?.props?.data?.createDtTm, "YYYY-MM-DD").format("DD-MM-YYYY")}
                    </h4>
                  </div>
              ...
              <div className={styles.date8} style={{ marginBottom: "2vh" }}>
                <div className={styles.date6}>
                  ...
                  <h4 style={{ marginLeft: "10px" }}>
                    <b>
                      {this?.props?.data?.newsPublishRequestDao?.departmentNameMr} विभागाकडील निविदा नोटीस
                      क्र.46/2022-23 चे शुद्धीपत्रक क्र.1 चे जाहिरात प्रसिध्दीचे बिल अदा करणेबाबत. जाहिरात
                      क्रमांक {this?.props?.data?.newsPublishRequestDao?.newsPublishRequestNo}
                      {". "}
                      {this?.props?.data?.newsPublishRequestDao?.newsPapersNamesMr}
                    </b>{" "}
                    {/* {this?.props?.dataa?.applicationDate} */}
                  </h4>
                </div>
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  ...
                  <p style={{ marginLeft: "40px", marginRight: "40px" }}>
                    {" "}
                    पिंपरी चिंचवड महानगरपालिकेच्या {this?.props?.data?.departmentName} विभागाकडील निविदा नोटीस
                    क्र. 46/2022-23 चे शुद्धीपत्रक क्र.1 संबंधित जाहिरात प्रसिध्द करणेकामी मध्यवर्ती भांडार
                    विभाग यांनी उपरोक्त वाचले क्रमांक 3 अन्वये जाहिरात प्रसिध्द करणेकामी पत्र दिले आहे. त्यास
                    अनुसरुन माहिती व जनसंपर्क विभाग यांनी वाचले क्रमांक 4 अन्वये दिनांक{" "}
                    {this?.props?.data?.newsPublishRequestDao?.createDtTm} रोजी जाहिरात प्रसिध्द करण्याबाबत
                    {this?.props?.data?.newsPublishRequestDao?.newsPapersNamesMr} या वर्तमानपत्राचे जाहिरात
                    व्यवस्थापक यांना कळविले आहे. संबंधित वर्तमानपत्र यांनी जाहिरात राज्य स्तरावर प्रसिध्द करुन
                    वाचले क्रमांक 5 अन्वये बिल सादर केले आहे.
                  </p>{" "}
                  <h4 style={{ marginLeft: "10px" }}>
                    <b>
                      {" "}
              ...
              <div className={styles.date9} style={{ marginTop: "" }}>
                <div className={styles.date10}>
                  <table className={styles.table}>
                    ...
                    {console.log("this.props.data", this?.props?.data?.paymentDetails)}
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  <p style={{ marginLeft: "40px", marginRight: "40px" }}>
                    ...
                    {this?.props?.data?.newsPublishRequestDao?.newsPapersNamesMr} या वर्तमानपत्राने जाहिरात{" "}
                    {this?.props?.data?.newsPublishRequestDao?.standardFormatSizeName} चौ.से.मी. या कमीत कमी
                    आकारमानात प्रसिध्द केलेली आहे. रोटेशन धोरण परिपत्रक वाचले क्र.2 नुसार बिल अदा करणे आवश्यक
                    आहे. सबब, मी सहाय्यक आयुक्त, माहिती व जनसंपर्क विभाग, पिंपरी चिंचवड महानगरपालिका, पिंपरी-
                    411018, उक्त तक्यात नमुद केल्याप्रमाणे नियमानुसार कपाती करून प्रदानार्थ मंजूर रक्कम रु.
                    {this?.props?.data?.billAmount}/- यामधुन बजा दंड रक्कम रु.
                    {this?.props?.data?.totalDeduction}/- व 1.5% आयकर रक्कम रु.
                    {this?.props?.data?.totalTaxDeduction}/- कपात करुन उर्वरित रक्कम रु.
                    {this?.props?.data?.totalNetAmount}/- अदा करण्यास या आदेशान्वये मान्यता देत आहे.
                  </p>{" "}
                  {/* <h4 style={{ marginLeft: "10px" }}> */}
                  {/* <b> */}
                  {/* {" "} */}
