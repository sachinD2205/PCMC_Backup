                    ...
                    <>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                ...
                                router.push({
                                    pathname: '/nrms/transaction/paperCuttingBook/approval',
              ...
              <div className={styles.date2}>
                ...
                <h4 style={{ marginLeft: '10px' }}>
                  <b>{this?.props?.dataa?.payment?.receiptNo}</b>
                            ...
                            <div className={styles.date4} style={{ margin: '1vh', width: '600px' }}>
                                    <h4 style={{
                                        marginLeft: '10px',
                            ...
                            >
                                ...
                                {/* details */}
                                     ...
                                     <div style={{ margin: '1vh', textAlign:'center' }} > Press Not</div>
                            {/* details */}
                        </div>
                    </div>
                </div>
