...
const EntryForm = () => {
    ...
    const geyBillApproval = () => {
        ...
        setId1(selectedObject?.pressNoteRequestNo ? selectedObject?.pressNoteRequestNo : "-");
        ...
        setPressDescription(selectedObject?.pressNoteDescription ? selectedObject?.pressNoteDescription : "-");
            ...
            const tempData = axios
                ...
                .then((res) => {
                    if (res.status == 201 && authority && authority[0] === "DEPT_USER") {
                        ...
                        sweetAlert("Releasing Order Generated", "Record Generate successfully !", "success");
                        getAllTableData();
                        setButtonInputState(false);
                        setIsOpenCollapse(false);
                        setFetchData(tempData);
