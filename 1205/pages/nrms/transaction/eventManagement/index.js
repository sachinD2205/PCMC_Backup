...
const EventManagement = () => {
          ...
          <Box>
            <IconButton
              ...
              onClick={() => {
                ...
                setValue("eventDate", moment(params?.row?.eventDate, "DD/MM/YYYY").format("YYYY-MM-DD"));
  ...
  // get EventManagement
  const getEventManagement = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
    axios
      .get(`${urls.NRMS}/trnEventManagement/getAll`, {
        // .get(`http://192.168.68.145:9004/nrms/api/trnEventManagement/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
          sortBy: _sortBy,
        ...
        let _res = resp?.map((val, id) => {
          return {
            ...
            departmentKey: val.departmentKey
              ? departments.find((item) => item?.id == val?.departmentKey)?.department
              : "-",
  ...
  const getNextEventNumber = () => {
    axios.get(`${urls.NRMS}/trnEventManagement/getNextEventNo`).then((r) => {
      // axios.get(`http://192.168.68.145:9004/nrms/api/trnEventManagement/getNextEventNo`).then((r) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    if (btnSaveText === "Save") {
      ...
      axios.post(`${urls.NRMS}/trnEventManagement/save`, _body).then((res) => {
      // axios.post(`http://192.168.68.145:9004/nrms/api/trnEventManagement/save`, _body).then((res) => {
        console.log("res---", res);
        if (res.status == 201) {
          getEventManagement();
      ...
      axios.post(`${urls.NRMS}/trnEventManagement/save`, updateBody).then((res) => {
        // axios.post(`http://192.168.68.145:9004/nrms/api/trnEventManagement/save`, updateBody).then((res) => {
        console.log("res---", res);
        if (res.status == 201) {
          getEventManagement();
                  ...
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={errors?.eventNumber ? errors.eventNumber.message : null}
                      />
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <TextField
                        ...
                        InputProps={{ style: { fontSize: 18 } }}
                        helperText={errors?.eventDescription ? errors.eventDescription.message : null}
                      />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container sx={{ padding: "10px" }}>
                          ...
                          render={({ field }) => (
                            <LocalizationProvider dateAdapter={AdapterMoment}>
                              <TimePicker
                                ...
                                renderInput={(params) => (
                                  <TextField error={errors.eventTime} {...params} sx={{ width: "100%" }} size="small" fullWidth />
                                )}
                              />
                            </LocalizationProvider>
                          )}
                    ...
                    >
                      <TextField
                        ...
                        InputProps={{ style: { fontSize: 18 } }}
                        helperText={errors?.eventLocationLat ? errors.eventLocationLat.message : null}
                      />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        InputProps={{ style: { fontSize: 18 } }}
                        helperText={errors?.eventLocationLong ? errors.eventLocationLong.message : null}
                      />
                    </Grid>
                  </Grid>
                  <Grid container>
