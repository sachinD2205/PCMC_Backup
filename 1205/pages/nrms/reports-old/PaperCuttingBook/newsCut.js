...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    if (btnSaveText === "Save") {
      ...
      const tempData = axios.post(`${urls.NRMS}/trnPaperCuttingBook/save`, _formData).then((res) => {
        console.log("res---", res);
        if (res.status == 201) {
  ...
  //     axios
  //       .get(
  //         `${urls.NRMS}/trnNewsPublishRequest/getDetailsByNewsPublishRequestNo?newsPublishRequestNo=NRMS/ADVT30/03/2023/000016`,
  //         {},
  //       )
  //       .then((r) => {
  //         let result = r.data.trnNewsPublishRequestList;
                        ...
                        render={({ field }) => (
                          <LocalizationProvider dateAdapter={AdapterMoment}>
                            <DatePicker
                              ...
                              label={<span style={{ fontSize: 16 }}>Published Date</span>}
                              value={field.value}
