...
const Index = () => {
    ...
    const getRotationGroup = () => {
        axios.get(`${urls.NRMS}/newspaperRotationGroupMaster/getAll`).then((r) => {
            console.log("a:a", r.data.newspaperRotationGroupMasterList.map((row) => ({
    ...
    const getRotationSubGroup = () => {
        axios.get(`${urls.NRMS}/newspaperRotationSubGroupMaster/getAll`).then((r) => {
            console.log("subGrssssoup", r.data.newspaperRotationSubGroupMasterList.map((row) => ({
    ...
    const getNewsPaper = () => {
        ...
        axios.get(`${urls.NRMS}/newsStandardFormatSizeMst/getAll`).then((r) => {
            console.log("dfgh", r?.data?.newsStandardFormatSizeMstList?.map((r, i) => ({
                id: r.id,
    ...
    const onSubmitForm = (formData) => {
        ...
        // Update Data Based On ID
            ...
            const tempData = axios
                .post(`${urls.NRMS}/trnNewsPublishRequest/save`, payload)
                .then((res) => {
                    console.log(":res", res);
                    if (res.status == 201) {
                        formData.id
                                                ...
                                                render={({ field }) => (
                                                    <Select
                                                        ...
                                                        InputLabelProps={{
                                                            //true
                                                            shrink:
                                                                (watch("zoneName") ? true : false) ||
                                                                (router.query.zoneName ? true : false),
                                                        }}
                                                    >
                                                        {zone &&
                                                            zone.map((each, index) => (
                              ...
                              : null}
                                    ...
                                    >
                                        <TextField
                                            ...
                                            error={!!errors.label2}
                                            helperText={
                                                errors?.workName ? errors.workName.message : null
                                            }
                                            InputLabelProps={{
                                                //true
                                                shrink:
                                    ...
                                    >
                                        <TextField
                                            ...
                                            helperText={
                                                errors?.newsAdvertisementDescription ? errors.newsAdvertisementDescription.message : null
                                            }
                                            InputLabelProps={{
                                                //true
                                                shrink:
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            />
                                            <FormHelperText>
                                                {errors?.rotationGroupName
                                                    ? errors.rotationGroupName.message
                                                    : null}
                                            </FormHelperText>
                                        </FormControl>
                                    </Grid>
