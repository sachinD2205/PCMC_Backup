...
const Index = () => {
    ...
    const getRotationGroups = () => {
        axios.get(`${urls.NRMS}/newspaperRotationGroupMaster/getAll`).then((r) => {
            console.log("a:a", r)
            setRotationGroups(
                r.data.newspaperRotationGroupMasterList
            );
    ...
    const getRotationSubGroupsByGroup = (value) => {
        axios.get(`${urls.NRMS}/newspaperRotationSubGroupMaster/getByGroupId?groupId=${value}`).then((r) => {
            setRotationSubGroups(
                r.data.newspaperRotationSubGroupMasterList
            );
        });
    };
    ...
    const columns = [
        ...
        {
            field: `${language === "en" ? "newsPaperGroupName" : "newsPaperGroupNameMr"}`,
            headerName: <FormattedLabel id="newsPaperDropDown" />,
            flex: 1,
        },
        {
            field: `${language === "en" ? "newsPaperSubGroupName" : "newsPaperSubGroupNameMr"}`,
        ...
        {
            field: `${language === "en" ? "newsPaperLevelTxt" : "newsPaperLevelTxtMr"}`,
            headerName: <FormattedLabel id="newsPaperLevelDropDown" />,
            flex: 1,
        },
        {
                    ...
                    <Box>
                        <IconButton
                            ...
                            onClick={() => {
                                ...
                                getNewsPaperLevels(params.row.newsPaperSubGroupKey);
                            ...
                            <Grid>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Controller
                                                        ...
                                                        {rotationGroups &&
                                                            rotationGroups.map((rotationGroupName, index) => (
                                                                <MenuItem key={index} value={rotationGroupName.id}>
                                                                    {language == 'en' ? rotationGroupName.rotationGroupName : rotationGroupName.rotationGroupNameMr}
                                                                </MenuItem>
                                                            ))}
                                                    </Select>
                                                )}
                                                ...
                                                defaultValue=""
                                            />
                                            <FormHelperText>{errors?.newsPaperGroupKey ? errors.newsPaperGroupKey.message : null}</FormHelperText>
                                        </FormControl>
                                    </Grid>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Controller
                                                    ...
                                                    >
                                                        {rotationSubGroups &&
                                                            rotationSubGroups.map((rotationGroupName, index) => (
                                                                <MenuItem key={index} value={rotationGroupName.id}>
                                                                    {language == 'en' ? rotationGroupName.rotationSubGroupName : rotationGroupName.rotationSubGroupNameMr}
                                                                </MenuItem>
                                                            ))}
                                                    </Select>
                                                )}
                                                ...
                                                defaultValue=""
                                            />
                                            <FormHelperText>{errors?.newsPaperSubGroupKey ? errors.newsPaperSubGroupKey.message : null}</FormHelperText>
                                        </FormControl>
                                    </Grid>
                                ...
                                <Grid container sx={{ padding: "10px" }}>
                                    ...
                                    >
                                        ...
                                        >
                                            <InputLabel id="demo-simple-select-standard-label">
                                                {<FormattedLabel id="newsPaperLevelDropDown" required />}
                                            </InputLabel>
                                            <Controller
                                                render={({ field }) => (
                                                    <Select
                                                        ...
                                                        {newsPaperLevels &&
                                                            newsPaperLevels.map((newsPaperLevel, index) => (
                                                                <MenuItem key={index} value={newsPaperLevel.id}>
                                                                    {language == 'en' ? newsPaperLevel.newsPaperLevel : newsPaperLevel.newsPaperLevelMr}
                                                                </MenuItem>
                                                            ))}
                                                    </Select>
                                                )}
                                                        ...
                                                        {chargeTypes &&
                                                            chargeTypes.map((chargeType, index) => (
                                                                <MenuItem key={index} value={chargeType.id}>
                                                                    {language == 'en' ? chargeType.chargeName : chargeType.chargeNameMr}
                                                                </MenuItem>
                                                            ))}
                                                    </Select>
                                                )}
                                ...
                                >
                                    ...
                                    >
                                        <Button
                                            sx={{ marginLeft: "300px", justifyContent: "center", alignItems: "center" }}
                                            type="submit"
                                            variant="contained"
                                            color="primary"
                                            endIcon={<SaveIcon />}
