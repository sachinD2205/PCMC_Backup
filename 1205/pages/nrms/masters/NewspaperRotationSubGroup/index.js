...
const Index = () => {
      ...
      .then((r) => {
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            rotationGroupName: rotationGroup?.find((rg) => rg?.id == r.rotationGroupKey)?.rotationGroupName,
            rotationGroupNameMr: rotationGroup?.find((rg) => rg?.id == r.rotationGroupKey)
              ?.rotationGroupNameMr,
          };
        });
        setDataSource([..._res]);
  ...
  const onSubmitForm = (fromData) => {
    ...
    if (btnSaveText === "Save") {
      const tempData = axios.post(`${urls.NRMS}/newspaperRotationSubGroupMaster/save`, _body).then((res) => {
        if (res.status == 201) {
                ...
                <Grid container>
                  ...
                  >
                    ...
                    >
                      ...
                      <Controller
                        ...
                        defaultValue=""
                      />
                      <FormHelperText>{errors?.rotationGroupKey ? errors.rotationGroupKey.message : null}</FormHelperText>
                    </FormControl>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                    <TextField
                      ...
                      helperText={
                        errors?.rotationSubGroupName ? errors.rotationSubGroupName.message : null
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                    <TextField
                      ...
                      helperText={
                        errors?.rotationSubGroupNameMr ? errors.rotationSubGroupNameMr.message : null
