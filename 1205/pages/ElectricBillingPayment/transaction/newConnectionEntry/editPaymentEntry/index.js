...
const Index = () => {
  ...
  const getConsumerDetails = () => {
    setConsumerName(
      !dataSource ? "-" : language == "en" ? dataSource?.consumerName : dataSource?.consumerNameMr,
    );
    setConsumerAddress(
      !dataSource ? "-" : language == "en" ? dataSource?.consumerAddress : dataSource?.consumerAddressMr,
    );
    ...
    setDesc(
      !dataSource
        ? "-"
        : language == "en"
        ? dataSource?.quotationDescription
        : dataSource?.quotationDescriptionMr,
    );
    ...
    >
      <FormProvider {...methods}>
        <form>
          ...
          >
            <h2>{/* <FormattedLabel id="quotationForNewConnection" /> */}</h2>
          </Box>
          ...
          <Grid container sx={{ padding: "10px" }}>
            ...
            >
              ...
              <FormControl variant="standard" sx={{ m: 1, minWidth: "50%" }} error={!!errors.paymentDate}>
                <Controller
                  // variant="standard"
                  control={control}
                  name="Payment Date"
                ...
                />
                <FormHelperText>{errors?.paymentDate ? errors.paymentDate.message : null}</FormHelperText>
              </FormControl>
            </Grid>
