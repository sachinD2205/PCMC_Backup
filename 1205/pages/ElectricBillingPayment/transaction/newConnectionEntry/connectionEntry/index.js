...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    const tempData = axios
        ...
        .then((res) => {
            if (res.status == 201) {
                sweetAlert("Completed!", `Connection ${dataSource?.id} Completed successfully !`, "success");
                getNewConnectionsData();
        ...
        <form onSubmit={handleSubmit(onSubmitForm)}>
          ...
          <Grid container sx={{ padding: "10px" }}>
                      ...
                      {billingCycle &&
                        billingCycle.map((cycle, index) => (
                          <MenuItem key={index} value={cycle.id}>
                            {language == "en" ? cycle.billingCycle : cycle.billingCycleMr}
                          </MenuItem>
                        ))}
                    </Select>
                  )}
            ...
            <Grid container>
              ...
              {(user && (authority && authority.find((val)=> val === "ENTRY"))) || (authority && authority.find((val)=> val === "PAYMENT VERIFICATION")) ? (
                <Grid
                  container
                  mt={5}
                  rowSpacing={2}
                ...
                >
                  ...
                  {dataSource?.status == 7 && authority && authority.find((val)=> val === "PAYMENT VERIFICATION" ) ? (
                    <>
                      <Grid
                        item
                        xl={6}
                      ...
                      >
                        ...
                        >
                           {<FormattedLabel id="downloadForm" />}
                        </Button>
                      </Grid>
                    </>
                  ) : (
                    ...
                    >
                      <Button
                        type="submit"
                        variant="contained"
                        disabled={authority && authority.find((val) => val !== "ENTRY")}
                      >
                ...
                <Grid container mt={5} rowSpacing={2} border px={5}>
                  ...
                  >
                    <Button variant="contained" onClick={handleOpen}>
                      {<FormattedLabel id="viewDemandLetter" />}
                    </Button>
                  </Grid>
                  ...
                  >
                    <Button variant="contained">{<FormattedLabel id="approve" />}</Button>
                  </Grid>
                  ...
                  >
                    <Button variant="contained">{<FormattedLabel id="revert" />}</Button>
                  </Grid>
