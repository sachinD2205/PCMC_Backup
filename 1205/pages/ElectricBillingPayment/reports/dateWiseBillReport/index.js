...
const Index = () => {
  ...
  const getZoneData = () => {
    axios.get(`${urls.CFCURL}/master/zone/getAll`).then((res) => {
      ...
      console.log("getZone.data", res.data.zone);
    });
  }
  ...
  const getWardData = () => {
    axios.get(`${urls.CFCURL}/master/ward/getAll`).then((res) => {
      ...
      console.log("getWard.data", res.data.ward);
    });
  }
  ...
  const onSubmitFunc = () => {
    if (watch("fromDate") && watch("toDate")) {
      ...
      setLoading(true);
      axios
        .post(`${urls.EBPSURL}/report/getDateWiseElectricBillDetails`, apiBodyToSend)
        .then((res) => {
          console.log(":log", res);
            ...
            if (res?.data.length > 0) {
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  paymentDate:  moment(r.paymentDate).format("DD-MM-YYYY"),
  ...
  const columns = [
    ...
    {
      field: "billingUnits",
      headerName: <FormattedLabel id="billingUnit" />,
      minWidth: 150,
      headerAlign: "center",
      align: "center",
    },
    ...
    {
      field: "paymentDate",
      headerName: <FormattedLabel id="paymentDate" />,
      minWidth: 200,
      headerAlign: "center",
      align: "center",
    },
    {
      field: "paidAmount",
      headerName: <FormattedLabel id="paidAmount" />,
      minWidth: 200,
      headerAlign: "center",
      align: "center",
    },
