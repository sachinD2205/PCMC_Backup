...
const Index = () => {
  ...
  const columnGroupingModel = [
      {
        groupId: language == "en" ? "April" : "एप्रिल",
      ...
      {
        groupId: language == "en" ?  "August" : "ऑगस्ट",
      ...
      {
        groupId: language == "en" ? "September" : "सप्टेंबर",
      ...
      {
        groupId: language == "en" ?  "October" : "ऑक्टोबर",
      ...
      {
        groupId: language == "en" ? "November" : "नोव्हेंबर",
      ...
      {
        groupId: language == "en" ? "December" : "डिसेंबर",
      ...
      {
        groupId: language == "en" ?  "January" : "जानेवारी",
      ...
      {
        groupId: language == "en" ?  "February" : "फेब्रुवारी",
      ...
      {
        groupId: language == "en" ?  "March" : "मार्च",
                    ...
                    >
                      {loadTypeDropDown &&
                        loadTypeDropDown.map((each, index) => (
                          <MenuItem key={index} value={each.id}>
                            {language == "en" ? each.loadType  : each.loadTypeMr}
                          </MenuItem>
                        ))}
                    </Select>
                  )}
                    ...
                    >
                      {msedclCategoryDropDown &&
                        msedclCategoryDropDown.map((each, index) => (
                          <MenuItem key={index} value={each.id}>
                             {language == "en" ? each.msedclCategory  : each.msedclCategoryMr}
                          </MenuItem>
                        ))}
                    </Select>
                  )}
                    ...
                    >
                      {consumptionTypeDropDown &&
                        consumptionTypeDropDown.map((each, index) => (
                          <MenuItem key={index} value={each.id}>
                            {language == "en" ? each.consumptionType  : each.consumptionTypeMr}
                          </MenuItem>
                        ))}
                    </Select>
                  )}
