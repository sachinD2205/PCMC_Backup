...
const Index = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      // )
      .get(
        `${urls.MR}/transaction/renewalOfMarraigeBoardCertificate/getapplicantById?applicationId=${router?.query?.id}`,
      )
      .then((res) => {
        setDataa(res.data);
      ...
      <div className={styles.btn}>
        ...
        <Button
          ...
          onClick={() => {
            swal(
              "Exit!",
              "Application for Renewal of Board registration Created successfully! Visit Zonal office for further information.",
              "success",
            );
            router.push("/marriageRegistration/transactions/RenewalOfMarriageBoardRegisteration");
          }}
        >
          Exit
        </Button>
