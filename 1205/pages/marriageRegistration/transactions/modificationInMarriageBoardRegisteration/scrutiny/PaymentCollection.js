...
const Index = () => {
  ...
  const handleExit = () => {
    ...
    router.push("/marriageRegistration/transactions/modificationInMarriageBoardRegisteration/scrutiny");
  };
  ...
  const handlePay = () => {
    ...
    // })
    axios
      .post(`${urls.MR}/transaction/modOfMarBoardCertificate/saveModOfMarBoardCertificateApprove`, finalBody)
      .then((res) => {
        console.log(res);
          ...
          <div className={styles.appDetails}>
            ...
            <div>
              <h4>
                ...
                {router.query.serviceId == 9 ? watch('charges') : total}
              </h4>
