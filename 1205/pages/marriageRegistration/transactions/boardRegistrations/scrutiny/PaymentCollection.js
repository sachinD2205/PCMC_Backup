...
const Index = () => {
  ...
  useEffect(() => {
    axios.get(`${urls.CFCURL}/master/servicecharges/getByServiceId?serviceId=67`).then((r) => {
  ...
  const handlePay = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        router.push({
          pathname: "/marriageRegistration/transactions/boardRegistrations/scrutiny/ServiceChargeRecipt",
          query: {
            ...router?.query,
          },
        });
      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          <div className={styles.appDetails}>
            ...
            <h4>अर्ज दिनांक : {moment(dataa?.applicationDate).format("DD-MM-YYYY")}</h4>
