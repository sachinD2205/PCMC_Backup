      ...
      <BasicLayout titleProp={'Goshwara 1'}>
        <Card>
         ...
         <Table
            ...
            scroll={{ y: 350, x: 1900 }}
          >
            <columns dataIndex='marriageDate' title='Marriage Date'
              width='150px'
              align='center'
            >
            </columns>
            <columns dataIndex='registrationNo' title='Marriage Registration No.'
              width='200px'
              align='center'
            >
            </columns>
            <columns dataIndex='marriageRegistrarOfficeName' title='Marriage Registrar Office Name'
              width='180px'
              align='center'
            >
            </columns>
            ...
            <ColumnGroup title='Groom Details'>
              <columns dataIndex='groomName' title='Groom Name'
                width='200px'
                align='center'
              >
              </columns>
              <columns dataIndex='hAge' title='Age'
                width='70px'
                align='center'
              >
              </columns>
              <columns dataIndex='hAddressP' title='Address'
                width='150px'
                align='center'
              >
              </columns>
              <columns dataIndex='husbandSign' title='Sign'
                width='100px'
                align='center'
              >
              </columns>
              <columns dataIndex='husbandPhoto' title='Web-Photo'
                width='120px'
                align='center'
              >
              </columns>
              <columns dataIndex='husbandThumb' title='Thumb Impression'
                width='160px'
                align='center'
              >
              </columns>
            ...
            <ColumnGroup title='Bride Details'>
              <columns dataIndex='brideName' title='Bride Name'
                width='200px'
                align='center'
              >
              </columns>
              <columns dataIndex='wAge' title='Age'
                width='70px'
                align='center'
              >
              </columns>
              <columns dataIndex='wAddressP' title='Address'
                width='150px'
                align='center'
              >
              </columns>
              <columns dataIndex='wifeSign' title='Sign'
                width='100px'
                align='center'
              >
              </columns>
              <columns dataIndex='wifePhoto' title='Web-Photo'
                width='120px'
                align='center'
              >
              </columns>
              <columns dataIndex='wifeThumb' title='Thumb Impression'
                width='160px'
                align='center'
              >
              </columns>
            ...
            <columns dataIndex='printDateandTime' title='Print Date and Time'
              width='170px'
              align='center'
            >
            </columns>
            <columns dataIndex='marriageRegistrar' title='Marriage Registrar'
              width='160px'
              align='center'
            >
            </columns>
            <columns dataIndex='zoneOfficeName' title='Zone Office Name'
              width='150px'
              align='center'
            >
            </columns>
            <columns dataIndex='nameOfCorporation' title='Name of Corporation'
              width='120px'
              align='center'
            >
            </columns>
            ...
            <table className={styles.report_table}>
              <thead>
                ...
                <tr>
                  ...
                  <th colSpan={1} rowSpan={4}>
                    <b>Marriage Registrar Office Name</b>
                  </th>
              ...
              <th colSpan={1} rowSpan={4}> 
              <b>Marriage Registrar</b>
              </th>
            */}
                  <th colSpan={1} rowSpan={4}>
                    <b>Zone Office Name</b>
                  </th>
                  <th colSpan={1} rowSpan={4}>
