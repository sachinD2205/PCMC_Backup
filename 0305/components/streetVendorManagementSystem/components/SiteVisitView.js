...
const SiteVisitView = (props) => {
  ...
  useEffect(() => {
    ...
    setStreetVendorPhoto(props?.props[props?.props?.length - 1].streetVendorPhoto);
    setStreetVendorThumb1(props?.props[props?.props?.length - 1].streetVendorThumb1);
    setStreetVendorThumb2(props?.props[props?.props?.length - 1].streetVendorThumb2);
    setStreetVendorThumb2(props?.props[props?.props?.length - 1].streetVendorThumb2);
    setValue("additionalLabour", props?.props[props?.props?.length - 1].additionalLabour);
    setValue("businessHawkinglocation", props?.props[props?.props?.length - 1].businessHawkinglocation);
    setValue("businessTrafficCongestion", props?.props[props?.props?.length - 1].businessTrafficCongestion);
    setValue("emailAddress", props?.props[props?.props?.length - 1].emailAddress);
    setValue("inspectionSellingGoods", props?.props[props?.props?.length - 1].inspectionSellingGoods);
    setValue("roadWithBusinessLocation", props?.props[props?.props?.length - 1].roadWithBusinessLocation);
    setValue("siteVisitRemark", props?.props[props?.props?.length - 1].siteVisitRemark);
                        ...
                        render={({ field }) => (
                          ...
                          >
                            <FormControlLabel
                              ...
                              helperText={
                                errors?.inspectionSellingGoods ? errors.inspectionSellingGoods.message : null
                              }
                            />
                            <FormControlLabel
                              disabled
