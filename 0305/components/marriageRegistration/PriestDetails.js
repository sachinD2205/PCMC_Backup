  ...
  return (
    <>
      <div className={styles.small}>
        ...
        <div className={styles.row}>
          <div>
            <FormControl variant="standard" error={!!errors.ptitle} sx={{ marginTop: 2 }}>
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{errors?.ptitle ? errors.ptitle.message : null}</FormHelperText>
            </FormControl>
          </div>
          <div>
            <TextField
          ...
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("pmName") ? true : false) || (router.query.pmName ? true : false),
              }}
              id="standard-basic"
          ...
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("plName") ? true : false) || (router.query.plName ? true : false),
              }}
              id="standard-basic"
        ...
        <div className={styles.row}>
          <div>
            <FormControl sx={{ marginTop: 0 }} error={!!errors.pbirthDate}>
                ...
                render={({ field }) => (
                  <LocalizationProvider dateAdapter={AdapterMoment}>
                    <DatePicker
                      ...
                      inputFormat="DD/MM/YYYY"
                      label={
                        <span style={{ fontSize: 13 }}> {<FormattedLabel id="BirthDate" required />}</span>
                      }
                      value={field.value}
                      onChange={(date) => {
                        field.onChange(moment(date).format("YYYY-MM-DD"));
              ...
              />
              <FormHelperText>{errors?.pbirthDate ? errors.pbirthDate.message : null}</FormHelperText>
            </FormControl>
          </div>
          <div>
            <TextField
          ...
          <div>
            <FormControl variant="standard" sx={{ marginTop: 2 }} error={!!errors.pgender}>
              <InputLabel id="demo-simple-select-standard-label">
              ...
              <Controller
                    ...
                    {pGenders &&
                      pGenders.map((pgender, index) => (
                        <MenuItem key={index} value={pgender.id}>
                          {/* {pgender.pgender} */}
                          {language == "en" ? pgender?.gender : pgender?.genderMr}
                        </MenuItem>
                      ))}
                  </Select>
                )}
                ...
                defaultValue=""
              />
              <FormHelperText>{errors?.pgender ? errors.pgender.message : null}</FormHelperText>
            </FormControl>
          </div>
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("paadharNo") ? true : false) || (router.query.paadharNo ? true : false),
              }}
              id="standard-basic"
        ...
        <div className={styles.row} style={{ marginRight: "25%" }}>
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("pemail") ? true : false) || (router.query.pemail ? true : false),
              }}
              id="standard-basic"
          ...
          <div>
            <FormControl variant="standard" sx={{ marginTop: 2 }} error={!!errors.preligionByBirth}>
              <InputLabel id="demo-simple-select-standard-label">
                    ...
                    {religions &&
                      religions.map((preligionByBirth, index) => (
                        <MenuItem key={index} value={preligionByBirth.id}>
                          ...
                          {language == "en" ? preligionByBirth?.religion : preligionByBirth?.religionMr}
                        </MenuItem>
                      ))}
                  </Select>
                )}
              ...
              />
              <FormHelperText>
                {errors?.preligionByBirth ? errors.preligionByBirth.message : null}
              </FormHelperText>
            </FormControl>
          </div>

          <div>
            <FormControl variant="standard" sx={{ marginTop: 2 }} error={!!errors.preligionByAdoption}>
              <InputLabel id="demo-simple-select-standard-label">
                    ...
                    {religions &&
                      religions.map((preligionByAdoption, index) => (
                        <MenuItem key={index} value={preligionByAdoption.id}>
                          ...
                          {language == "en" ? preligionByAdoption?.religion : preligionByAdoption?.religionMr}
                        </MenuItem>
                      ))}
                  </Select>
                )}
              ...
              />
              <FormHelperText>
                {errors?.preligionByAdoption ? errors.preligionByAdoption.message : null}
              </FormHelperText>
            </FormControl>
          </div>
        </div>
        ...
        <div className={styles.row}>
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("pbuildingNo") ? true : false) || (router.query.pbuildingNo ? true : false),
              }}
              id="standard-basic"
              ...
              helperText={errors?.pbuildingNo ? errors.pbuildingNo.message : null}
            />
          </div>
          <div>
            <TextField
              InputLabelProps={{
                shrink:
                  (watch("pbuildingName") ? true : false) || (router.query.pbuildingName ? true : false),
              }}
              id="standard-basic"
              ...
              helperText={errors?.pbuildingName ? errors.pbuildingName.message : null}
            />
          </div>
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("proadName") ? true : false) || (router.query.proadName ? true : false),
              }}
              id="standard-basic"
          ...
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("plandmark") ? true : false) || (router.query.plandmark ? true : false),
              }}
              id="standard-basic"
        ...
        <div className={styles.row}>
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("pcityName") ? true : false) || (router.query.pcityName ? true : false),
              }}
              id="standard-basic"
          ...
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("pstate") ? true : false) || (router.query.pstate ? true : false),
              }}
              id="standard-basic"
          ...
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("ppincode") ? true : false) || (router.query.ppincode ? true : false),
              }}
              id="standard-basic"
          ...
          <div>
            <TextField
              InputLabelProps={{
                shrink: (watch("pmobileNo") ? true : false) || (router.query.pmobileNo ? true : false),
              }}
              id="standard-basic"
