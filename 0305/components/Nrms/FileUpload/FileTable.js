...
const FileTable = (props) => {
    ...
    props.newFilesFn((oldElements) => {
      ...
      return [
        ...oldElements,
        {
          ...
          attachedNameEn: user?.userDao?.firstNameEn + " " + user?.userDao?.middleNameEn + " " + user?.userDao?.lastNameEn,
  ...
  // useEffect
  useEffect(() => { console.log("props.authorizedToUpload", props.authorizedToUpload); }, [props.authorizedToUpload]);
