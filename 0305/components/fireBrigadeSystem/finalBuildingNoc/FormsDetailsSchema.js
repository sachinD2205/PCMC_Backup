...
let FormSchema = yup.object().shape({
  ...
  //   .matches(
  //     /^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/,
  //     "Applicant contact is not valid"
  //   )
  ...
  //   .string()
  //   .matches(/^[0-9]+$/, "Must be number !!!")
  //   .required("Revenue survey number is Required !!!"),
  // townPlanningNo: yup
  //   .string()
  //   .matches(/^[0-9]+$/, "Must be number !!!")
  //   .required("Town planning number is Required !!!"),
  // blockNo: yup
  //   .string()
  //   .matches(/^[0-9]+$/, "Must be number !!!")
  ...
  //   .string()
  //   .matches(/^[0-9]+$/, "Must be number !!!")
  //   .required("Op number is Required !!!"),
  // citySurveyNo: yup
  //   .string()
  //   .matches(/^[0-9]+$/, "Must be number !!!")
  //   .required("city survey number is Required !!!"),
  // buildingLocationMr: yup
  //   .string()
  //   .required("Building location is Required !!!"),
