...
export default class BonafideToPrint extends React.Component {
  render() {
    ...
    console.log("studentDataForPrint", this.props.studentData);
          ...
          <div className={styles.small} style={{ margin: "5px" }}>
            <Grid container sx={{ padding: "10px" }}>
              ...
              >
                <Typography component="div" style={{ justifyContent: "center", alignItems: "center" }}>
                  ...
                  >
                    {language == "en" ? " Bonafide Certificate " : "बोनाफाईड प्रमाणपत्र"}
                  </Box>
                  <Box
                    sx={{
                      display: "flex",
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={12}>
                {language == "en" ? (
                  <Typography>
                    This is to certify that <b> {this?.props?.data?.studentName} </b> is a student of{" "}
                    <b>{this?.props?.data?.schoolName} </b>currently studying in class{" "}
                    <b>{this?.props?.data?.className}</b> and division{" "}
                    <b>{this?.props?.data?.divisionName}</b> .
                  </Typography>
                ) : (
                  <Typography>
                    हे प्रमाणित करण्यासाठी आहे की <b> {studentNameMr}</b> हा{" "}
                    <b> {studentData?.schoolNameMr}</b> चा विद्यार्थी आहे जो सध्या वर्ग{" "}
                    <b> {this?.props?.data?.className} </b>आणि <b>{this?.props?.data?.divisionName}</b>{" "}
                    विभागात शिकत आहे, .
                  </Typography>
                )}
              </Grid>
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={12}>
                {language == "en" ? (
                  <Typography>
                    According to school record, he/she belongs to <b>{studentData?.casteName}</b> Category,
                    His/Her birth date is{" "}
                    <b>{moment(this?.props?.data?.studentDateOfBirth, "YYYY-MM-DD").format("DD-MM-YYYY")}</b>
                  </Typography>
                ) : (
                  <Typography>
                    शाळेच्या नोंदीनुसार तो/ती <b>{studentData?.casteNameMr}</b> या श्रेणीतील आहे ,तसेच
                    त्याचि/तिची जन्मतारीख{" "}
                    <b>{moment(this?.props?.data?.studentDateOfBirth, "YYYY-MM-DD").format("DD-MM-YYYY")}</b>
                  </Typography>
                )}
              </Grid>
            ...
            <Grid container sx={{ padding: "10px" }}>
              <Grid item xs={12}>
                {language == "en" ? (
                  <Typography>
                    and place of birth is <b>{studentData?.birthPlace}</b> . His/Her residential permanent
                    address is <b>{studentData?.familyPermanentAddress}</b>
                  </Typography>
                ) : (
                  <Typography>
                    आणि जन्म ठिकाण <b>{studentData?.birthPlacemr}</b> आहे. त्याचा/तिचा रहिवासी कायमचा पत्ता{" "}
            ...
            <Grid container sx={{ padding: "6px" }}>
              <Grid item xs={12}>
                {language == "en" ? (
                  ...
                  <Typography>
                    हे प्रमाणित केले जाते की वरील माहिती शाळेच्या नोंदणी क्रमांक 1 च्या आधारावर आहे
                  </Typography>
                )}
              </Grid>
            </Grid>
            ...
            <Grid container sx={{ padding: "6px" }}>
              <Grid item xs={12}>
                {language == "en" ? (
                  ...
                  <Typography>
                    टीप: 1. बोनाफाईड प्रमाणपत्रामध्ये अनधिकृत बदल करणे हा गंभीर गुन्हा आहे.
                  </Typography>
                )}
              </Grid>
            </Grid>
