...
let schema = yup.object().shape({
  ...
  appId: yup.string().required().typeError("Plase Choose Application Name"),
  icon: yup.string().required().typeError("Plase Choose Icon"),
  breadcrumName: yup.string().required().required().typeError("Enter Breadcrum Name"),
  ...
  parentId: yup.string().required().typeError("Plase Select One"),
