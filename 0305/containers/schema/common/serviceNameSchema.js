...
let schema = yup.object().shape({
  ...
  application: yup.string().required().typeError("Plase Choose Application Name"),
  ...
  noOfScrutinyLevel: yup.number().required().typeError("Plase Enter Scrutiny Level"),
  ...
  clickTo: yup.string().required().typeError("URL is required !!"),
});
