...
const siteVisitDashboard = () => {
  ...
  const getAllSiteVisitAppointments = () => {
    ...
    axios
      .get(`${urls.HMS}/master/AppointmentScheduleReschedule/getAppointmentByFromDateAndToDate?fromDate=${startDateMonth}&toDate=${endDateMonth}`).then((r) => {
