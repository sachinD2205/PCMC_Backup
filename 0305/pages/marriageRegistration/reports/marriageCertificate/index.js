          ...
          <div>
            <Paper>
              <table className={styles.data} style={{ marginTop: "25px" }}>
                <tr>
                  <div className={styles.main}>
                    ...
                    <div className={styles.two}>
                      ...
                      /> */}
                      <Image src={"/logoCer.jpg"} alt="Maharashtra Logo" height={200} width={200}></Image>
                    </div>
                ...
                <tr>
                  <center style={{ lineHeight: "0.8" }}>
                    ...
                    <h3>Form 'E'</h3> <h3>विवाह नोंदणी प्रमाणपत्र</h3>{" "}
                    <h3>Certificate Of Registration Of Marriage</h3>
                    <h3>(पहा कलम ६ (१) आणि नियम ५) See section 6(1) and Rule 5</h3>
                  </center>
                </tr>
              </table>
                  ...
                  <div className={styles.data1}>
                    ...
                    >
                      <label>
                        ...
                        रोजी <b>{" " + this?.props?.data?.pplaceOfMarriageMr}</b> (ठिकाणी) येथे विधी संपन्न
                        झाला. त्याची महाराष्ट्र विवाह मंडळाचे विनियमन आणि विवाह नोंदणी विधेयक १९९८ अन्वये
                        ...
                        at Serial No:
                        <b>{" " + this?.props?.data?.registrationNumber}</b> of Volume 3 of register of
                        Marriages maintained under the Maharashtra Regulation of Marriage Bureaus and
              ...
              <div className={styles.kahipn}>
                ...
                >
                  <b>ठिकाण :{/* {' ' + this?.props?.data?.zone?.zoneNameMr + ' '} */}</b>
