...
const LoiGenerationRecipt = () => {
  ...
  const getLoiGenerationData = (data) => {
    ...
    if (router?.query?.applicationId) {
      axios
        .get(
          `${urls.MR}/transaction/marriageBoardRegistration/getapplicantById?applicationId=${Number(
            ...
            <div className={styles.two} style={{ marginTop: "2vh", marginLeft: "5vh", marginRight: "5vh" }}>
              ...
              <p>
                <b>
                  ...
                  <br /> किंवा जवळील पिंपरी चिंचवड महानगरपालिका विभागीय कार्यालयाला भेट द्या .<br></br>
                </b>
              </p>
