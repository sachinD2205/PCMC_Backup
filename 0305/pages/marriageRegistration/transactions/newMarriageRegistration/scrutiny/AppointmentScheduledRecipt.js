            ...
            <div className={styles.two}>
              ...
              <div style={{ marginTop: "2vh", marginLeft: "5vh", marginRight: "5vh" }}>
                <h4>
                  ...
                  <b>
                    <br />
                    तुमचा {router?.query?.serviceNameMr} अर्ज प्राप्त झाला आहे आणि मंजुरी साठी प्रलंबित आहे.
                  </b>
                  <b>
                    {" "}
                    अपॉइंटमेंट तारीख आणि अपॉइंटमेंट स्लॉट वेळ :{" "}
                    {" " + moment(router?.query?.appointmentDate, "YYYY-MM-DD").format("DD-MM-YYYY")}{" "}
                    {router?.query?.appointmentFromTime} - {router?.query?.appointmentToTime}
                  </b>{" "}
                  &nbsp;
                  <b>
                    <br />
                    कृपया सर्व चेकलिस्ट दस्तऐवजांची मूळ हार्ड कॉपी {router?.query?.zoneAddress} येथे सोबत ठेवा
                  </b>{" "}
                  &nbsp;
                  <b>
                    {router?.query?.serviceNameMr} या सेवेसाठी नागरिक सेवा पोर्टलवर तुमची अपॉइंटमेंट बुक झाली
                    आहे. <br />
