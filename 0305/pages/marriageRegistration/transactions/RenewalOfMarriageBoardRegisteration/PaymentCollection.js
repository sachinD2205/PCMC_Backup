...
const Index = () => {
  ...
  useEffect(() => {
    axios.get(`${urls.CFCURL}/master/servicecharges/getByServiceId?serviceId=14`).then((r) => {
        ...
        >
          ...
          <div className={styles.appDetails}>
            ...
            {/* {router.query.serviceId != 9 ? (
              ...
              */}
            <div>
              <h4>Total Amount to be paid : {router.query.serviceId == 14 ? watch("charges") : total}</h4>
