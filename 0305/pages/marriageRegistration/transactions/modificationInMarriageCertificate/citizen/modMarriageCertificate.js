...
const Index = (props) => {
      ...
      .then((res) => {
        ...
        if (res.status == 200) {
          ...
          if (res.data.length > 0) {
            ...
            swal("Error!", "Something problem with the searched Data !", "error");
          }
        }
      })
      .catch((err) => {
  ...
  useEffect(() => {
    if (
      (showData, router.query.pageMode == "Edit")
  ...
  const handleApply = () => {
    ...
    if (btnSaveText === "Save") {
      axios
        .post(`${urls.MR}/transaction/modOfMarCertificate/saveModOfMarCertificateRegistration`, finalBody)
        .then((res) => {
  ...
  const getById = (id) => {
    axios.get(`${urls.MR}/transaction/reIssuanceM/getapplicantById?applicationId=${id}`).then((r) => {
      ...
      axios.get(`${urls.MR}/transaction/applicant/getapplicantById?applicationId=${oldAppId}`).then((re) => {
                      ...
                      {router?.query?.pageMode == "View" ? (
                        ...
                        <>
                          ...
                          >
                            ...
                            >
                              <Typography>
                                2) Filter (Zone * ,marriage date *,groomFName ,groomLName ,brideFName
                                ,brideLName)
                              </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                  ...
                  {errors?.wardKey ? errors.wardKey.message : null}
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={
                                    errors?.aflatBuildingNoMr ? errors.aflatBuildingNoMr.message : null
                                  }
                                />
                              </div>
                              <div>
                        ...
                        >
                          ...
                          <AccordionDetails>
                            ...
                            <div className={styles.row}>
                              <div>
                                <FormControl sx={{ marginTop: 0 }} error={!!errors.marriageDate}>
                                  <Controller
                                    control={control}
                                    name="marriageDate"
                                    defaultValue={null}
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={
                                    errors?.pplaceOfMarriageMr ? errors.pplaceOfMarriageMr.message : null
                                  }
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <FormControl sx={{ marginTop: 0 }} error={!!errors.marriageDate}>
                                  ...
                                  />
                                  <FormHelperText>
                                    {errors?.marriageDateM ? errors.marriageDateM.message : null}
                                  </FormHelperText>
                                </FormControl>
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={
                                    errors?.pplaceOfMarriageMrM ? errors.pplaceOfMarriageMrM.message : null
                                  }
                                />
                              </div>
                            </div>
                          ...
                          <AccordionDetails>
                            <div style={{ marginLeft: "25px" }}>
                              <FormControlLabel
                                ...
                                control={
                                  <Checkbox checked={getValues("isApplicantGroomMod") ? true : false} />
                                }
                                label=<Typography>
                                  <b>
                            ...
                            <div className={styles.row}>
                              <div>
                                ...
                                >
                                  ...
                                  <Controller
                                    render={({ field }) => (
                                      <Select
                                        ...
                                        onChange={(value) => {
                                          field.onChange(value);
                                          setValue("gtitleMarM", value.target.value);
                                        }}
                                        label="Title  "
                                        id="demo-simple-select-standard"
                                        labelId="id='demo-simple-select-standard-label'"
                                  ...
                                  />
                                  <FormHelperText>
                                    {errors?.gtitleM ? errors.gtitleM.message : null}
                                  </FormHelperText>
                                </FormControl>
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gfNameM ? errors.gfNameM.message : null}
                                />
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gmNameM ? errors.gmNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.glNameM ? errors.glNameM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                ...
                                >
                                  ...
                                  />
                                  <FormHelperText>
                                    {errors?.gtitleMarM ? errors.gtitleMarM.message : null}
                                  </FormHelperText>
                                </FormControl>
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gfNameMrM ? errors.gfNameMrM.message : null}
                                />
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gmNameMrM ? errors.gmNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.glNameMrM ? errors.glNameMrM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gbuildingNoM ? errors.gbuildingNoM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gbuildingNameM ? errors.gbuildingNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.groadNameM ? errors.groadNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.glandmarkM ? errors.glandmarkM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gbuildingNameMr ? errors.gbuildingNameMr.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gbuildingNoMrM ? errors.gbuildingNoMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gbuildingNameM ? errors.gbuildingNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.groadNameMrM ? errors.groadNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.glandmarkMrM ? errors.glandmarkMrM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gcityNameM ? errors.gcityNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gstateM ? errors.gstateM.message : null}
                                />
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gcityNameMrM ? errors.gcityNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gstateMrM ? errors.gstateMrM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gpincodeM ? errors.gpincodeM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gmobileNoM ? errors.gmobileNoM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.gaadharNoM ? errors.gaadharNoM.message : null}
                                />
                              </div>
                            </div>
                          </AccordionDetails>
                          ...
                          <AccordionDetails>
                            <div style={{ marginLeft: "25px" }}>
                              <FormControlLabel
                                ...
                                control={<Checkbox checked={getValues("isApplicantBrideMod")} />}
                                label=<Typography>
                                  <b>
                                    {" "}
                            ...
                            <div className={styles.row}>
                              <div>
                                ...
                                >
                                  ...
                                  <Controller
                                    render={({ field }) => (
                                      <Select
                                        ...
                                        onChange={(value) => {
                                          field.onChange(value);
                                          setValue("btitleMarM", value.target.value);
                                        }}
                                        label="Title *"
                                        id="demo-simple-select-standard"
                                        labelId="id='demo-simple-select-standard-label'"
                                  ...
                                  />
                                  <FormHelperText>
                                    {errors?.btitleM ? errors.btitleM.message : null}
                                  </FormHelperText>
                                </FormControl>
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bfNameM ? errors.bfNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bmNameM ? errors.bmNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.blNameM ? errors.blNameM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                ...
                                >
                                  ...
                                  />
                                  <FormHelperText>
                                    {errors?.btitleMarM ? errors.btitleMarM.message : null}
                                  </FormHelperText>
                                </FormControl>
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bfNameMrM ? errors.bfNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bmNameMrM ? errors.bmNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.blNameMrM ? errors.blNameMrM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bbuildingNoM ? errors.bbuildingNoM.message : null}
                                />
                              </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bbuildingNoMrM ? errors.bbuildingNoMrM.message : null}
                                />
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={
                                    errors?.bbuildingNameMrM ? errors.bbuildingNameMrM.message : null
                                  }
                                />
                              </div>
                            ...
                            <div className={styles.row}>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bcityNameM ? errors.bcityNameM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bstateM ? errors.bstateM.message : null}
                                />
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bcityNameMrM ? errors.bcityNameMrM.message : null}
                                />
                              </div>
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bstateMrM ? errors.bstateMrM.message : null}
                                />
                              </div>
                            </div>
                            ...
                            <div className={styles.row}>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.bmobileNoM ? errors.bmobileNoM.message : null}
                                />
                              </div>
                              ...
                              <div>
                                <TextField
                                  ...
                                  helperText={errors?.baadharNoM ? errors.baadharNoM.message : null}
                                />
                              </div>
                            </div>
                          </AccordionDetails>
                        ...
                        >
                          ...
                          <AccordionDetails>
                                ...
                                <div className={styles.row}>
                                  <div style={{ marginTop: "20px" }}>
                                    ...
                                    <UploadButton
                                      ...
                                      fileDtl={getValues("gadharCardModDocument")}
                                  ...
                                  <div style={{ marginTop: "20px" }}>
                                    ...
                                    <UploadButton
                                      appName={appName}
                                      serviceName={serviceName}
                                      fileDtl={getValues("gaddressProofModDocument")}
                                ...
                                <div className={styles.row}>
                                  <div style={{ marginTop: "20px" }}>
                                    ...
                                    <UploadButton
                                      appName={appName}
                                      serviceName={serviceName}
                                      fileDtl={getValues("badharCardModDocument")}
                                  ...
                                  <div style={{ marginTop: "20px" }}>
                                    ...
                                    <UploadButton
                                      appName={appName}
                                      serviceName={serviceName}
                                      fileDtl={getValues("baddressProofModDocument")}
                            ...
                            <div className={styles.rowM}>
                              <div style={{ marginTop: "20px" }}>
                                <Typography>Old Marriage Certificate </Typography>
                                <UploadButton
                                  appName={appName}
                                  serviceName={serviceName}
                                  fileDtl={getValues("oldMarriageCerModDocument")}
