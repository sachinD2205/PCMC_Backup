            ...
            <Card>
              ...
              <div className={styles.summ}>
                ...
                <div>
                  ...
                  <h3>
                    : {this?.props?.data?.aflatBuildingNoMr} {this?.props?.data?.abuildingNameMr} {","}
                    {this?.props?.data?.aroadNameMr} {","} {this?.props?.data?.alandmarkMr} {","}{" "}
                    {this?.props?.data?.acityNameMr} {","} {this?.props?.data?.astateMr}{" "}
                  </h3>
                </div>
              </div>
            </Card>
