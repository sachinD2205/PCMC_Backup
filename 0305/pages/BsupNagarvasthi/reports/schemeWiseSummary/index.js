...
const getAllSubSchemes = (_pageSize = 10, _pageNo = 0) => { axios.get(`${urls.BSUPURL}/mstSubSchemes/getAll`, {
  ...
  const onSubmitFunc = (formData) => {
    ...
    if (formData.fromDate && formData.toDate) {
      let sendFromDate = moment(formData.fromDate).format("YYYY-MM-DDThh:mm:ss");
      let sendToDate = moment(formData.toDate).format("YYYY-MM-DDThh:mm:ss");
      ...
      console.log("api bode sent to api "+ apiBodyToSend)
      ///////////////////////////////////////////
      axios
        .post(`${urls.BSUPURL}/report/getSchemeWiseSummaryReport`, apiBodyToSend)
        .then((res) => {
          console.log(":log", res);
          setLoading(true);
  ...
  const columns = [
    ...
    },
    {
      ...
      },      
      {
        ...
        headerName: <FormattedLabel id="benefitedApplications" />,
        minWidth: 400,
        headerAlign: "center",
        align: "center",
      },
      {
        ...
        headerName: <FormattedLabel id="benefitRejectedApplications" />,
        minWidth: 400,
        headerAlign: "center",
        align: "center",
      }
  ...
  function generateCSVFile(data) {
    ...
    downloadLink.download = data ? `Scheme Wise Summary.csv` : "data.csv";
    downloadLink.click();
    URL.revokeObjectURL(url);
  }
// {console.log("mainNames ",mainNames)}
  return (
