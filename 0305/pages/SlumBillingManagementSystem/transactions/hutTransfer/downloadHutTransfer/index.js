...
const Index = () => {
  ...
  useEffect(() => {
    ...
    setValue("transferDate", res !== null ? res?.transferDate : "-");
  ...
  const approvalValidation = () => {
    ...
    return clerk === "CLERK" &&
      (dataSource?.status == 14 || dataSource?.status == 3 || dataSource?.status == 4)
      ? false
  ...
  const validateIssueBtn = () => {
    ...
    return clerk === "CLERK" && dataSource?.status == 4 ? false : true;
  };
  ...
  const handleOnSubmit = (formData) => {
    ...
    if (btnSaveText === "Save") {
      ...
      const tempData = axios
        ...
        .then((res) => {
          if (res.status == 201) {
            sweetAlert("Issued!", `Hut Transfer ${dataSource.applicationNo} successfully !`, "success");
            router.push("/SlumBillingManagementSystem/transactions/hutTransfer/hutTransferDetails");
          }
        });
          ...
          <Grid
            ...
            >
              <TextField
                ...
                helperText={error?.officeSuperintendantApprovalRemark ? error.officeSuperintendantApprovalRemark.message : null}
              />
            </Grid>
          ...
          <Grid
            ...
            >
              <TextField
                ...
                helperText={error?.administrativeOfficerApprovalRemark ? error.administrativeOfficerApprovalRemark.message : null}
              />
            </Grid>
          ...
          <Grid
            ...
            >
              <TextField
                ...
                helperText={error?.assistantCommissionerApprovalRemark ? error.assistantCommissionerApprovalRemark.message : null}
              />
            </Grid>
