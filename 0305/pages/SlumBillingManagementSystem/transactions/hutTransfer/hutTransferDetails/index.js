      ...
      // status
      {
        ...
        renderCell: (params) => {
          return (
            ...
            ) : (params.row.status.includes("Waiting for Site Visit") || params.row.status.includes("Payment Done") || params.row.status.includes("Site Visit Scheduled")|| params.row.status.includes("Site Visit Done") ) &&
              authority &&
