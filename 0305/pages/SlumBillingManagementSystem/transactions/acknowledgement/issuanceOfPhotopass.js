  ...
  useEffect(() => {
    ...
    if (router.query.id) {
      ...
      if (logedInUser === "citizenUser") {
        axios.get(`${urls.SLUMURL}/trnIssuePhotopass/search/applicationNumber?applicationNumber=${router.query.id}`, {
            headers: {
                UserId: user.id
            }
        },).then((r) => {
            ...
            <Card>
              ...
              <div className={styles.summ}>
                ...
                <div>
                  ...
                  <h3>
                    : {`${this?.props?.slumData?.slumName}, ${this?.props?.areaData?.areaName}, ${this?.props?.zoneData?.zoneName}, ${this?.props?.villageData?.villageName}, ${this?.props?.data?.pincode}`}{' '}
