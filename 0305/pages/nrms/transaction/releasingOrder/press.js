...
const Index = () => {
  ...
  useEffect(() => {
    axios.get(`${urls.NRMS}/trnPressNoteRequestApproval/getById?id=${router?.query?.id}`).then((r) => {
      let result = r?.data;
            ...
            <div className={styles.date4} style={{ marginTop: "2vh" }}>
              <div className={styles.date3}>
                <h4 style={{ marginRight: "4vh" }}>
                  <b>प्रेस प्रकाशन ऑर्डर क्रमांक: {this?.props?.selectedObject?.pressNoteRequestNo}</b>
                </h4>{" "}
              </div>
            </div>
                ...
                <div className={styles.date6}>
                  <h4 style={{ marginLeft: "4vh" }}>
                    <b>
                      ...
                      दिनांक :{" "}
                      {moment(this?.props?.selectedObject?.pressNoteReleaseDate, "YYYY-MM-DD").format(
                        "DD-MM-YYYY",
                      )}{" "}
                    </b>
                    <br />
