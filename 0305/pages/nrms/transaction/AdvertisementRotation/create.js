              ...
              <Grid>
                <Grid container sx={{ padding: "10px" }}>
                  ...
                  {((!authority?.includes("ENTRY") &&
                    !router?.query?.pageMode) || (!authority?.includes("ENTRY") &&
                    ...
                    <>
                      ...
                      >
                        ...
                        <TextField
                          ...
                          InputLabelProps={{
                            //true
                            shrink: (watch("workCost") ? true : false) || (router.query.workCost ? true : false),
                          }}
                        />
                      </Grid>
                    </>
                            ...
                            render={({ field }) => (
                              <Select
                                ...
                                onChange={(value) => {
                                  ...
                                  getStandardFormatSize(selectedGroupId, selectedSubGroupId, value.target.value);
                                }}
                              >
                                ...
                                {newsPaperOriginal &&
                                  newsPaperOriginal.map((newsPaper, index) => (
                                    <MenuItem key={newsPaper.id} value={newsPaper.newspaperName}>
                                      <Checkbox checked={selectedNewsPapers.indexOf(newsPaper.newspaperName) > -1} />
                ...
                >
                  ...
                  >
                    ...
                    {/* <TextField
                      ...
                      InputLabelProps={{
                        shrink:
                          (watch("advirtiseMentInPdf") ? true : false) ||
                          (router.query.advirtiseMentInPdf ? true : false),
                      }}
                      label={<FormattedLabel id="advirtiseMentInPdf" required />}
                      variant="standard"
                      {...register("advirtiseMentInPdf")}
                      error={!!errors.advirtiseMentInPdf}
                      helperText={errors?.advirtiseMentInPdf ? errors.advirtiseMentInPdf.message : null}
                    /> */}
                  </Grid>
                      ...
                      <Grid container ml={5} border px={5}>
                        ...
                        <Grid item>
                          <Button type="submit"
                            ...
                            variant="contained" color="success" endIcon={<SaveIcon />}>
                        ...
                        <Grid item>
                          <Button
                            ...
                            variant="contained"
                            color="error"
                            onClick={() => { exitButton(), setBtnSaveText("CREATE") }}
                          >
