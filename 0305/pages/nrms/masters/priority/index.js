...
import schema from "../../../../containers/schema/newsRotationManagementSystem/masters/priority";
...
const Index = () => {
    ...
    const getData = (_pageSize = 10, _pageNo = 0, _sortBy = 'id', _sortDir = 'Desc') => {
        ...
        axios
            ...
            .then((r) => {
                console.log(";r", r);
                let _res = r.data.priority.map((r, i) => {
                    return {
                        ...r,
                        srNo: i + 1,
                    };
    ...
    const onSubmitForm = (fromData) => {
        ...
        // if (btnSaveText === "Save") {
        axios
            .post(`${urls.NRMS}/priority/save`, _body)
            .then((res) => {
                if (res.status == 201) {
                    fromData.id
                        ? sweetAlert(
            ...
            swal({
                ...
                if (willDelete === true) {
                    axios
                        ...
                        .post(`${urls.NRMS}/priority/save`, body)
                        .then((res) => {
    ...
    const columns = [
        ...
        {
            field: "priorityMr",
            headerName: <FormattedLabel id="priorityMr" />,
            flex: 1,
        },
        {
            field: "actions",
    ...
    return (
        ...
        >
            ...
            >
                <h2>
                    <FormattedLabel id="priorityHeading" />
                </h2>
            </Box>
                                    ...
                                    >
                                        ...
                                        >
                                            <TextField
                                                ...
                                                sx={{ width: 300 }}
                                                id="standard-textarea"
                                                label={<FormattedLabel id="priorityMr" required />}
                                                multiline
                                                variant="standard"
                                                {...register("priorityMr")}
                                                error={!!errors.priorityMr}
                                                helperText={
                                                    errors?.priorityMr ? errors.priorityMr.message : null
                                                }
                                                InputLabelProps={{ shrink: true }}
