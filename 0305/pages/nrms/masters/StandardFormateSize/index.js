...
const Index = () => {
  ...
  const getNewsPaperLevels = (groupId, value) => {
    axios
      .get(`${urls.NRMS}/newsPaperLevel/getByRotationSubGroup?groupId=${groupId}&subGroupId=${value}`)
      .then((res) => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    axios.post(`${urls.NRMS}/newsStandardFormatSizeMst/save`, _body).then((res) => {
      if (res.status == 201) {
        fromData.id
          ...
          <Box>
            <IconButton
              ...
              onClick={() => {
                ...
                getNewsPaperLevels(params.row.newsPaperGroupKey, params.row.newsPaperSubGroupKey);

                getNewsPaperOriginal(params.row.newsPaperGroupKey, params.row.newsPaperSubGroupKey, params.row.newsPaperLevel);
                ...
                <Grid container sx={{ padding: "10px" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <FormHelperText>
                        {errors?.newsPaperGroupKey ? errors.newsPaperGroupKey.message : null}
                      </FormHelperText>
                    </FormControl>
                  </Grid>
                  <Grid
                  ...
                  >
                    ...
                    >
                        ...
                        render={({ field }) => (
                          <Select
                            ...
                            onChange={(value) => {
                              ...
                              getNewsPaperLevels(selectedGroupId, value.target.value);
                            }}
                          >
                            {rotationSubGroups &&
                      ...
                      />
                      <FormHelperText>
                        {errors?.newsPaperSubGroupKey ? errors.newsPaperSubGroupKey.message : null}
                      </FormHelperText>
                    </FormControl>
                  </Grid>
                  <Grid
                      ...
                      <Controller
                        render={({ field }) => (
                          <Select
                            ...
                            onChange={(value) => {
                              field.onChange(value);
                              getNewsPaperOriginal(selectedGroupId, selectedSubGroupId, value.target.value);
                            }}
                          >
                            {newsPaperLevels &&
