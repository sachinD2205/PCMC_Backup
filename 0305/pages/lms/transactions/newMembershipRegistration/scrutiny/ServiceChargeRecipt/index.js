...
const Index = () => {
  ...
  return (
    <>
      <div>
        <ComponentToPrint dataa={dataa} ref={componentRef} libraryName={libraryName} serviceCharge={serviceCharge} />
      </div>
      <br />
              ...
              <p>
                <h5 style={{ marginLeft: '40px', marginRight: '40px' }}>
                  <b>
                    ...
                    <table id="table-to-xls" className={styles.report_table}>
                      <thead>
                        ...
                        {this.props.serviceCharge?.map((service, index) => (
                          ...
                          < tr >
                            ...
                            {service.chargeType == 'C' ? (
                              <td colSpan={4}>{service.amount} * {this?.props?.dataa?.membershipMonths}</td>
                            ) : (
                              <td colSpan={4}>{service.amount}</td>
                            )
                            }
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={4}>
                            <b>
                              एकूण रक्कम : {this?.props?.dataa?.paymentDao?.amount}/-
                            </b>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <br />
                    नवीन सदस्य नोंदणी झालेल्याच्या दिनांक:{' '}
                    <b>
                      {' '}
                      {' ' +
                        moment(
                    ...
                    ग्रंथालय अभ्यास केंद्र नोंदणी आकारण्यात येणारे नवीन सदस्य नोंदणी करणे शुल्क
                  </b>
                  <b>एकूण फी</b> &nbsp;
