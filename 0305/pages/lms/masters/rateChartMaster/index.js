        ...
        axios
            ...
            .then((r) => {
                ...
                let _res = result.map((r, i) => {
                    console.log('44')
                    console.log("kay", serviceKeys?.find((item) => item.id == r.serviceId)?.serviceName, r.serviceId);
                    ...
                    <Box>
                        <IconButton
                            ...
                            onClick={() => {
                                ...
                                setValue('serviceId', serviceKeys?.find((item) => item.id == params.row.serviceId)?.serviceName)
            ...
            >
                ...
                <div>
                    <Typography sx={{ fontWeight: 800, color: 'red', marginLeft: "7vh", marginTop: "2vh", marginBottom: "2vh" }}>
                        ...
                        *Note - Library Type must be 1) L(for library)  2) C(for Competitive center) and  Charge Type must be  1) C (for Charge) 2) D (for Deposit)
                    </Typography>
                </div>
                                    ...
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                ...
                                                errors?.chargePrefixEng ? 'chargePrefixEng is Required !!!' : null
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                // errors?.studentName ? errors.studentName.message : null
                                                errors?.chargePrefixMr ? 'chargePrefixMr is Required !!!' : null
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                // errors?.studentName ? errors.studentName.message : null
                                                errors?.chargeNameEng ? 'chargeNameEng is Required !!!' : null
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                // errors?.studentName ? errors.studentName.message : null
                                                errors?.chargeNameMr ? 'chargeNameMr is Required !!!' : null
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                // errors?.studentName ? errors.studentName.message : null
                                                errors?.libraryType ? 'libraryType is Required !!!' : null
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                // errors?.studentName ? errors.studentName.message : null
                                                errors?.amount ? 'amount is Required !!!' : null
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                                        <TextField
                                            ...
                                            helperText={
                                                // errors?.studentName ? errors.studentName.message : null
                                                errors?.chargeType ? 'chargeType is Required !!!' : null
                                            }
                                        />
                                    </Grid>
