...
const Index = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/user/changeUserPassword`, finalBodyForApi).then((res) => {
      ...
      if (res.status == 200 || res.status == 201) {
        ...
        formData.id
          ? sweetAlert("Updated!", "Password Updated successfully !", "success")
          : sweetAlert("Updated!", "Password Updated successfully !", "success");
...
cc
          ...
          <form onSubmit={handleSubmit(onSubmitForm)}>
            <Grid container columns={{ xs: 12, sm: 12, md: 12 }} className={styles.feildres}>
              <Grid item xs={12} className={styles.feildres} sx={{ paddingBottom: 2 }}>
                <TextField
                  // inputProps={{
                  //   shrink: true,
                  // }}
