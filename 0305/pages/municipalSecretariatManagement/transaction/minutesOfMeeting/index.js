    ...
    axios
      ...
      .then((res) => {
        if (res.status === 200 || res.status === 201) {
          sweetAlert("Success!", "Proceeding done successfully!", "success").then((ok) => {
            if (ok) {
              router.push(`/municipalSecretariatManagement/transaction/calender`);
            }
          });
        }
      })
      ...
      <Paper className={styles.main} style={{ position: "relative" }}>
        ...
        <form className={styles.main} onSubmit={handleSubmit(submit)}>
          ...
          <div style={{ display: "flex", justifyContent: "space-evenly" }}>
            {/* ////////////////////////////////////////////////////////////////// */}
            <FormControl style={{ minWidth: "230px", marginTop: "20px", marginBottom: "20px" }}>
              <InputLabel id="demo-simple-select-standard-label">
            ...
            <Button
              ...
              onClick={() => {
                router.push({
                  ...
                  query: { agendaNo: router?.query?.agendaNo, committeeName: watch("committeeId") },
                });
              }}
            >
