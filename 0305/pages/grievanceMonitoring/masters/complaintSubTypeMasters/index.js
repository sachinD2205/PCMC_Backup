...
const Form = () => {
  ...
  const getComplaintSubType = (_pageSize = 10, _pageNo = 0) => {
    axios
      .get(
        `${urls.GM}/complaintSubTypeMaster/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
  ...
  const columns = [
    ...
    // { field: 'complaintSubTypeMr', 
    // headerName: 'तक्रार उपप्रकार', width: 300 },
    // { field: "description", 
    // headerName: <FormattedLabel id="description" />, 
    // width: 300 },
    // {field: "descriptionMr", headerName: " <FormattedLabel id="description" />,
    //   flex: 1,
    // },
    {
      field: 'actions',
                      ...
                      <div>
                        <div>
                          <TextField
                            ...
                            sx={{ width: 250 }}
                            id="standard-basic"
                            label={<FormattedLabel id="descriptionMr" />}
                            // label={<FormattedLabel id="status" />}
                            variant="standard"
                            {...register('descriptionMr')}
                            error={!!errors.descriptionMr}
                            helperText={
                              errors?.descriptionMr
                                ? errors.descriptionMr.message
                                : null
                            }
                          />
                        </div>
