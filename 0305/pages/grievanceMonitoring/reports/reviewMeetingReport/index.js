...
const Index = () => {
  ...
  const onSubmitFunc = () => {
    if (watch("eventId") && watch("fromDate") && watch("toDate")) {
      ...
      ///////////////////////////////////////////
      axios
        .post(`${urls.GM}/report/getReviewMeetingReport`, apiBodyToSend)
        .then((res) => {
          console.log(":log", res);
          setLoading(true);
          if (res?.status === 200 || res?.status === 201) {
  ...
  const columns = [
    ...
    {
      field: "openCount",
      headerName: <FormattedLabel id="openCount" />,
      nWidth: 100,
      headerAlign: "center",
      align: "center",
    },
    {
      field: "closeCount",
      headerName: <FormattedLabel id="closeCount" />,
      nWidth: 100,
      headerAlign: "center",
      align: "center",
    },
        ...
        >
          ...
          >
            <strong className={styles.fancy_link1}>
              <FormattedLabel id="ReviewMeetingReport" />
            </strong>
          </Box>
        </Box>
        {/* >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> */}
