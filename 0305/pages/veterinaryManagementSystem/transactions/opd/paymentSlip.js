...
const Index = () => {
  ...
  useEffect(() => {
    if (router.query.id && bankName) {
      axios
        .get(`${URLs.VMS}/trnAnimalTreatment/getById?id=${router.query.id}`)
        .then((res) => {
          ...
          <div className={styles.officeCopy}>
            ...
            <table className={styles.tableWrap}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>{language === "en" ? "Opd Registration" : "बाह्यरुग्ण विभाग नोंदणी"}</span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
                <td className={styles.tableData1}>
                ...
                <td className={styles.tableData3} colSpan={4}>
                  <span>
                    {language === "en" ? "Regarding Opd Registration Fee" : "बाह्यरुग्ण विभाग नोंदणी शुल्क"}
                  </span>
                </td>
              </tr>
              <tr className={styles.tableRow}>
              ...
              <tr className={styles.tableRow}>
                ...
                <td className={styles.tableData2}>
                  <span>{language === "en" ? "Opd bill payment" : "ओपीडी बिल पेमेंट"}</span>
                </td>
                <td className={styles.tableData2}>
                  {/* <span>{language === "en" ? "₹ 75.00" : "₹ ७५.००"}</span> */}
                  <span>₹ {applicationDetails?.paymentDao?.amount}</span>
