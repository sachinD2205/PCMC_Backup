...
const Index = () => {
  ...
  const viewRecord5 = (record) => {
    ...
    router.push({
      pathname: "/FireBrigadeSystem/transactions/finalAhawal/loiGenerationComponent",
      query: {
        pageMode: "Edit",
        ...record,
      },
  ...
  const viewRecord6 = (record) => {
    console.log("record", JSON.stringify(record));
    router.push({
      pathname: "/FireBrigadeSystem/transactions/finalAhawal/loiCollectionComponent",
      query: {
        pageMode: "Edit",
        ...record,
      },
  ...
  // get Vardi Types
  const getVardiTypes = () => {
    axios.get(`${urls.BaseURL}/vardiTypeMaster/getVardiTypeMasterData`).then((r) => {
      let vardi = {};
        ...
        let _res = res?.data?.emergencyService
          ...
          .map((r, i) => {
            ...
            return {
              ...
              // application date
              departureTime: moment(r?.firstAhawal?.departureTime, "hh:mm (a/p)m").format("hh:mm (a/p)m"),
              ...
              isExternalPersonAddedInDuty: r?.firstAhawal?.isExternalPersonAddedInDuty,
              ...
              firedThingsDuringAccuseMr: r?.firstAhawal?.firedThingsDuringAccuseMr,
              insurancePolicyApplicable: r?.firstAhawal?.insurancePolicyApplicable,
              ...
              isFireEquipmentsAvailable: r?.firstAhawal?.isFireEquipmentsAvailable,
              ...
              fireLossInformationDetails: r?.finalAhawal?.fireLossInformationDetails,
              fireLossInformationDetailsMr: r?.finalAhawal?.fireLossInformationDetailsMr,
              ...
              lossOfBuildingMaterialMr: r?.finalAhawal?.lossOfBuildingMaterialMr,
              ...
              firedThingsDuringAccuseMr: r?.finalAhawal?.firedThingsDuringAccuseMr,
              lossInAmount: r?.finalAhawal?.lossInAmount,
              insurancePolicyDetails: r?.finalAhawal?.insurancePolicyDetails,
              insurancePolicyDetailsMr: r?.finalAhawal?.insurancePolicyDetailsMr,
              ...
              employeeDetailsDuringFireWorks: r?.finalAhawal?.employeeDetailsDuringFireWorks,
              ...
              firstVehicleReachAtLocationTime: r?.finalAhawal?.firstVehicleReachAtLocationTime,
              distanceFromMainFireStation: r?.finalAhawal?.distanceFromMainFireStation,
              distanceFromSubFireStation: r?.finalAhawal?.distanceFromSubFireStation,
              ...
              firstVehicleLeftAtLocationDateAndTime: r?.finalAhawal?.firstVehicleLeftAtLocationDateAndTime,
              // bill payement Details

              subMenu: r?.finalAhawal?.subMenu,

              chequeDate: moment(r?.finalAhawal?.chequeDate, "YYYY-MM-DD").format("YYYY-MM-DD"),
      ...
      renderCell: (params) => {
        ...
        return (
          <Box>
            ...
            {params.row.applicationStatus === "APPLICATION_SENT_TO_MAIN_FIRE_OFFICER" &&
              params.row.applicationStatus === "LOI_GENERATED" && (
                <IconButton
                  // disabled={params.row.activeFlag === "Y" ? false : true}
                  onClick={() => {
            ...
            {params.row.applicationStatus === "LOI_GENERATED" ? (
              <IconButton>
                <Button size="small" variant="contained" sx={{ width: "150px" }}>
                  LOI Generated
                </Button>
              </IconButton>
            ) : (
            ...
            {params.row.isPayment === "Y" ? (
              ...
              <IconButton
                ...
                onClick={() => {
                  const record = params.row;
                  router.push({
                    pathname: "/FireBrigadeSystem/transactions/finalAhawal/paymentDetails",
                    query: {
                      pageMode: "Edit",
                      isPayment: "N",
                      ...record,
              ...
              >
                <Button size="small" sx={{ color: "blue", textTransform: "capitalize" }}>
                  Pending
                </Button>
              </IconButton>
            )}
    ...
    <Box>
      <Box style={{ display: "flex" }}>
        <Box className={styles.tableHead}>
          <Box className={styles.h1Tag}>{<FormattedLabel id="finalVardi" />}</Box>
        </Box>
      </Box>
