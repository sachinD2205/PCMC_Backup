...
const LoiGenerationComponent = () => {
  ...
  const onSubmitForm = (r) => {
    ...
    const finalBody = {
      ...
      loii: {
        ...
        billVillage: r.billVillage,
        billVillageMr: r.billVillageMr,
  ...
  // Get Charge Name
  const getChargeName = () => {
    axios.get(`${urls.FbsURL}/master/chargeType/getAll`).then((res) => {
                  ...
                  >
                    ...
                    <Grid item xs={4} className={styles.feildres}>
                      <TextField
                        ...
                        variant="standard"
                        {...register("billPayerMiddleNameMr")}
                        error={!!errors.billPayerMiddleNameMr}
                        helperText={
                          errors?.billPayerMiddleNameMr
                            ? errors.billPayerMiddleNameMr.message
                            : null
                        }
                      />
                    </Grid>
                  ...
                  >
                    ...
                    <Grid item xs={4} className={styles.feildres}>
                      <TextField
                        ...
                        variant="standard"
                        {...register("billVillage")}
                        error={!!errors.billVillage}
                        helperText={
                          errors?.billVillage
                            ? errors.billVillage.message
                            : null
                        }
                      />
                    </Grid>
                    ...
                    <Grid item xs={4} className={styles.feildres}>
                      <TextField
                        ...
                        variant="standard"
                        {...register("billVillageMr")}
                        error={!!errors.billVillageMr}
                        helperText={
                          errors?.billVillageMr
                            ? errors.billVillageMr.message
                            : null
                        }
                      />
                    </Grid>
