...
const IndustryCertificateReport = () => {
  ...
  return (
    <>
      ...
      <Box sx={{ margin: "10px", marginRight: "30%", marginLeft: "50%" }}>
        <Button
          variant='contained'
          color='primary'
          style={{ float: "right" }}
...
{/* <Table sx={{  width: '100%', height: "40%" }} size="small" aria-label="a dense table" border="1" stickyHeader> */}
                  ...
                  <TableRow>
                    ...
                    <TableCell colspan='6'>
                      {this?.props?.data?.area}, {this?.props?.data?.city}
                    </TableCell>
                  </TableRow>
                  {/* <TableRow></TableRow> */}
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <b>{this?.props?.data?.totalAmount}</b>
                    </TableCell>
                    <TableCell></TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell colspan='6'>
                      <b> {this?.props?.data?.amountInWord} </b>
                    </TableCell>
                  </TableRow>
