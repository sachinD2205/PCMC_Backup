...
const WorkFlow = () => {
  ...
  const getIssuanceOfHawkerLicense = () => {
    axios
      ...
      .then((resp) => {
        ...
        //   // srNo: i + 1,
        // };
        setDataSource(resp.data.emergencyService);
  ...
  const getCancellLicDetails = (licenseNo) => {
    axios
      .get(`${urls.SSLM}/License/getDataByLiscenceNo?licenseNo=${licenseNo}`)
      .then((res) => {
        console.log(res);
        setDataSource(
          res.data.map((r, i) => ({
  ...
  const viewRecord4 = (record) => {
    ...
    router.push({
      // pathname: `/skySignLicense/transactions/components/FormPreview`,
      // pathname: `/skySignLicense/transactions/components/siteVisit`,
      pathname: `/FireBrigadeSystem/transactions/firstAhawal/components/loiGenerationRecipt`,
  ...
  const viewRecord5 = (record) => {
    ...
    router.push({
      // pathname: `/skySignLicense/transactions/components/FormPreview`,
      // pathname: `/skySignLicense/transactions/components/siteVisit`,
      pathname: `/FireBrigadeSystem/transactions/firstAhawal/components/LoiGenerationComponent`,
  ...
  const viewRecord6 = (record) => {
    ...
    router.push({
      // pathname: `/skySignLicense/transactions/components/FormPreview`,
      // pathname: `/skySignLicense/transactions/components/siteVisit`,
      pathname: `/FireBrigadeSystem/transactions/firstAhawal/components/LoiCollectionComponent`,
  ...
  const viewRecord7 = (record) => {
    ...
    router.push({
      // pathname: `/skySignLicense/transactions/components/FormPreview`,
      pathname: `/skySignLicense/FileUpload/UploadButton1`,
      // pathname: `/skySignLicense/transactions/reIssuanceOfIndustry`,
            ...
            {/* <div className={styles.btn1}>
              <Button
                ...
                onClick={() => cancellButton(
                  router.push("/skySignLicense/transactions/cancellationofIndustry")
                )}
              >
                Work Flow
              </Button>
