...
import ApplicantDetails from "../../../../components/fireBrigadeSystem/finalBuildingNoc/ApplicantDetails";
import BuildingUse from "../../../../components/fireBrigadeSystem/finalBuildingNoc/BuildingUse";
import FormsDetails from "../../../../components/fireBrigadeSystem/finalBuildingNoc/FormsDetails";
import OtherDetails from "../../../../components/fireBrigadeSystem/finalBuildingNoc/OtherDetails";
        ...
        <Box sx={{ flexGrow: 1 }} style={{ backgroundColor: "#BFC9CA  " }}>
          <AppBar position="static" sx={{ backgroundColor: "#FBFCFC " }}>
            <Toolbar variant="dense">
              ...
              >
                <ArrowBackIcon
                  onClick={() =>
                    router.push({
                      pathname:
                        "/FireBrigadeSystem/transactions/finalBuildingNoc",
                    })
                  }
                />
              </IconButton>
              ...
              >
                {<FormattedLabel id="finalBuildingFireNOC" />}
              </Typography>
            </Toolbar>
          </AppBar>
        </Box>
