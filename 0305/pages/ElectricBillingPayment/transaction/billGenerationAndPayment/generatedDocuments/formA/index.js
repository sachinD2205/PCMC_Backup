              ...
              <div className={styles.formA_table} style={{ marginBottom: "2vh" }}>
                <table style={{ width: "100%" }}>
                  <tr>
                    ...
                    <td>अंदाजपत्रकीय तरतुद सन :</td>
                  </tr>
                  <tr>
                    <td> </td>
                    <td> </td>
                    <td>अंदाजपत्रकीय तरतुद रु.</td>
                  </tr>
                  <tr>
                    <td>देयक क्र.:</td>
                  ...
                  <tr>
                    <td>दिनांक:  {` ${day}/${month}/${year}`}</td>
                    <td>रक्कम रु.: {this?.props?.billData?.toBePaidAmount}</td>
                    <td>उपलब्ध शिल्लक:</td>
                  </tr>
                </table>
              </div>
              ...
              <div className={styles.date4}>
                <div className={styles.date2}>
                  <p style={{ marginLeft: "80px", marginRight: "40px" }}>
                    {"  "}
                    प्रमाणीत करण्यात येते की हा बिलात दाखविलेले दर व परिमाणे ही अचुक आहेत आणि सामुग्री, वस्तु
                    चांगल्या स्थितीत मिळाल्या असून त्या पृष्ठावरील भागाच्या समुचित नोंदवहीत पृष्ठ क्रमांक{" "}
                    {"  "} अ.क्र. {'  '} वर नोंदल्या आहेत.
                  </p>{" "}
                </div>
              </div>
              <div className={styles.date4}>
                <div className={styles.date2}>
                  <p style={{ marginLeft: "80px", marginRight: "40px" }}>
                    सदरची रक्कम यांपूर्वी अदा केलेली नाही प्रदान मंजूर रक्कम रुपये{" "}
                    <b>{this?.props?.billData?.toBePaidAmount}</b> अक्षरी रुपये{" "}
                    <b>{toWords.convert(this?.props?.billData?.toBePaidAmount)}</b>
                  </p>{" "}
                </div>
              </div>
