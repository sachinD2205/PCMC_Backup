            ...
            <div className={styles.two}>
                  ...
                  <div className={styles.date3}>
                    ...
                    {/* <h4 style={{ marginLeft: "10px" }}>
                      <b>
                        {" "}
                        {" " +
                          moment(this?.props?.billData?.currReadingDate, "YYYY-MM-DD").format("DD-MM-YYYY")}
                      </b>{" "}
                    </h4> */}
                  </div>
                </div>
              ...
              <div className={styles.date7}>
                <div className={styles.date4} style={{ marginTop: "2vh", marginBottom: "2vh" }}>
                  <div className={styles.date3}>
                    <h4 style={{ marginLeft: "80px" }}>
                      प्रदानार्थ मंजूर र.रु. <b>{this?.props?.billData?.toBePaidAmount}</b> अक्षरी{" "}
                      <b>{toWords.convert(this?.props?.billData?.toBePaidAmount)}</b>रुपये
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.date7}>
                <div className={styles.date4} style={{ marginTop: "2vh" }}>
                  <div className={styles.date3}>
                    <h4 style={{ marginLeft: "80px" }}>
                      रक्कम रुपये <b>{this?.props?.billData?.toBePaidAmount} </b>अक्षरी{" "}
                      <b>{toWords.convert(this?.props?.billData?.toBePaidAmount)}</b> रुपये अदा करणेस हरकत
                      वाटत नाही.
                    </h4>
                  </div>
                </div>
              ...
              <div className={styles.date7}>
                <div className={styles.date4} style={{ marginTop: "2vh" }}>
                  <div className={styles.date3}>
                    <h4 style={{ marginLeft: "80px" }}>
                      रक्कम रुपये <b>{this?.props?.billData?.toBePaidAmount}</b> फक्त अदा करावे.
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  <p style={{ marginLeft: "80px", marginRight: "40px" }}>
                    {"  "}
                    महानगरपालिकेकडून रक्कम रुपये <b>{this?.props?.billData?.toBePaidAmount}</b> अक्षरी{" "}
                    <b>{toWords.convert(this?.props?.billData?.toBePaidAmount)}</b> रुपये फक्त धनादेश क्रमांक{" "}
                    <b>---</b> दिनांक{" "} ---
                    {/* <b>
                      {" "}
                      {" " +
              ...
              <div className={styles.date7}>
                <div className={styles.date4} style={{ marginTop: "3vh" }}>
                  <div className={styles.date3}>
                    <h4 style={{ marginLeft: "80px" }}>
                      <b>धनादेश घेणा-याची सही</b>
                    </h4>
                  </div>
                </div>
              </div>
