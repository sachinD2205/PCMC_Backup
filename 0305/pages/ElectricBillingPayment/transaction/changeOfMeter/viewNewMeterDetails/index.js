...
const Index = () => {
  ...
  useEffect(()=>{
    ...
    setValue('oldMeterStatusKey', _res?.oldMeterStatusKey ? _res?.oldMeterStatusKey : "-")
  ...
  const getMeterStatus = () => {
    axios.get(`${urls.EBPSURL}/mstMeterStatus/getAll`).then((res) => {
      ...
      let result = temp && temp.find((each)=>each.id == changeMeterData?.newMeterStatusKey)
      console.log("getMeterStatus", result);
      setValue('newMeterStatusKey',result?.meterStatus)
    });
  };
          ...
          <Grid container sx={{ padding: "10px" }}>
            ...
            >
              <TextField
                ...
                variant="standard"
                value={moment(watch('oldMeterClosingDate')).format("YYYY-MM-DD")}
            ...
            >
              <TextField
                ...
                variant="standard"
                value={moment(watch('newMeterInstallationDate')).format("YYYY-MM-DD")}
