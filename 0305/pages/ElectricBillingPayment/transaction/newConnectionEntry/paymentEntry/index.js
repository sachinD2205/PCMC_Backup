...
import schema from "../../../../../containers/schema/ElelctricBillingPaymentSchema/paymentEntrySchema";
...
const Index = () => {
  ...
  const getConsumerDetails = () => {
    ...
    setAmount(dataSource?.quotationAmount ? dataSource?.quotationAmount : "-");
  };
  ...
  const onSubmitForm = (data) => {
    ...
    let _formData ={
        ...
        amountPaid: quotationAmount,
    }

    console.log("form data --->", data);
    dispatch(setNewEntryConnection(_formData))
    ...
    if (btnSaveText === "Save") {
        console.log("Save New COnnection ............ 1")
        ...
        <form onSubmit={handleSubmit(onSubmitForm)}>
          ...
          <Grid container sx={{ padding: "10px" }}>
            ...
            <Grid container mt={5} border px={5}>
              ...
              >
                <Button onClick={cancellButton} variant="contained">
                  Clear
