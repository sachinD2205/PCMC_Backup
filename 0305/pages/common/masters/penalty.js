...
const Penalty = () => {
  ...
  // Get Table - Data
  const getPenaltyDetails = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
    axios
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.BaseURL}/penaltyMaster/save`, finalBodyForApi).then((res) => {
      if (res.status == 200) {
        formData.id
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/penaltyMaster/save`, body).then((res) => {
                      ...
                      <div className={styles.row}>
                        <div className={styles.fieldss}>
                          <TextField
                            ...
                            helperText={errors?.penaltyPrefix ? errors.penaltyPrefix.message : null}
                          />
                        </div>
                        <div className={styles.fieldss}>
                        ...
                        <div className={styles.fieldss}>
                          <TextField
                            ...
                            helperText={errors?.penaltyType ? errors.penaltyType.message : null}
                          />
                        </div>
                        <div className={styles.fieldss}>
                          <TextField
