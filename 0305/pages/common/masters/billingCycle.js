...
const BillingCycle = () => {
  ...
  // Get Table - Data
  const getBillingCycleDetails = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
    console.log("getLIC ----");
    axios
  ...
  const getDataById = (value) => {
    ...
    setID(value);
    axios.get(`${urls.CFCURL}/master/MstBillingCycle/getbillingCycleDaoDataById/?id=${value}`).then((res) => {
      reset(res.data);
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/billingCycleNameMaster/save`, body).then((res) => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    axios.post(`${urls.CFCURL}/master/billingCycleNameMaster/save`, finalBodyForApi).then((res) => {
      if (res.status == 200) {
        id
  ...
  const columns = [
    ...
    { field: "fromDate", flex: 2, headerName: "From Date" },
    {
      field: "toDate",
      headerName: "To Date",
      flex: 2,
                  ...
                  <Grid container columns={{ xs: 4, sm: 8, md: 12 }} className={styles.feildres}>
                    <Grid item xs={4} className={styles.feildres}>
                      <TextField
                        ...
                        helperText={errors?.billingCycle ? errors.billingCycle.message : null}
                      />
                    </Grid>
                    <Grid item xs={4} className={styles.feildres}>
                      <TextField
                        ...
                        helperText={errors?.billingCycleMr ? errors.billingCycleMr.message : null}
                      />
                    </Grid>
                    <Grid item xs={4} className={styles.feildres}>
                      <TextField
                        ...
                        helperText={errors?.billingCyclePrefix ? errors.billingCyclePrefix.message : null}
                      />
                    </Grid>
                    <Grid item xs={4} className={styles.feildres}>
