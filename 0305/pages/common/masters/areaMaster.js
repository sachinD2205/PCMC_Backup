...
const Index = () => {
  ...
  const getAreaMaster = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/area/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/area/save`, finalBodyForApi).then((res) => {
              ...
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.areaNameMr ? errors.areaNameMr.message : null}
                  />
                </Grid>
