...
import styles from "../../../styles/[designationMaster].module.css";
...
const Index = () => {
      ...
      .then((res, i) => {
        ...
        let _res = result.map((res, i) => {
          ...
          return {
            ...
            designationCol: designationList.find((f) => f.id == res.designation)?.designation,
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/departmentAndDesignationMapping/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/departmentAndDesignationMapping/save`, finalBodyForApi).then((res) => {
                ...
                >
                  ...
                  >
                    ...
                    <Controller
                            ...
                            designationList.map((desg, index) => {
                              return (
                                <MenuItem key={index} value={desg.id}>
                                  {language === "en" ? desg.designation : desg.designationMr}
                                </MenuItem>
                              );
                            })}
                        </Select>
                      ...
                      defaultValue=""
                    />
                    <FormHelperText>{errors?.designation ? errors.designation.message : null}</FormHelperText>
                  </FormControl>
                </Grid>
              </Grid>
