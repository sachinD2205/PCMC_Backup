...
const ApplicationStatus = () => {
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          return {
            ...
            id: val.id,
            service: services[val.service] ? services[val.service].serviceName : val.service,
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/applicationStatus/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/applicationStatus/save`, finalBodyForApi).then((res) => {
              ...
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.serviceStatus ? errors.serviceStatus.message : null}
                  />
                </Grid>
                {/* <Grid
                    item
