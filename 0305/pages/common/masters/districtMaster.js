...
const Index = () => {
 ...
 ;
  ...
  const getDistrictMaster = () => {
    axios.get(`${urls.BaseURL}/districtMaster/getAll`).then((res) => {
                      ...
                      <Grid container spacing={2} style={{marginTop:"5px",marginLeft:"5%"}}>
                        <Grid item xs={4}>
                          <TextField
                            ...
                            helperText={
                              errors?.districtNameEn ? errors.districtNameEn.message : null
                            }
                          />
                        </Grid>
                        <Grid item xs={4}>
                          <TextField
                            ...
                            helperText={
                              errors?.districtNameMr ? errors.districtNameMr.message : null
                            }
                          />
                        </Grid>
