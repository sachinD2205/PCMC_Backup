...
const Index = () => {
  ...
  // Get Table - Data
  const getReligionDetails = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
    axios
  ...
  const onSubmitForm = (fromData) => {
    ...
    axios.post(`${urls.CFCURL}/master/religion/save`, finalBodyForApi).then((res) => {
      if (res.status == 200) {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.CFCURL}/master/religion/save`, body).then((res) => {
                  ...
                  <Grid container style={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        id="outlined-basic"
                        label={<FormattedLabel id="religionMr" />}
                        variant="outlined"
                        {...register("religionMr")}
                        error={!!errors.religionMr}
                        helperText={errors?.religionMr ? errors.religionMr.message : null}
                      />
                      {/* </div> */}
                    </Grid>
                    <Grid
