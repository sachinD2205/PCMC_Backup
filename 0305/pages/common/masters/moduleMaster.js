...
const Index = () => {
  ...
  const getModule = (_pageSize = 10, _pageNo = 0, _sortBy = "id", _sortDir = "desc") => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.CFCURL}/master/application/save`, finalBodyForApi).then((res) => {
                ...
                <Grid container style={{ padding: "10px" }}>
                  ...
                  >
                    <TextField
                      ...
                      id="outlined-basic"
                      label={<FormattedLabel id="moduleCode" />}
                      variant="outlined"
                      {...register("appCode")}
                              ...
                              ? moduleTypes.map((module, index) => {
                                  ...
                                  return (
                                    <MenuItem key={index} value={module.id}>
                                      {language === "en" ? module.packageNameEng : module.packageNameMr}
                                    </MenuItem>
                                  );
                                })
                              : "NA"}
