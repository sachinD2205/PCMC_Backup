...
const Index = () => {
  ...
  const [circleData, setCircleData] = useState([{ id: 1, circleEn: "", circleMr: "" }]);
  const [areaData, setAreaData] = useState([{ id: 1, areaEn: "", areaMr: "" }]);
  const [usageTypeData, setUsageTypeData] = useState([{ id: 1, usageTypeEn: "", usageTypeMr: "" }]);
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        setCircleData(
          res.data.circle.map((j) => ({ id: j.id, circleEn: j.circleName, circleMr: j.circleNameMr })),
        );
      })
      .catch(() => {
        sweetAlert({
          title: "ERROR!",
          text: `Encountered an error while fetching circle's data`,
          icon: "error",
          buttons: {
            confirm: {
              text: "OK",
    ...
    axios
      ...
      .then((res) => {
        setAreaData(res.data.area.map((j) => ({ id: j.id, areaEn: j.areaName, areaMr: j.areaNameMr })));
      })
      .catch(() => {
        sweetAlert({
          title: "ERROR!",
          text: `Encountered an error while fetching area's data`,
          icon: "error",
          buttons: {
            confirm: {
              text: "OK",
          ...
          <div className={styles.row}>
              ...
              <Controller
                render={({ field }) => (
                  ...
                  >
                    ...
                    <MenuItem key={1} value={"newBill"}>
                      {language == "en" ? "Revaluation Bill" : "पुनर्मूल्यांकन बील"}
                    </MenuItem>
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.billType ? error.billType.message : null}</FormHelperText>
            </FormControl>
            <FormControl
              // disabled={router.query.pageMode == "view" ? true : false}
              variant="standard"
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.circle ? error.circle.message : null}</FormHelperText>
            </FormControl>
            <FormControl
              // disabled={router.query.pageMode == "view" ? true : false}
              variant="standard"
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.area ? error.area.message : null}</FormHelperText>
            </FormControl>
            <FormControl
              // disabled={router.query.pageMode == "view" ? true : false}
              variant="standard"
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.usageType ? error.usageType.message : null}</FormHelperText>
            </FormControl>
          </div>
          ...
          <div className={styles.row}>
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.subUsageType ? error.subUsageType.message : null}</FormHelperText>
            </FormControl>
            <FormControl
              // disabled={router.query.pageMode == "view" ? true : false}
              variant="standard"
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.propertyType ? error.propertyType.message : null}</FormHelperText>
            </FormControl>
            <FormControl
              // disabled={router.query.pageMode == "view" ? true : false}
              variant="standard"
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.propertySubType ? error.propertySubType.message : null}</FormHelperText>
            </FormControl>
            <TextField
          ...
          <div className={styles.row}>
            ...
            >
              ...
              <Controller
                ...
                defaultValue=""
              />
              <FormHelperText>{error?.property ? error.property.message : null}</FormHelperText>
            </FormControl>
            <TextField
              disabled={router.query.id ? true : false}
              sx={{ width: "200px" }}
            ...
            <TextField
              ...
              helperText={error?.occupierName ? error.occupierName.message : null}
            />
            <TextField
              disabled={router.query.id ? true : false}
              sx={{ width: "200px" }}
              ...
              InputLabelProps={{
                shrink: router.query.id || watch("selectedCount") ? true : false,
              }}
              error={!!error.selectedCount}
              helperText={error?.selectedCount ? error.selectedCount.message : null}
            />
          </div>
          <div className={styles.row}>
            <TextField
