...
const EquipmentCategory = () => {
      ...
      .then((res) => {
        ...
        let _res = result.map((val, i) => {
          ...
          return {
            ...
            srNo: i + 1,
            equipmentCategoryNameEn: val.equipmentCategoryNameEn ? val.equipmentCategoryNameEn : "-",
            equipmentCategoryNameMr: val.equipmentCategoryNameMr ? val.equipmentCategoryNameMr : "-",
            id: val.id,
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.PABBMURL}/mstEquipmentCategory/save`, body).then((res) => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.PABBMURL}/mstEquipmentCategory/save`, finalBodyForApi).then((res) => {
  ...
  const columns = [
    ...
    {
      field: language == "en" ? "equipmentCategoryNameEn" : "equipmentCategoryNameMr",
      headerName:
        language == "en" ? (
          ...
          <>
            <IconButton
              onClick={() => {
                ...
                reset(params.row);
                setValue("equipmentCategoryName", params.row.equipmentCategoryName);
              }}
            >
  ...
  return (
    <div>
      <Paper style={{ marginTop: "10%" }}>
        ...
        >
          <h2>
            <FormattedLabel id="equipmentCategory" /> {/* New Auditorium Entry */}
          </h2>
        </Box>
        {loading ? (
          <Loader />
                  ...
                  <Grid container style={{ padding: "10px" }}>
                    ...
                    >
                      <TextField
                        ...
                        helperText={
                          errors?.equipmentCategoryNameEn ? errors.equipmentCategoryNameEn.message : null
                        }
                      />
                    </Grid>
                    <Grid
                    ...
                    >
                      <TextField
                        ...
                        helperText={
                          errors?.equipmentCategoryNameMr ? errors.equipmentCategoryNameMr.message : null
                        }
                      />
                    </Grid>
                  </Grid>
