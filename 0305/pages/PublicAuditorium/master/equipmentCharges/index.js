...
const EquipmentCharges = () => {
  ...
  const columns = [
    ...
    {
      field: language == "en" ? "equipmentName" : "equipmentNameMr",
      headerName:
        language == "en" ? <FormattedLabel id="equipment" /> : <FormattedLabel id="equipmentNameMr" />,
      flex: 1,
      headerAlign: "center",
    },
  ...
  return (
    <div>
      <Paper style={{ marginTop: "10%" }}>
        ...
        >
          <h2>
            <FormattedLabel id="equipmentCharges" /> {/* New Auditorium Entry */}
          </h2>
        </Box>
                              ...
                              onChange={(value) => {
                                ...
                                setFilteredEquipmentNames(
                                  equipmentName.map((val) => {
                                    return val.equipmentCategoryId == value.target.value && val;
                                  }),
                                );
                              }}
                      ...
                      >
                        ...
                        <Controller
                          render={({ field }) => (
                            ...
                            >
                              {filteredEquipmentNames?.map((equipmentCat, index) => {
                                return (
                                  <MenuItem
                                    sx={{ display: equipmentCat.equipmentNameEn ? "flex" : "none" }}
                                    key={index}
