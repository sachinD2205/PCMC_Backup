...
const CancellationByDepartment = () => {
  ...
  const onSubmitForm = (formData) => {
    ...
    axios
      ...
      .then((res) => {
        //   axios
        //     .post(`http://192.168.68.145:9006/pabbm/api/trnAuditoriumBookingOnlineProcess/bookingCancellation`, finalBodyForApi)
        //     .then((res) => {
    ...
    <div>
      {loading ? (
        ...
        <Paper>
          ...
          >
            <h2>Forcefully Cancellation By Department</h2>
          </Box>
          {isOpenCollapse && (
                ...
                <Grid container sx={{ padding: "10px" }}>
                  ...
                  >
                    <TextField
                      ...
                      helperText={errors?.reasonForCancellation ? errors.reasonForCancellation.message : null}
                    />
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <TextField
                      ...
                      helperText={errors?.cancellationRemark ? errors.cancellationRemark.message : null}
                    />
                  </Grid>
                </Grid>
                <Grid container sx={{ padding: "10px" }}>
