...
const CheckAuditoriumAvailability = () => {
  ...
  const getCheckAvailabilityOfAuditorium = () => {
    axios.get(`${urls.PABBMURL}/trnCheckAvailablityForBooking/getAll`).then((res, index) => {
      console.log("34", res);
      let _res = res.data.trnCheckAvailablityForBookingList.map((row, index) => ({
        id: row.id,
        srNo: index + 1,
  ...
  const onSubmitForm = (formData) => {
    ...
    axios.post(`${urls.PABBMURL}/trnCheckAvailablityForBooking/save`, finalBodyForApi).then((res) => {
          ...
          <Slide direction="down" in={slideChecked} mountOnEnter unmountOnExit>
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <FormControl variant="standard" sx={{ width: "90%" }} error={!!errors.slotKey}>
                    <InputLabel id="demo-simple-select-standard-label">
                    ...
                    <Controller
                      ...
                      defaultValue=""
                    />
                    <FormHelperText>{errors?.slotKey ? errors.slotKey.message : null}</FormHelperText>
                  </FormControl>
                </Grid>
              </Grid>
