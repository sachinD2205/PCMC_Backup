        ...
        let _res = result.map((val, i) => {
          ...
          return {
            ...
            eventName: val.eventName
              ? programEventDescription.find((obj) => obj?.id == val.eventName)?.eventNameEn
              : "-",
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${urls.PABBMURL}/trnAuditoriumEventsCharges/save`, body).then((res) => {
  ...
  return (
    <div>
      <Paper style={{ margin: "50px" }}>
        ...
        >
          <h2>
            <FormattedLabel id="auditoriumEventCharges" /> {/* New Auditorium Entry */}
          </h2>
        </Box>
        {isOpenCollapse && (
          <Slide direction="down" in={slideChecked} mountOnEnter unmountOnExit>
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <Grid container style={{ padding: "10px" }}>
                ...
                >
                  <FormControl error={errors.eventName} variant="standard" sx={{ width: "90%" }}>
                    <InputLabel id="demo-simple-select-standard-label">
                    ...
                    <Controller
                        ...
                        >
                          {programEventDescription &&
                            programEventDescription.map((auditorium, index) => {
                              return (
                                <MenuItem
                                  sx={{ display: auditorium.eventNameEn ? "flex" : "none" }}
                                  key={index}
                                  value={auditorium.id}
                                >
                      ...
                      defaultValue=""
                    />
                    <FormHelperText>{errors?.eventName ? errors.eventName.message : null}</FormHelperText>
                  </FormControl>
                </Grid>
                {/* <Grid
                  item
              ...
              <Grid container sx={{ padding: "10px" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={errors?.banerBoardCharges ? errors.banerBoardCharges.message : null}
                  />
                </Grid>
              </Grid>
              <Grid container style={{ padding: "10px" }}>
