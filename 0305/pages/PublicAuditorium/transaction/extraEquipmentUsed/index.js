    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmitForm)}>
                              ...
                              <Select
                                ...
                                onChange={(value) => {
                                  ...
                                  let df = equipmentCharges.find((val) => {
                                    return val.equipmentName == value.target.value && val.totalAmount;
                                  });
                                  ...
                                  ? equipments.map((val, id) => {
                                      return (
                                        <MenuItem key={id} value={val.id}>
                                          {language === "en" ? val.equipmentNameEn : val.equipmentNameMr}
                                        </MenuItem>
                                      );
                                    })
                                  : "Not Available"}
        ...
        <Grid container style={{ padding: "10px" }}>
          ...
          >
            <Button size="small" type="submit" variant="contained" color="success" endIcon={<SaveIcon />}>
              Save
            </Button>
          </Grid>
          <Grid
