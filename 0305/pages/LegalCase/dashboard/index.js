...
const Index = () => {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      let totalDemandednBill = billRaised + billSubmitted + billApproved + billPaid;
    ...
    useEffect(() => {
      let totalOpinion = opinionCreated + opinionApproved + advocateOpinionSubmitted + opinionSubmmited;
      setTotalOpinion(totalOpinion);
    }, [opinionCreated, opinionApproved, advocateOpinionSubmitted, opinionSubmmited]);

  // useEffect for Notice
  useEffect(() => {
    let totalNotice = noticeDrafted + noticeCreated + noticeApproved + noticeReassigned;
    setTotalNotice(totalNotice);
  }, [noticeDrafted, noticeCreated, noticeApproved, noticeReassigned]);

  useEffect(() => {}, [totalCaseEntry, totalDemandednBill, totalOpinion, totalNotice]);
  ...
  useEffect(() => {
    ...
    // define a default function to be called 
    apiii(); 
  }, [serviceId]);
              ...
              <>
                ...
                >
                  <Typography style={{ padding: "5px !Important", margin: "5px !Important" }}>
                    {/* <h3>Case Details</h3> */}
                    <h3>
                      <FormattedLabel id="caseDetails"></FormattedLabel> : Total Case Entries {totalCaseEntry}
                      {/* {setOpinionApproved(e.count)} */}
                    </h3>
                  </Typography>
              ...
              <>
                ...
                >
                  <Typography style={{ padding: "5px !Important", margin: "5px !Important" }}>
                    ...
                    <h3>
                      <FormattedLabel id="opinionDetails"></FormattedLabel> : Total Opinions {totalOpinion}
                    </h3>
                  </Typography>
              ...
              <>
                ...
                >
                  <Typography style={{ padding: "5px !Important", margin: "5px !Important" }}>
                    ...
                    <h3>
                      <FormattedLabel id="noticeDetails" /> : Total Notice Created {}
                    </h3>
                  </Typography>
              ...
              <>
                ...
                >
                  <Typography style={{ padding: "5px !Important", margin: "5px !Important" }}>
                    {/* <h3>Bill Tracking</h3> */}
                    <h3>
                      <FormattedLabel id="billTracking"></FormattedLabel> : Total Bills {totalDemandednBill}
                    </h3>
                  </Typography>
                  {/* New Code */}
                  <Grid container>
