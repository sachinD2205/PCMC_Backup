  ...
  const onSubmitForm = (data) => {
    ...
    if (approveRejectRemarkMode == "Reassign") {
      bodyForApiApproveParawiseReport = {
        id: noticeId,
        hodRejectionRemarkAfterParawise: data?.remark,
        hodRejectionRemarkAfterParawiseMr: data?.remarkMr,
      };
    }
    ...
    console.log("bodyForApiApproveTrnNoticeAfterParawiseByHod", bodyForApiApproveTrnNoticeAfterParawiseByHod);
            ...
            {loading ? (
              ...
              <>
                ...
                >
                  ...
                  >
                    <h2>Response To Notice Approval</h2>
                  </Box>
                </Box>
                <div
                  style={{
                ...
                <h1>Response to Notice Approval</h1>
