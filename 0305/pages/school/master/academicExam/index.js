...
const Index = () => {
  ...
  const fetchExams = async (pageNo, pageSize, _sortBy = "id", _sortDir = "desc") => {
  ...
  const onSubmitForm = async (formData) => {
    ...
    try {
      let body = {
        ...
        examType: formData.examType == "Oth" ? formData.othExamTypeName : formData.examType,
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <TextField
                                ...
                                helperText={errors.othExamTypeName ? labels.othExamTypeNameRequired : null}
                              />
                            )}
                          />
                        </FormControl>
