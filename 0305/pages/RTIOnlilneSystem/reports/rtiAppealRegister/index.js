...
const Index = () => {
            ...
            if (res?.data.length > 0) {
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  fullName: r.applicantFirstName + " " + r.applicantMiddlName + " " + r.applicantLastName,
                  address: r.address,
                  descriptionOfInformationOfficer: r.descriptionOfInformationOfficer,
                  dateOfOrderAgainstAppeal: moment(r.dateOfOrderAgainstAppeal).format("DD-MM-YYYY"),
  ...
  const columns = [
    ...
    {
      field: "descriptionOfInformationOfficer",
      headerName: <FormattedLabel id="descriptionOfInformationOfficer" />,
      minWidth: 250,
      headerAlign: "center",
    },
    {
      field: "dateOfOrderAgainstAppeal",
      headerName: <FormattedLabel id="dateOfOrderAgainstAppeal" />,
      minWidth: 230,
      headerAlign: "center",
      align: "center",
    },
    {
      ...
      headerName: <FormattedLabel id="descriptionOfInformation" />,
      minWidth: 250,
      headerAlign: "center",
    },
    {
      field: "informationPurpose",
      headerName: <FormattedLabel id="informationPurpose" />,
      minWidth: 250,
      headerAlign: "center",
    },
    {
      field: "reasonOfAppeal",
      headerName: <FormattedLabel id="reasonOfAppeal" />,
      minWidth: 250,
      headerAlign: "center",
    },
    {
      field: "concernDepartmentOrOffice",
      headerName: <FormattedLabel id="concernDepartmentOrOffice" />,
      minWidth: 250,
      headerAlign: "center",
    },
  ];
