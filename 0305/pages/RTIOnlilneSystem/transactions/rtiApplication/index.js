                            ...
                            if (will) {
                                sweetAlert({
                                    ...
                                    if (will) {
                                        ...
                                        router.push({
                                            pathname:
                                                "/RTIOnlilneSystem/transactions/acknowledgement/rtiApplication",
                            ...
                            if (will) {
                                sweetAlert({
                                    ...
                                    if (will) {
                                        ...
                                        router.push({
                                            pathname:
                                                "/RTIOnlilneSystem/transactions/acknowledgement/rtiApplication?id",
                                            query: { id: res.data.message.split('[')[1].split(']')[0] },
                                        })
                                        removeDocumentToLocalStorage("RTIRelatedDocuments")
                                    ...
                                    <Grid container sx={{ padding: "10px" }}>
                                        ...
                                        >
                                            <TextField
                                                sx={{ width: 570 }}
                                                id="standard-textarea"
                                                label={<FormattedLabel id="informationSubject" required/>}
                                                multiline
                                                variant="standard"
                                        ...
                                        >
                                            <TextField
                                                ...
                                                label={<FormattedLabel id="addInfo" />}
                                                multiline
                                                variant="standard"
                                                {...register("additionalInfo")}
                                                error={!!errors.additionalInfo}
                                                helperText={
                                                    errors?.additionalInfo ? errors.additionalInfo.message : null
                                                }
                                            />
                                        </Grid> */}
