...
const EntryForm = () => {
    ...
    const [hearingTimeVal, setHearingTime] = useState()
    ...
    const setAppealDetails = (res) => {
        ...
        if (res.data.trnRtiHearingDaoList.length != 0) {
            ...
            setValue2("decisionStatus", res.data.trnRtiHearingDaoList[0].decisionDetails)
            ...
            if (res.data.trnRtiHearingDaoList[0].decisionOrderDocumentPath != null) {
                doc.push({
                    ...
                    documentPath: "Decision Order Document",
            ...
            if (res.data.trnRtiHearingDaoList[0].informationDeliveredDocumentPath != null) {
                doc.push({
                    ...
                    documentPath: "Information Delivered Document",
    ...
    const setApplicationDetailsOnForm = (_res) => {
        ...
        console.log("CCCCCCCCCCCCCCCC ", _res.dependentRtiApplicationDaoList)
