...
import styles from "../../../../styles/sportsPortalStyles/facility.module.css";
        ...
        >
          ...
          <div className={styles.selectContainer}>
            <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
              ...
              >
                <MenuItem value={10}>Ward1</MenuItem>
                <MenuItem value={20}>Ward2</MenuItem>
                <MenuItem value={30}>Ward3</MenuItem>
              </Select>
            </FormControl>
            <FormControl sx={{ m: 1, minWidth: 150 }} size="small">
              ...
              <Select
                ...
                // onChange={handleChange}
              >
                <MenuItem value={10}>FacilityName1</MenuItem>
                <MenuItem value={20}>FacilityName2</MenuItem>
                <MenuItem value={30}>FacilityName3</MenuItem>
              </Select>
            </FormControl>
          </div>
