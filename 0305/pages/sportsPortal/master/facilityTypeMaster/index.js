...
const Index = () => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    if (btnSaveText === "save") {
      const tempData = axios.post(`${URLS.SPURL}/facilityType/saveFacilityType`, _body).then((res) => {
        if (res.status == 200) {
    ...
    // Update Data Based On ID
      ...
      axios.post(`${URLS.SPURL}/facilityType/saveFacilityType`, _body).then((res) => {
        console.log("res", res);
        if (res.status == 200) {
          fromData.id
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios.post(`${URLS.SPURL}/facilityType/saveFacilityType`, body).then((res) => {
                  ...
                  <div className={styles.main}>
                    <div className={styles.row}>
                      <div>
                        <TextField
                          id="standard-basic"
                          label={<FormattedLabel id="facilityTypeId" />}
                          variant="standard"
                          sx={{ width: 220 }}
                                  ...
                                  wardNames.map((wardName, index) => {
                                    return (
                                      <MenuItem key={index} value={wardName.id}>
                                        {language == "en" ? wardName?.wardName : wardName?.wardxNameMr}
                                      </MenuItem>
                                    );
                                  })}
                              </Select>
                    ...
                    <div className={styles.row}>
                      ...
                      <div>
                        <TextField
                          ...
                          helperText={errors?.facilityType ? "Facility Type is Required !!!" : null}
                        />
                      </div>
                      <div>
                        <TextField
                          sx={{ width: 220 }}
                          id="standard-basic"
                          label={<FormattedLabel id="facilityTypeMr" />}
                          // label="Facility Type (In Marathi)"
                          variant="standard"
                          {...register("facilityTypeMr")}
                          error={!!errors.facilityTypeMr}
                          helperText={errors?.facilityTypeMr ? "Facility Type is Required !!!" : null}
                        />
                      </div>
                      <div>
                        <TextField
                          ...
                          helperText={
                            ...
                            errors?.geoCode ? "GIS ID/geoCode is Required !!!" : null
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className={styles.row}>
                      <div>
                        <TextField
                          ...
                          helperText={
                            // errors?.studentName ? errors.studentName.message : null
                            errors?.remark ? "Capacity  is Required !!!" : null
                          }
                        />
                      </div>
                    </div>
