...
const Index = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${urls.SPURL}/swimmingBookingMonthly/getById?id=${router.query?.Id}`).then((res) => {
      const tempData = res?.data;

      const _res = {
        ...tempData,
        venueNames: venueNames?.find((obj) => obj?.id == tempData?.venue)?.venue,
        facilityNames: facilityNames?.find((obj) => obj?.id == tempData?.facilityName)?.facilityName,
            ...
            <Card>
              <div className={styles.info}>
                ...
                <h3>
                  ...
                  {this?.props?.data?.serviceName} अर्ज यशस्वीरीत्या सादर झाला आहे.
                </h3>
                {/* <h3> {this?.props?.data?.facilityName}</h3> */}
                <h3>Swimming Pool Name: {this?.props?.data?.venueNames}</h3>
                {/* <h3>Slots: {this?.props?.data?.selectSlot}</h3> */}
              ...
              <div className={styles.summ}>
                ...
                <div>
                  ...
                  <h3>
                    ...
                    :{" "}
                    <b>
                      {this?.props?.data?.firstName} {this?.props?.data?.middleName}{" "}
