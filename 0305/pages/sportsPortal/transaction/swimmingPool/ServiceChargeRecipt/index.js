...
const Index = () => {
  ...
  useEffect(() => {
    axios.get(`${urls.SPURL}/swimmingPool/getById?id=${router?.query?.applicationId}`).then((res) => {
              ...
              <p>
                <h5 style={{ marginLeft: "40px", marginRight: "40px" }}>
                  <b>
                    ...
                    {/* {this?.props?.dataa?.marriageDate} */}व जलतरण तलाव नोंदणीकृत आकारण्यात येणारे शुल्क
                  </b>
                  <b> एकूण फी</b> &nbsp;
