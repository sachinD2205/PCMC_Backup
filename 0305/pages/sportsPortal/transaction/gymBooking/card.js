...
const Index = (props) => {
  ...
  return (
    <>
      <div>
        <ComponentToPrint ref={componentRef} datta={datta} />
      </div>
          ...
          <div className={styles.small}>
            ...
            <div className={styles.two}>
              ...
              <div className={styles.date4} style={{ marginTop: "2vh" }}>
                <div>
                  <img
                    src={`${urls.CFCURL}/file/preview?filePath=${this?.props?.datta?.aadharCard}`}
                    alt="Photo "
                    width={200}
                  ></img>
                </div>
                <div className={styles.date3}>
                  <h4 style={{ marginLeft: "40px" }}>
                    <b>अर्जाचा क्रमांक : {this?.props?.datta?.applicationNumber}</b>
                  </h4>{" "}
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  <h4 style={{ marginLeft: "40px" }}>
                    {" "}
                    <b>अर्ज दिनांक : {this?.props?.datta?.applicationDate}</b>
                  </h4>{" "}
                </div>
              </div>
              ...
              <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                <div className={styles.date2}>
                  <h4 style={{ marginLeft: "40px" }}>
                    {" "}
                    <b>
                      कालावधी: {this?.props?.datta?.fromDate} - {this?.props?.datta?.toDate}
                    </b>
                  </h4>{" "}
                  {/* <h4 style={{ marginLeft: "10px" }}>{router.query.firstName}</h4> */}
                </div>
