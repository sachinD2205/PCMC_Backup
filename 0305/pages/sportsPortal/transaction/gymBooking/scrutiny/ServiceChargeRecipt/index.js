...
const Index = (props) => {
  ...
  useEffect(() => {
    ...
    reset(props?.data);
    console.log("propsyetoy", router.query);
  }, []);
  useEffect(() => {
    axios.get(`${urls.SPURL}/gymBooking/getById?id=${router.query?.applicationId}`).then((res) => {
      setDataa(res.data);
              ...
              <p>
                <h5 style={{ marginLeft: "40px", marginRight: "40px" }}>
                  ...
                  <td colSpan={4}></td>
                    ...
                    <br />
                    व्यायाम शाळा नोंदणीकृत झालेल्याचा दिनांक:{" "}
                    <b>
                      {" "}
                      {" " + moment(this?.props?.dataa?.applicationDate, "YYYY-MM-DD").format("DD-MM-YYYY")}
                    </b>{" "}
                    {/* {this?.props?.dataa?.marriageDate} */}व व्यायाम शाळा नोंदणीकृत आकारण्यात येणारे शुल्क
                  </b>
                  <b> एकूण फी</b> &nbsp;
                  <b>{this?.props?.sum}</b>
                  <b> रु .</b>
