...
const IndustryCertificateReport = () => {
  ...
  useEffect(() => {
    if (router?.query?.id) {
      axios
        .get(
          `${urls.SSLM}/Trn/ApplicantDetails/getByIdAndServicIdAndID?serviceId=7&id=${router?.query?.id}`,
        )
        .then((res) => {
          console.log("aala", res.data.trnApplicantDetailsDao[0])
          setDataa(res.data.trnApplicantDetailsDao[0])
        })
    }
  }, [])
                  ...
                  <table className={styles.data}>
                    ...
                    <div style={{ marginTop: "5vh", marginBottom: "5vh", marginLeft: "5vh" }}>
                      ...
                      <tr>
                        <div>
                          <h3>
                            <b>परवाना क्रमांक :-&nbsp;{this?.props?.dataa?.trnLicense[0].licenseNo}</b>
                          </h3>
                      ...
                      <tr>
                        <h3>
                          <b> परवाना दिनांक :-&nbsp;{moment(this?.props?.dataa?.trnLicense[0].licenseDate).format('DD-MM-YYYY')} </b>
                        </h3>
                      </tr>
                      <tr>
                        <h3>
                          <b>परवाना कालावधी : &nbsp;{moment(this?.props?.dataa?.trnLicense[0].licenseValidTill).format('DD-MM-YYYY')}</b>
                        </h3>
                      </tr>
                      <tr>
                        <h3>
                          <b>व्यवसायाचे नाव : &nbsp;{this?.props?.dataa?.trnIndustryBussinessDetailsDao?.nameOfOrganization}</b>
                        </h3>
                      </tr>
                      <tr> <h3>
                      ...
                      {/* <tr>
                        <h3>
                          <b>व्यवसायाचे स्वरूप :&nbsp;{this?.props?.dataa?.trnLicense[0].licenseValidTill} </b>
                        </h3>
                      </tr>
                      <tr>
                        <div>
                          <h3>
                            <b>व्यवसायाचा प्रकार : &nbsp;{this?.props?.dataa?.trnLicense[0].licenseValidTill}</b>
                          </h3>
                      ...
                      <tr>
                        <div>
                          <right>
                            ...
                            <h3>
                              <b> व्यवसायाचे ठिकाण : &nbsp;{this?.props?.dataa?.trnIndustryBussinessDetailsDao?.cityServrNumber + "," + this?.props?.dataa?.trnIndustryBussinessDetailsDao?.roadName + "," + this?.props?.dataa?.trnIndustryBussinessDetailsDao?.prCityName + "," + this?.props?.dataa?.trnIndustryBussinessDetailsDao?.prState
                                + "," + this?.props?.dataa?.trnIndustryBussinessDetailsDao?.pincode}</b>
                            </h3>
                            {/* <h3>
                              <b> व्यवसायाचा उपप्रकार : &nbsp;{this?.props?.dataa?.trnLicense[0].licenseValidTill}</b>
                            </h3> */}
                          </right>
                        </div>
                      </tr>
                      ...
                      <tr>
                        <h3>
                          <b>एकूण क्षेत्र : &nbsp;{this?.props?.dataa?.trnIndustryBussinessDetailsDao?.totalAreaM + " in sq.m"}</b>
                        </h3>
                      </tr>
                      {/* <tr>
                        <h3>
                      ...
                      <tr>
                        <h3>
                          <b>बांधकाम क्षेत्र :  &nbsp;{this?.props?.dataa?.trnIndustryBussinessDetailsDao?.constructionAreaM + " in sq.m"}</b>
                        </h3>
                      </tr>
                      <tr>
                        <h3>
                          <b> कामाच्या वेळा :  &nbsp;{this?.props?.dataa?.trnIndustryBussinessDetailsDao?.workingHours + " तास"}</b>
                        </h3>
                            ...
                            <tr>
                              <div>
                                <right>
                                  ...
                                  <h3>
                                    <b>परवान्याची फी र.रू.:  &nbsp;{this?.props?.dataa?.trnLoi[0]?.amount}</b>
                                  </h3>
                                  <h3>
                                    <b>पावती क्रमांक :  &nbsp;{this?.props?.dataa?.trnLoi[0]?.trnPaymentCollectionDao[0]?.receiptNo}</b>
                                  </h3>
                                  <h3>
                                    <b> फी भरल्याचा दिनांक : &nbsp;{this?.props?.dataa?.trnLoi[0]?.trnPaymentCollectionDao[0]?.receiptDate}</b>
                                  </h3>
                                </right>
