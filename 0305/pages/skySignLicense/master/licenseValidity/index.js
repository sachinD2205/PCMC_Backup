...
// import schema from "./licenseValidityschema";
import styles from "../../../../styles/skysignstyles/view.module.css";
import schema from "../../../../containers/schema/skysignschema/licenseValidityschema";
...
const Index = () => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.SSLM}/master/MstLicenseValidity/save`, body)
            .then((res) => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    console.log("Post -----");
    axios
      .post(`${urls.SSLM}/master/MstLicenseValidity/save`, finalBodyForApi)
      .then((res) => {
        console.log("res", res);
        if (res.status == 200) {
          fromData.id
  ...
  const getLicenseValidityDetails = (_pageSize = 10, _pageNo = 0) => {
    ...
    console.log("getLIC ----");
    axios
      .get(`${urls.SSLM}/master/MstLicenseValidity/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((r) => {
        console.log(";r", r);
        let result = r.data.MstLicenseValidity;
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            licenseTypeName: licenseTypes?.find(
              (obj) => obj?.id == r.licenseType
            )?.licenseType,
  ...
  return (
    <>
      {/* <BasicLayout titleProp={"License Validity"}> */}
      <Paper
        sx={{
          marginLeft: "10px",
          marginRight: "10px",
      ...
      >
                ...
                <div className={styles.small}>
                  ...
                  <div className={styles.row}>
                    ...
                    <div>
                      <TextField
                        id="standard-basic"
                        label="LicenseValidity *"
                        variant="standard"
                        // value={dataInForm && dataInForm.licenseValidity}
        ...
        <DataGrid
          ...
          columns={columns}
          onPageChange={(_data) => {
            getLicenseValidityDetails(data.pageSize, _data);
          }}
          onPageSizeChange={(_data) => {
            console.log("222", _data);
            // updateData("page", 1);
            getLicenseValidityDetails(_data, data.page);
          }}
        />
      </Paper>
      {/* </BasicLayout> */}
