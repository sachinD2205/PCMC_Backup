          ...
          <div className={styles.small}>
            ...
            <div>
              <h2 className={styles.heading}>
                <b>पावती</b>
                <h5>
                  (महाराष्ट्र आकाश चिन्ह परवाना व्यवस्थापन विनियमन उद्योग परवाना जारी करणे)
                </h5>
              </h2>
            </div>
              ...
              <p>
                <h5 style={{ marginLeft: '40px', marginRight: '40px' }}>
                  <b>
                    ...
                    <table id="table-to-xls" className={styles.report_table}>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={4}>
                            <b>
                              एकूण रक्कम : {this?.props?.dataa?.trnLoi[0]?.amount}
                            </b>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <br />
                    उद्योग परवाना जारी झालेल्याच्या दिनांक:{' '}
                    <b>
                      {' '}
                      {' ' +
                        moment(
                    ...
                    आकाश चिन्ह परवाना व्यवस्थापन आकारण्यात येणारे उद्योग परवाना जारी करणे &nbsp;
                  </b>
                  <b>एकूण फी</b> &nbsp;
