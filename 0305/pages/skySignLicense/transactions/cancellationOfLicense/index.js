...
import schema from "../../../../containers/schema/skysignschema/cancellationOfLicenseschema";
...
const Index = () => {
  ...
  // const getCancellLicDetails = (licenseNo) => {
  //   axios.get(`${urls.SSLM}/master/License/getDataByLiscenceNo?licenseNo=${licenseNo}`).then((res) => {
  //     console.log(res);
  //     setDataSource(
  //       res.data.map((r, i) => ({
  //         id: r.id,
  ...
  //             ? licenseType[r.licenseType].licenseTypeMar
  //             : "-",
  ...
  const viewRecord = (record) => {
    ...
    router.push({
      ...
      pathname: `/skySignLicense/transactions/cancellationofIndustry`,
                  ...
                  <div className={styles.btn1}>
                        <Button
                         sx={{ marginRight: 8 }}
                          ...
                          // onClick={() => exitButton()}
                          onClick={() => router.push(`./cancellationOfLicense`)}
                        >
